# executor_engine/execution_path

## Purpose
Menetapkan aturan operasional untuk executor_engine dan fungsi execution_path dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul executor_engine dan seluruh agent yang bergantung pada execution_path.

## Definitions
- execution_path: komponen utama yang mengatur executor_engine dan fungsi execution_path.
...
## Core rules
- execution_path hanya mengurus executor_engine dan fungsi execution_path dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status execution_path, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
