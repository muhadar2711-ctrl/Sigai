...
## Purpose
Menetapkan aturan operasional untuk technical dan fungsi fibonacci dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul technical dan seluruh agent yang bergantung pada fibonacci.

## Definitions
- fibonacci: komponen utama yang mengatur technical dan fungsi fibonacci.
...
## Core rules
- fibonacci hanya mengurus technical dan fungsi fibonacci dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status fibonacci, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
