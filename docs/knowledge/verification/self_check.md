...
## Purpose
Menetapkan aturan operasional untuk verification dan fungsi self_check dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul verification dan seluruh agent yang bergantung pada self_check.

## Definitions
- self_check: komponen utama yang mengatur verification dan fungsi self_check.
...
## Core rules
- self_check hanya mengurus verification dan fungsi self_check dan tidak boleh mengambil tanggung jawab modul lain.
