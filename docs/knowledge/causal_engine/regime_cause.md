# causal_engine/regime_cause

## Purpose
Menetapkan aturan operasional untuk causal_engine dan fungsi regime_cause dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul causal_engine dan seluruh agent yang bergantung pada regime_cause.

## Definitions
- regime_cause: komponen utama yang mengatur causal_engine dan fungsi regime_cause.
...
## Core rules
- regime_cause hanya mengurus causal_engine dan fungsi regime_cause dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status regime_cause, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
