...
## Purpose
Menetapkan aturan operasional untuk agents dan fungsi analyst_agent dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul agents dan seluruh agent yang bergantung pada analyst_agent.

## Definitions
- analyst_agent: komponen utama yang mengatur agents dan fungsi analyst_agent.
...
## Core rules
- analyst_agent hanya mengurus agents dan fungsi analyst_agent dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status analyst_agent, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
