# state_engine/state_reset

## Purpose
Menetapkan aturan operasional untuk state_engine dan fungsi state_reset dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul state_engine dan seluruh agent yang bergantung pada state_reset.

## Definitions
- state_reset: komponen utama yang mengatur state_engine dan fungsi state_reset.
...
## Core rules
- state_reset hanya mengurus state_engine dan fungsi state_reset dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status state_reset, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
