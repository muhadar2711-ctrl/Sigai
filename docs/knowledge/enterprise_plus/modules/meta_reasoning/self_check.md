# meta_reasoning/self_check

## Purpose
Menetapkan aturan operasional untuk enterprise_plus meta_reasoning untuk self_check dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul meta_reasoning dan seluruh agent yang bergantung pada self_check.

## Definitions
- self_check: komponen utama yang mengatur enterprise_plus meta_reasoning untuk self_check.
...
## Core rules
- self_check hanya mengurus enterprise_plus meta_reasoning untuk self_check dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status self_check, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
