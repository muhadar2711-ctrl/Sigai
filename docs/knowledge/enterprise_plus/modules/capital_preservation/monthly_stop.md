# capital_preservation/monthly_stop

## Purpose
Menetapkan aturan operasional untuk enterprise_plus capital_preservation untuk monthly_stop dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul capital_preservation dan seluruh agent yang bergantung pada monthly_stop.

## Definitions
- monthly_stop: komponen utama yang mengatur enterprise_plus capital_preservation untuk monthly_stop.
...
## Core rules
- monthly_stop hanya mengurus enterprise_plus capital_preservation untuk monthly_stop dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status monthly_stop, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
