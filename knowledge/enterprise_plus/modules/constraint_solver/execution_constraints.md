# constraint_solver/execution_constraints

## Purpose
Menetapkan aturan operasional untuk enterprise_plus constraint_solver untuk execution_constraints dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul constraint_solver dan seluruh agent yang bergantung pada execution_constraints.

## Definitions
- execution_constraints: komponen utama yang mengatur enterprise_plus constraint_solver untuk execution_constraints.
...
## Core rules
- execution_constraints hanya mengurus enterprise_plus constraint_solver untuk execution_constraints dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait constraint_solver.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status execution_constraints, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder constraint_solver lain yang relevan.
