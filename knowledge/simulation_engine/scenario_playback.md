# simulation_engine/scenario_playback

## Purpose
Menetapkan aturan operasional untuk simulation_engine dan fungsi scenario_playback dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul simulation_engine dan seluruh agent yang bergantung pada scenario_playback.

## Definitions
- scenario_playback: komponen utama yang mengatur simulation_engine dan fungsi scenario_playback.
...
## Core rules
- scenario_playback hanya mengurus simulation_engine dan fungsi scenario_playback dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait simulation_engine.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status scenario_playback, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder simulation_engine lain yang relevan.
