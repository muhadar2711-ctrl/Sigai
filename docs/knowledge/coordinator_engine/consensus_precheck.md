# coordinator_engine/consensus_precheck

## Purpose
Menetapkan aturan operasional untuk coordinator_engine dan fungsi consensus_precheck dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul coordinator_engine dan seluruh agent yang bergantung pada consensus_precheck.

## Definitions
- consensus_precheck: komponen utama yang mengatur coordinator_engine dan fungsi consensus_precheck.
...
## Core rules
- consensus_precheck hanya mengurus coordinator_engine dan fungsi consensus_precheck dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait coordinator_engine.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status consensus_precheck, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder coordinator_engine lain yang relevan.
