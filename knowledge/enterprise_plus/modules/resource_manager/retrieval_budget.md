# resource_manager/retrieval_budget

## Purpose
Menetapkan aturan operasional untuk enterprise_plus resource_manager untuk retrieval_budget dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul resource_manager dan seluruh agent yang bergantung pada retrieval_budget.

## Definitions
- retrieval_budget: komponen utama yang mengatur enterprise_plus resource_manager untuk retrieval_budget.
...
## Core rules
- retrieval_budget hanya mengurus enterprise_plus resource_manager untuk retrieval_budget dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait resource_manager.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status retrieval_budget, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder resource_manager lain yang relevan.
