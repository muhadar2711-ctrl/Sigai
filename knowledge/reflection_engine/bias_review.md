# reflection_engine/bias_review

## Purpose
Menetapkan aturan operasional untuk reflection_engine dan fungsi bias_review dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul reflection_engine dan seluruh agent yang bergantung pada bias_review.

## Definitions
- bias_review: komponen utama yang mengatur reflection_engine dan fungsi bias_review.
...
## Core rules
- bias_review hanya mengurus reflection_engine dan fungsi bias_review dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status bias_review, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
