# attention_engine/attention_decay

## Purpose
Menetapkan aturan operasional untuk enterprise_plus attention_engine untuk attention_decay dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul attention_engine dan seluruh agent yang bergantung pada attention_decay.

## Definitions
- attention_decay: komponen utama yang mengatur enterprise_plus attention_engine untuk attention_decay.
...
## Core rules
- attention_decay hanya mengurus enterprise_plus attention_engine untuk attention_decay dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status attention_decay, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
