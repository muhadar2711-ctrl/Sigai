...
## Purpose
Menetapkan aturan operasional untuk strategy dan fungsi wyckoff dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul strategy dan seluruh agent yang bergantung pada wyckoff.

## Definitions
- wyckoff: komponen utama yang mengatur strategy dan fungsi wyckoff.
...
## Core rules
- wyckoff hanya mengurus strategy dan fungsi wyckoff dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status wyckoff, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
