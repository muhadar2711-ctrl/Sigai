# causal_engine/invalidation_cause

## Purpose
Menetapkan aturan operasional untuk causal_engine dan fungsi invalidation_cause dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul causal_engine dan seluruh agent yang bergantung pada invalidation_cause.

## Definitions
- invalidation_cause: komponen utama yang mengatur causal_engine dan fungsi invalidation_cause.
...
## Core rules
- invalidation_cause hanya mengurus causal_engine dan fungsi invalidation_cause dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait causal_engine.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status invalidation_cause, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder causal_engine lain yang relevan.
