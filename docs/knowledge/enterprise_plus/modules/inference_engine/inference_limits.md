# inference_engine/inference_limits

## Purpose
Menetapkan aturan operasional untuk enterprise_plus inference_engine untuk inference_limits dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul inference_engine dan seluruh agent yang bergantung pada inference_limits.

## Definitions
- inference_limits: komponen utama yang mengatur enterprise_plus inference_engine untuk inference_limits.
...
## Core rules
- inference_limits hanya mengurus enterprise_plus inference_engine untuk inference_limits dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status inference_limits, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
