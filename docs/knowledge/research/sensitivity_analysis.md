...
## Purpose
Menetapkan aturan operasional untuk research dan fungsi sensitivity_analysis dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul research dan seluruh agent yang bergantung pada sensitivity_analysis.

## Definitions
- sensitivity_analysis: komponen utama yang mengatur research dan fungsi sensitivity_analysis.
...
## Core rules
- sensitivity_analysis hanya mengurus research dan fungsi sensitivity_analysis dan tidak boleh mengambil tanggung jawab modul lain.
