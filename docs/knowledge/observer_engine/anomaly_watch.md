# observer_engine/anomaly_watch

## Purpose
Menetapkan aturan operasional untuk observer_engine dan fungsi anomaly_watch dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul observer_engine dan seluruh agent yang bergantung pada anomaly_watch.

## Definitions
- anomaly_watch: komponen utama yang mengatur observer_engine dan fungsi anomaly_watch.
...
## Core rules
- anomaly_watch hanya mengurus observer_engine dan fungsi anomaly_watch dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait observer_engine.
...
## Interactions
- Berinteraksi dengan folder observer_engine lain yang relevan.
