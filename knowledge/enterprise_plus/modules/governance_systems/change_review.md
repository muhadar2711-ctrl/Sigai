# governance_systems/change_review

## Purpose
Menetapkan aturan operasional untuk enterprise_plus governance_systems untuk change_review dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul governance_systems dan seluruh agent yang bergantung pada change_review.

## Definitions
- change_review: komponen utama yang mengatur enterprise_plus governance_systems untuk change_review.
...
## Core rules
- change_review hanya mengurus enterprise_plus governance_systems untuk change_review dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status change_review, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
