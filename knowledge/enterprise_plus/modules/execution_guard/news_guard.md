# execution_guard/news_guard

## Purpose
Menetapkan aturan operasional untuk enterprise_plus execution_guard untuk news_guard dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul execution_guard dan seluruh agent yang bergantung pada news_guard.

## Definitions
- news_guard: komponen utama yang mengatur enterprise_plus execution_guard untuk news_guard.
...
## Core rules
- news_guard hanya mengurus enterprise_plus execution_guard untuk news_guard dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status news_guard, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
