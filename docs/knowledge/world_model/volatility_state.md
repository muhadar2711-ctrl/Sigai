# world_model/volatility_state

## Purpose
Menetapkan aturan operasional untuk world_model dan fungsi volatility_state dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul world_model dan seluruh agent yang bergantung pada volatility_state.

## Definitions
- volatility_state: komponen utama yang mengatur world_model dan fungsi volatility_state.
...
## Core rules
- volatility_state hanya mengurus world_model dan fungsi volatility_state dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status volatility_state, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
