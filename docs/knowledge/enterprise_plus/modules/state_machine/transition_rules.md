...
## Purpose
Menetapkan aturan operasional untuk enterprise_plus state_machine untuk transition_rules dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul state_machine dan seluruh agent yang bergantung pada transition_rules.

## Definitions
- transition_rules: komponen utama yang mengatur enterprise_plus state_machine untuk transition_rules.
...
## Core rules
- transition_rules hanya mengurus enterprise_plus state_machine untuk transition_rules dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status transition_rules, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
