# volatility_engine/volatility_regime

## Purpose
Menetapkan aturan operasional untuk enterprise_plus volatility_engine untuk volatility_regime dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul volatility_engine dan seluruh agent yang bergantung pada volatility_regime.

## Definitions
- volatility_regime: komponen utama yang mengatur enterprise_plus volatility_engine untuk volatility_regime.
...
## Core rules
- volatility_regime hanya mengurus enterprise_plus volatility_engine untuk volatility_regime dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait volatility_engine.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status volatility_regime, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder volatility_engine lain yang relevan.
