# meta_reasoning/reflection_depth

## Purpose
Menetapkan aturan operasional untuk enterprise_plus meta_reasoning untuk reflection_depth dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul meta_reasoning dan seluruh agent yang bergantung pada reflection_depth.

## Definitions
- reflection_depth: komponen utama yang mengatur enterprise_plus meta_reasoning untuk reflection_depth.
...
## Core rules
- reflection_depth hanya mengurus enterprise_plus meta_reasoning untuk reflection_depth dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status reflection_depth, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
