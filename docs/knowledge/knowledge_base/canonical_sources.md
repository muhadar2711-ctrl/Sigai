# knowledge_base/canonical_sources

## Purpose
Menetapkan aturan operasional untuk knowledge_base dan fungsi canonical_sources dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul knowledge_base dan seluruh agent yang bergantung pada canonical_sources.

## Definitions
- canonical_sources: komponen utama yang mengatur knowledge_base dan fungsi canonical_sources.
...
## Core rules
- canonical_sources hanya mengurus knowledge_base dan fungsi canonical_sources dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait knowledge_base.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status canonical_sources, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder knowledge_base lain yang relevan.
