# inference_engine/contradiction_check

## Purpose
Menetapkan aturan operasional untuk enterprise_plus inference_engine untuk contradiction_check dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul inference_engine dan seluruh agent yang bergantung pada contradiction_check.

## Definitions
- contradiction_check: komponen utama yang mengatur enterprise_plus inference_engine untuk contradiction_check.
...
## Core rules
- contradiction_check hanya mengurus enterprise_plus inference_engine untuk contradiction_check dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status contradiction_check, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
