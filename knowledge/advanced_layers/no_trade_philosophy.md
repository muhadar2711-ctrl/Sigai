# advanced_layers/no_trade_philosophy

## Purpose
Menetapkan filosofi no-trade sebagai outcome profesional.
...
## Core rules
- Menahan entry adalah keputusan valid.
- Pasar yang ambigu harus dibalas dengan wait.
- Kualitas setup lebih penting dari banyaknya sinyal.
