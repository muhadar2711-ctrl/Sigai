# meta_reasoning/reasoning_budget

## Purpose
Menetapkan aturan operasional untuk enterprise_plus meta_reasoning untuk reasoning_budget dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul meta_reasoning dan seluruh agent yang bergantung pada reasoning_budget.

## Definitions
- reasoning_budget: komponen utama yang mengatur enterprise_plus meta_reasoning untuk reasoning_budget.
...
## Core rules
- reasoning_budget hanya mengurus enterprise_plus meta_reasoning untuk reasoning_budget dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status reasoning_budget, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
