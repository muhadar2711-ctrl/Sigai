# capital_preservation/daily_stop

## Purpose
Menetapkan aturan operasional untuk enterprise_plus capital_preservation untuk daily_stop dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul capital_preservation dan seluruh agent yang bergantung pada daily_stop.

## Definitions
- daily_stop: komponen utama yang mengatur enterprise_plus capital_preservation untuk daily_stop.
...
## Core rules
- daily_stop hanya mengurus enterprise_plus capital_preservation untuk daily_stop dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status daily_stop, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
