# trade_lifecycle/recovery

## Purpose
Menetapkan aturan operasional untuk enterprise_plus trade_lifecycle untuk recovery dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul trade_lifecycle dan seluruh agent yang bergantung pada recovery.

## Definitions
- recovery: komponen utama yang mengatur enterprise_plus trade_lifecycle untuk recovery.
...
## Core rules
- recovery hanya mengurus enterprise_plus trade_lifecycle untuk recovery dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status recovery, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
