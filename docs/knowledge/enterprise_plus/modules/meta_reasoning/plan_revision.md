# meta_reasoning/plan_revision

## Purpose
Menetapkan aturan operasional untuk enterprise_plus meta_reasoning untuk plan_revision dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul meta_reasoning dan seluruh agent yang bergantung pada plan_revision.

## Definitions
- plan_revision: komponen utama yang mengatur enterprise_plus meta_reasoning untuk plan_revision.
...
## Core rules
- plan_revision hanya mengurus enterprise_plus meta_reasoning untuk plan_revision dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status plan_revision, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
