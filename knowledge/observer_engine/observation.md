# observer_engine/observation

## Purpose
Menetapkan aturan operasional untuk observer_engine dan fungsi observation dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul observer_engine dan seluruh agent yang bergantung pada observation.

## Definitions
- observation: komponen utama yang mengatur observer_engine dan fungsi observation.
...
## Core rules
- observation hanya mengurus observer_engine dan fungsi observation dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status observation, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
