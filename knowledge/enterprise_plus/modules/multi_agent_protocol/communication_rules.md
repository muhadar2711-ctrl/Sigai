# multi_agent_protocol/communication_rules

## Purpose
Menetapkan aturan operasional untuk enterprise_plus multi_agent_protocol untuk communication_rules dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul multi_agent_protocol dan seluruh agent yang bergantung pada communication_rules.

## Definitions
- communication_rules: komponen utama yang mengatur enterprise_plus multi_agent_protocol untuk communication_rules.
...
## Core rules
- communication_rules hanya mengurus enterprise_plus multi_agent_protocol untuk communication_rules dan tidak boleh mengambil tanggung jawab modul lain.
...
- Handoff, state, dan kontrak harus eksplisit.
- Tidak ada transisi tersembunyi.

## Inputs
- Struktur market, session, liquidity, volatility, news, risk state, dan context aktif.
- Evidence dari modul terkait multi_agent_protocol.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status communication_rules, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder multi_agent_protocol lain yang relevan.
