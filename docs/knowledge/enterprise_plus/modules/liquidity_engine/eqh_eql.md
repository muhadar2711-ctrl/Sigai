# liquidity_engine/eqh_eql

## Purpose
Menetapkan aturan operasional untuk enterprise_plus liquidity_engine untuk eqh_eql dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul liquidity_engine dan seluruh agent yang bergantung pada eqh_eql.

## Definitions
- eqh_eql: komponen utama yang mengatur enterprise_plus liquidity_engine untuk eqh_eql.
...
## Core rules
- eqh_eql hanya mengurus enterprise_plus liquidity_engine untuk eqh_eql dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status eqh_eql, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
