...
## Purpose
Menetapkan aturan operasional untuk agents dan fungsi explanation_agent dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul agents dan seluruh agent yang bergantung pada explanation_agent.

## Definitions
- explanation_agent: komponen utama yang mengatur agents dan fungsi explanation_agent.
...
## Core rules
- explanation_agent hanya mengurus agents dan fungsi explanation_agent dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status explanation_agent, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
