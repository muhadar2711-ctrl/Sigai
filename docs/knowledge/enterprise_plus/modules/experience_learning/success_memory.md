# experience_learning/success_memory

## Purpose
Menetapkan aturan operasional untuk enterprise_plus experience_learning untuk success_memory dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul experience_learning dan seluruh agent yang bergantung pada success_memory.

## Definitions
- success_memory: komponen utama yang mengatur enterprise_plus experience_learning untuk success_memory.
...
## Core rules
- success_memory hanya mengurus enterprise_plus experience_learning untuk success_memory dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status success_memory, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
