# fundamental/recession_model

## Purpose
Menetapkan aturan operasional untuk fundamental dan fungsi recession_model dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul fundamental dan seluruh agent yang bergantung pada recession_model.

## Definitions
- recession_model: komponen utama yang mengatur fundamental dan fungsi recession_model.
...
## Core rules
- recession_model hanya mengurus fundamental dan fungsi recession_model dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status recession_model, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
