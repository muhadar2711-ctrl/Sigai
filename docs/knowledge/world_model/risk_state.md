# world_model/risk_state

## Purpose
Menetapkan aturan operasional untuk world_model dan fungsi risk_state dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul world_model dan seluruh agent yang bergantung pada risk_state.

## Definitions
- risk_state: komponen utama yang mengatur world_model dan fungsi risk_state.
...
## Core rules
- risk_state hanya mengurus world_model dan fungsi risk_state dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status risk_state, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
