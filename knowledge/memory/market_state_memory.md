# memory/market_state_memory

## Purpose
Menetapkan aturan operasional untuk memory dan fungsi market_state_memory dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul memory dan seluruh agent yang bergantung pada market_state_memory.

## Definitions
- market_state_memory: komponen utama yang mengatur memory dan fungsi market_state_memory.
...
## Core rules
- market_state_memory hanya mengurus memory dan fungsi market_state_memory dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait memory.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status market_state_memory, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder memory lain yang relevan.
