# multi_agent_protocol/turn_taking

## Purpose
Menetapkan aturan operasional untuk enterprise_plus multi_agent_protocol untuk turn_taking dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul multi_agent_protocol dan seluruh agent yang bergantung pada turn_taking.

## Definitions
- turn_taking: komponen utama yang mengatur enterprise_plus multi_agent_protocol untuk turn_taking.
...
## Core rules
- turn_taking hanya mengurus enterprise_plus multi_agent_protocol untuk turn_taking dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status turn_taking, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
