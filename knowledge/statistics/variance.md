...
## Purpose
Menetapkan aturan operasional untuk statistics dan fungsi variance dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul statistics dan seluruh agent yang bergantung pada variance.

## Definitions
- variance: komponen utama yang mengatur statistics dan fungsi variance.
...
## Core rules
- variance hanya mengurus statistics dan fungsi variance dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status variance, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
