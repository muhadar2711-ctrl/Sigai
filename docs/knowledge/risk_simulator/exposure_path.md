# risk_simulator/exposure_path

## Purpose
Menetapkan aturan operasional untuk risk_simulator dan fungsi exposure_path dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul risk_simulator dan seluruh agent yang bergantung pada exposure_path.

## Definitions
- exposure_path: komponen utama yang mengatur risk_simulator dan fungsi exposure_path.
...
## Core rules
- exposure_path hanya mengurus risk_simulator dan fungsi exposure_path dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status exposure_path, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
