...
## Purpose
Menetapkan aturan operasional untuk backtest dan fungsi out_of_sample dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul backtest dan seluruh agent yang bergantung pada out_of_sample.

## Definitions
- out_of_sample: komponen utama yang mengatur backtest dan fungsi out_of_sample.
...
## Core rules
- out_of_sample hanya mengurus backtest dan fungsi out_of_sample dan tidak boleh mengambil tanggung jawab modul lain.
