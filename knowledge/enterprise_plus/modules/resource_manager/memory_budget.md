# resource_manager/memory_budget

## Purpose
Menetapkan aturan operasional untuk enterprise_plus resource_manager untuk memory_budget dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul resource_manager dan seluruh agent yang bergantung pada memory_budget.

## Definitions
- memory_budget: komponen utama yang mengatur enterprise_plus resource_manager untuk memory_budget.
...
## Core rules
- memory_budget hanya mengurus enterprise_plus resource_manager untuk memory_budget dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status memory_budget, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
