# state_machine/state_audit

## Purpose
Menetapkan aturan operasional untuk enterprise_plus state_machine untuk state_audit dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul state_machine dan seluruh agent yang bergantung pada state_audit.

## Definitions
- state_audit: komponen utama yang mengatur enterprise_plus state_machine untuk state_audit.
...
## Core rules
- state_audit hanya mengurus enterprise_plus state_machine untuk state_audit dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status state_audit, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
