...
## Purpose
Menetapkan aturan operasional untuk filters dan fungsi news_filter dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul filters dan seluruh agent yang bergantung pada news_filter.

## Definitions
- news_filter: komponen utama yang mengatur filters dan fungsi news_filter.
...
## Core rules
- news_filter hanya mengurus filters dan fungsi news_filter dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status news_filter, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
