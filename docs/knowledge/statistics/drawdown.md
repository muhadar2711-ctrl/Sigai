...
## Purpose
Menetapkan aturan operasional untuk statistics dan fungsi drawdown dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul statistics dan seluruh agent yang bergantung pada drawdown.

## Definitions
- drawdown: komponen utama yang mengatur statistics dan fungsi drawdown.
...
## Core rules
- drawdown hanya mengurus statistics dan fungsi drawdown dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status drawdown, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
