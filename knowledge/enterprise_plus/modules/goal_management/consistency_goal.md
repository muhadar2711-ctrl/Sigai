# goal_management/consistency_goal

## Purpose
Menetapkan aturan operasional untuk enterprise_plus goal_management untuk consistency_goal dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul goal_management dan seluruh agent yang bergantung pada consistency_goal.

## Definitions
- consistency_goal: komponen utama yang mengatur enterprise_plus goal_management untuk consistency_goal.
...
## Core rules
- consistency_goal hanya mengurus enterprise_plus goal_management untuk consistency_goal dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait goal_management.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status consistency_goal, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder goal_management lain yang relevan.
