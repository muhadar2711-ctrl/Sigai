# evaluation_engine/quality_score

## Purpose
Menetapkan aturan operasional untuk evaluation_engine dan fungsi quality_score dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul evaluation_engine dan seluruh agent yang bergantung pada quality_score.

## Definitions
- quality_score: komponen utama yang mengatur evaluation_engine dan fungsi quality_score.
...
## Core rules
- quality_score hanya mengurus evaluation_engine dan fungsi quality_score dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait evaluation_engine.
...
## Interactions
- Berinteraksi dengan folder evaluation_engine lain yang relevan.
