# cognitive_architecture/attention_engine

## Purpose
Menetapkan aturan operasional untuk enterprise_plus cognitive_architecture untuk attention_engine dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul cognitive_architecture dan seluruh agent yang bergantung pada attention_engine.

## Definitions
- attention_engine: komponen utama yang mengatur enterprise_plus cognitive_architecture untuk attention_engine.
...
## Core rules
- attention_engine hanya mengurus enterprise_plus cognitive_architecture untuk attention_engine dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait cognitive_architecture.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status attention_engine, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder cognitive_architecture lain yang relevan.
