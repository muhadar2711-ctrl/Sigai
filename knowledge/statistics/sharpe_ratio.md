...
## Purpose
Menetapkan aturan operasional untuk statistics dan fungsi sharpe_ratio dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul statistics dan seluruh agent yang bergantung pada sharpe_ratio.

## Definitions
- sharpe_ratio: komponen utama yang mengatur statistics dan fungsi sharpe_ratio.
...
## Core rules
- sharpe_ratio hanya mengurus statistics dan fungsi sharpe_ratio dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status sharpe_ratio, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
