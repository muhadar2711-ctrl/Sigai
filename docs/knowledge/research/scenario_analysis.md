...
## Purpose
Menetapkan aturan operasional untuk research dan fungsi scenario_analysis dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul research dan seluruh agent yang bergantung pada scenario_analysis.

## Definitions
- scenario_analysis: komponen utama yang mengatur research dan fungsi scenario_analysis.
...
## Core rules
- scenario_analysis hanya mengurus research dan fungsi scenario_analysis dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status scenario_analysis, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
