# research/out_of_sample

## Purpose
Menetapkan aturan operasional untuk research dan fungsi out_of_sample dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul research dan seluruh agent yang bergantung pada out_of_sample.

## Definitions
- out_of_sample: komponen utama yang mengatur research dan fungsi out_of_sample.
...
## Core rules
- out_of_sample hanya mengurus research dan fungsi out_of_sample dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status out_of_sample, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
