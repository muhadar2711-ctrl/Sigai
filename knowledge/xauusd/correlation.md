...
## Purpose
Menetapkan aturan operasional untuk xauusd dan fungsi correlation dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul xauusd dan seluruh agent yang bergantung pada correlation.

## Definitions
- correlation: komponen utama yang mengatur xauusd dan fungsi correlation.
...
## Core rules
- correlation hanya mengurus xauusd dan fungsi correlation dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status correlation, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
