...
## Purpose
Menetapkan aturan operasional untuk agents dan fungsi news_agent dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul agents dan seluruh agent yang bergantung pada news_agent.

## Definitions
- news_agent: komponen utama yang mengatur agents dan fungsi news_agent.
...
## Core rules
- news_agent hanya mengurus agents dan fungsi news_agent dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status news_agent, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
