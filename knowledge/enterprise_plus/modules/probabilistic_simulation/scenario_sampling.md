# probabilistic_simulation/scenario_sampling

## Purpose
Menetapkan aturan operasional untuk enterprise_plus probabilistic_simulation untuk scenario_sampling dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul probabilistic_simulation dan seluruh agent yang bergantung pada scenario_sampling.

## Definitions
- scenario_sampling: komponen utama yang mengatur enterprise_plus probabilistic_simulation untuk scenario_sampling.
...
## Core rules
- scenario_sampling hanya mengurus enterprise_plus probabilistic_simulation untuk scenario_sampling dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status scenario_sampling, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
