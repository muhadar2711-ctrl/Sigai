# stress_engine/stress_inputs

## Purpose
Menetapkan aturan operasional untuk stress_engine dan fungsi stress_inputs dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul stress_engine dan seluruh agent yang bergantung pada stress_inputs.

## Definitions
- stress_inputs: komponen utama yang mengatur stress_engine dan fungsi stress_inputs.
...
## Core rules
- stress_inputs hanya mengurus stress_engine dan fungsi stress_inputs dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status stress_inputs, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
