# trade_lifecycle/posttrade

## Purpose
Menetapkan aturan operasional untuk enterprise_plus trade_lifecycle untuk posttrade dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul trade_lifecycle dan seluruh agent yang bergantung pada posttrade.

## Definitions
- posttrade: komponen utama yang mengatur enterprise_plus trade_lifecycle untuk posttrade.
...
## Core rules
- posttrade hanya mengurus enterprise_plus trade_lifecycle untuk posttrade dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status posttrade, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
