...
## Purpose
Menetapkan aturan operasional untuk agents dan fungsi risk_agent dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul agents dan seluruh agent yang bergantung pada risk_agent.

## Definitions
- risk_agent: komponen utama yang mengatur agents dan fungsi risk_agent.
...
## Core rules
- risk_agent hanya mengurus agents dan fungsi risk_agent dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status risk_agent, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
