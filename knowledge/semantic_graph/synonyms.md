# semantic_graph/synonyms

## Purpose
Menetapkan aturan operasional untuk semantic_graph dan fungsi synonyms dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul semantic_graph dan seluruh agent yang bergantung pada synonyms.

## Definitions
- synonyms: komponen utama yang mengatur semantic_graph dan fungsi synonyms.
...
## Core rules
- synonyms hanya mengurus semantic_graph dan fungsi synonyms dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status synonyms, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
