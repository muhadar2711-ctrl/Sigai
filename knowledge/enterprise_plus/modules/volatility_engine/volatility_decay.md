# volatility_engine/volatility_decay

## Purpose
Menetapkan aturan operasional untuk enterprise_plus volatility_engine untuk volatility_decay dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul volatility_engine dan seluruh agent yang bergantung pada volatility_decay.

## Definitions
- volatility_decay: komponen utama yang mengatur enterprise_plus volatility_engine untuk volatility_decay.
...
## Core rules
- volatility_decay hanya mengurus enterprise_plus volatility_engine untuk volatility_decay dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status volatility_decay, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
