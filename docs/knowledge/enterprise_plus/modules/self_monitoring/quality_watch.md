# self_monitoring/quality_watch

## Purpose
Menetapkan aturan operasional untuk enterprise_plus self_monitoring untuk quality_watch dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul self_monitoring dan seluruh agent yang bergantung pada quality_watch.

## Definitions
- quality_watch: komponen utama yang mengatur enterprise_plus self_monitoring untuk quality_watch.
...
## Core rules
- quality_watch hanya mengurus enterprise_plus self_monitoring untuk quality_watch dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status quality_watch, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
