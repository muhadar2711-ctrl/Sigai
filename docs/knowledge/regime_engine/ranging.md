# regime_engine/ranging

## Purpose
Menetapkan aturan operasional untuk regime_engine dan fungsi ranging dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul regime_engine dan seluruh agent yang bergantung pada ranging.

## Definitions
- ranging: komponen utama yang mengatur regime_engine dan fungsi ranging.
...
## Core rules
- ranging hanya mengurus regime_engine dan fungsi ranging dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status ranging, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
