# experience_learning/failure_memory

## Purpose
Menetapkan aturan operasional untuk enterprise_plus experience_learning untuk failure_memory dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul experience_learning dan seluruh agent yang bergantung pada failure_memory.

## Definitions
- failure_memory: komponen utama yang mengatur enterprise_plus experience_learning untuk failure_memory.
...
## Core rules
- failure_memory hanya mengurus enterprise_plus experience_learning untuk failure_memory dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status failure_memory, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
