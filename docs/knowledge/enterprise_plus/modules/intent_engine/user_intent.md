# intent_engine/user_intent

## Purpose
Menetapkan aturan operasional untuk enterprise_plus intent_engine untuk user_intent dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul intent_engine dan seluruh agent yang bergantung pada user_intent.

## Definitions
- user_intent: komponen utama yang mengatur enterprise_plus intent_engine untuk user_intent.
...
## Core rules
- user_intent hanya mengurus enterprise_plus intent_engine untuk user_intent dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status user_intent, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
