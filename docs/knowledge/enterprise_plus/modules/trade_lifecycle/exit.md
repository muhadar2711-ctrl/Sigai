# trade_lifecycle/exit

## Purpose
Menetapkan aturan operasional untuk enterprise_plus trade_lifecycle untuk exit dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul trade_lifecycle dan seluruh agent yang bergantung pada exit.

## Definitions
- exit: komponen utama yang mengatur enterprise_plus trade_lifecycle untuk exit.
...
## Core rules
- exit hanya mengurus enterprise_plus trade_lifecycle untuk exit dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status exit, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
