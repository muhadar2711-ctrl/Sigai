# trade_management/partial_close

## Purpose
Menetapkan aturan operasional untuk trade_management dan fungsi partial_close dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul trade_management dan seluruh agent yang bergantung pada partial_close.

## Definitions
- partial_close: komponen utama yang mengatur trade_management dan fungsi partial_close.
...
## Core rules
- partial_close hanya mengurus trade_management dan fungsi partial_close dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait trade_management.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status partial_close, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder trade_management lain yang relevan.
