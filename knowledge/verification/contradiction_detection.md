...
## Purpose
Menetapkan aturan operasional untuk verification dan fungsi contradiction_detection dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul verification dan seluruh agent yang bergantung pada contradiction_detection.

## Definitions
- contradiction_detection: komponen utama yang mengatur verification dan fungsi contradiction_detection.
...
## Core rules
- contradiction_detection hanya mengurus verification dan fungsi contradiction_detection dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status contradiction_detection, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
