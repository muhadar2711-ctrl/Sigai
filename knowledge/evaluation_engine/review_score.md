# evaluation_engine/review_score

## Purpose
Menetapkan aturan operasional untuk evaluation_engine dan fungsi review_score dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul evaluation_engine dan seluruh agent yang bergantung pada review_score.

## Definitions
- review_score: komponen utama yang mengatur evaluation_engine dan fungsi review_score.
...
## Core rules
- review_score hanya mengurus evaluation_engine dan fungsi review_score dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status review_score, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
