# multi_agent_protocol/shared_memory_rules

## Purpose
Menetapkan aturan operasional untuk enterprise_plus multi_agent_protocol untuk shared_memory_rules dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul multi_agent_protocol dan seluruh agent yang bergantung pada shared_memory_rules.

## Definitions
- shared_memory_rules: komponen utama yang mengatur enterprise_plus multi_agent_protocol untuk shared_memory_rules.
...
## Core rules
- shared_memory_rules hanya mengurus enterprise_plus multi_agent_protocol untuk shared_memory_rules dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status shared_memory_rules, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
