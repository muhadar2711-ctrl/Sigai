# liquidity_engine/pool_rotation

## Purpose
Menetapkan aturan operasional untuk enterprise_plus liquidity_engine untuk pool_rotation dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul liquidity_engine dan seluruh agent yang bergantung pada pool_rotation.

## Definitions
- pool_rotation: komponen utama yang mengatur enterprise_plus liquidity_engine untuk pool_rotation.
...
## Core rules
- pool_rotation hanya mengurus enterprise_plus liquidity_engine untuk pool_rotation dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status pool_rotation, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
