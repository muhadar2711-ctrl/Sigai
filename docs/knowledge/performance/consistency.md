...
## Purpose
Menetapkan aturan operasional untuk performance dan fungsi consistency dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul performance dan seluruh agent yang bergantung pada consistency.

## Definitions
- consistency: komponen utama yang mengatur performance dan fungsi consistency.
...
## Core rules
- consistency hanya mengurus performance dan fungsi consistency dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status consistency, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
