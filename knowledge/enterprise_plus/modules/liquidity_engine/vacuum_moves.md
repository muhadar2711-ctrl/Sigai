# liquidity_engine/vacuum_moves

## Purpose
Menetapkan aturan operasional untuk enterprise_plus liquidity_engine untuk vacuum_moves dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul liquidity_engine dan seluruh agent yang bergantung pada vacuum_moves.

## Definitions
- vacuum_moves: komponen utama yang mengatur enterprise_plus liquidity_engine untuk vacuum_moves.
...
## Core rules
- vacuum_moves hanya mengurus enterprise_plus liquidity_engine untuk vacuum_moves dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status vacuum_moves, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
