# multi_agent_protocol/voting_system

## Purpose
Menetapkan aturan operasional untuk enterprise_plus multi_agent_protocol untuk voting_system dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul multi_agent_protocol dan seluruh agent yang bergantung pada voting_system.

## Definitions
- voting_system: komponen utama yang mengatur enterprise_plus multi_agent_protocol untuk voting_system.
...
## Core rules
- voting_system hanya mengurus enterprise_plus multi_agent_protocol untuk voting_system dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status voting_system, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
