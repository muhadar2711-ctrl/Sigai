# self_monitoring/anomaly_watch

## Purpose
Menetapkan aturan operasional untuk enterprise_plus self_monitoring untuk anomaly_watch dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul self_monitoring dan seluruh agent yang bergantung pada anomaly_watch.

## Definitions
- anomaly_watch: komponen utama yang mengatur enterprise_plus self_monitoring untuk anomaly_watch.
...
## Core rules
- anomaly_watch hanya mengurus enterprise_plus self_monitoring untuk anomaly_watch dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status anomaly_watch, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
