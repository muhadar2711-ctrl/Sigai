# intent_engine/conflict_intent

## Purpose
Menetapkan aturan operasional untuk enterprise_plus intent_engine untuk conflict_intent dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul intent_engine dan seluruh agent yang bergantung pada conflict_intent.

## Definitions
- conflict_intent: komponen utama yang mengatur enterprise_plus intent_engine untuk conflict_intent.
...
## Core rules
- conflict_intent hanya mengurus enterprise_plus intent_engine untuk conflict_intent dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status conflict_intent, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
