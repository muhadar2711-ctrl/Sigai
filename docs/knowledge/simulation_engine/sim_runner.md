# simulation_engine/sim_runner

## Purpose
Menetapkan aturan operasional untuk simulation_engine dan fungsi sim_runner dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul simulation_engine dan seluruh agent yang bergantung pada sim_runner.

## Definitions
- sim_runner: komponen utama yang mengatur simulation_engine dan fungsi sim_runner.
...
## Core rules
- sim_runner hanya mengurus simulation_engine dan fungsi sim_runner dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status sim_runner, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
