# intent_engine/intent_validation

## Purpose
Menetapkan aturan operasional untuk enterprise_plus intent_engine untuk intent_validation dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul intent_engine dan seluruh agent yang bergantung pada intent_validation.

## Definitions
- intent_validation: komponen utama yang mengatur enterprise_plus intent_engine untuk intent_validation.
...
## Core rules
- intent_validation hanya mengurus enterprise_plus intent_engine untuk intent_validation dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status intent_validation, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
