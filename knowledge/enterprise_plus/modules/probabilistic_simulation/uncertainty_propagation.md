# probabilistic_simulation/uncertainty_propagation

## Purpose
Menetapkan aturan operasional untuk enterprise_plus probabilistic_simulation untuk uncertainty_propagation dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul probabilistic_simulation dan seluruh agent yang bergantung pada uncertainty_propagation.

## Definitions
- uncertainty_propagation: komponen utama yang mengatur enterprise_plus probabilistic_simulation untuk uncertainty_propagation.
...
## Core rules
- uncertainty_propagation hanya mengurus enterprise_plus probabilistic_simulation untuk uncertainty_propagation dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait probabilistic_simulation.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status uncertainty_propagation, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder probabilistic_simulation lain yang relevan.
