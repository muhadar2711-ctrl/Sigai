# explanation_engine/no_trade_explanation

## Purpose
Menetapkan aturan operasional untuk enterprise_plus explanation_engine untuk no_trade_explanation dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul explanation_engine dan seluruh agent yang bergantung pada no_trade_explanation.

## Definitions
- no_trade_explanation: komponen utama yang mengatur enterprise_plus explanation_engine untuk no_trade_explanation.
...
## Core rules
- no_trade_explanation hanya mengurus enterprise_plus explanation_engine untuk no_trade_explanation dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status no_trade_explanation, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
