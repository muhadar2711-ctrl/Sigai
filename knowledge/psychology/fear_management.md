# psychology/fear_management

## Purpose
Menetapkan aturan operasional untuk psychology dan fungsi fear_management dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul psychology dan seluruh agent yang bergantung pada fear_management.

## Definitions
- fear_management: komponen utama yang mengatur psychology dan fungsi fear_management.
...
## Core rules
- fear_management hanya mengurus psychology dan fungsi fear_management dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status fear_management, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
