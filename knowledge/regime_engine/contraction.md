# regime_engine/contraction

## Purpose
Menetapkan aturan operasional untuk regime_engine dan fungsi contraction dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul regime_engine dan seluruh agent yang bergantung pada contraction.

## Definitions
- contraction: komponen utama yang mengatur regime_engine dan fungsi contraction.
...
## Core rules
- contraction hanya mengurus regime_engine dan fungsi contraction dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait regime_engine.
...
## Interactions
- Berinteraksi dengan folder regime_engine lain yang relevan.
