# memory/no_trade_memory

## Purpose
Menetapkan aturan operasional untuk memory dan fungsi no_trade_memory dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul memory dan seluruh agent yang bergantung pada no_trade_memory.

## Definitions
- no_trade_memory: komponen utama yang mengatur memory dan fungsi no_trade_memory.
...
## Core rules
- no_trade_memory hanya mengurus memory dan fungsi no_trade_memory dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status no_trade_memory, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
