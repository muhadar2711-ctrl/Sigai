...
## Purpose
Menetapkan aturan operasional untuk execution dan fungsi risk_management dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul execution dan seluruh agent yang bergantung pada risk_management.

## Definitions
- risk_management: komponen utama yang mengatur execution dan fungsi risk_management.
...
## Core rules
- risk_management hanya mengurus execution dan fungsi risk_management dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status risk_management, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
