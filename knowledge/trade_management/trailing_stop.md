...
## Purpose
Menetapkan aturan operasional untuk trade_management dan fungsi trailing_stop dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul trade_management dan seluruh agent yang bergantung pada trailing_stop.

## Definitions
- trailing_stop: komponen utama yang mengatur trade_management dan fungsi trailing_stop.
...
## Core rules
- trailing_stop hanya mengurus trade_management dan fungsi trailing_stop dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status trailing_stop, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
