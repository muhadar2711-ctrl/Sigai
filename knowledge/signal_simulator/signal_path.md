# signal_simulator/signal_path

## Purpose
Menetapkan aturan operasional untuk signal_simulator dan fungsi signal_path dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul signal_simulator dan seluruh agent yang bergantung pada signal_path.

## Definitions
- signal_path: komponen utama yang mengatur signal_simulator dan fungsi signal_path.
...
## Core rules
- signal_path hanya mengurus signal_simulator dan fungsi signal_path dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status signal_path, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
