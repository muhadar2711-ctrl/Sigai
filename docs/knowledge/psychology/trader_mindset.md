# psychology/trader_mindset

## Purpose
Menetapkan aturan operasional untuk psychology dan fungsi trader_mindset dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul psychology dan seluruh agent yang bergantung pada trader_mindset.

## Definitions
- trader_mindset: komponen utama yang mengatur psychology dan fungsi trader_mindset.
...
## Core rules
- trader_mindset hanya mengurus psychology dan fungsi trader_mindset dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status trader_mindset, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
