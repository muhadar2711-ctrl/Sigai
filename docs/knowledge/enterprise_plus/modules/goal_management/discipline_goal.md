# goal_management/discipline_goal

## Purpose
Menetapkan aturan operasional untuk enterprise_plus goal_management untuk discipline_goal dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul goal_management dan seluruh agent yang bergantung pada discipline_goal.

## Definitions
- discipline_goal: komponen utama yang mengatur enterprise_plus goal_management untuk discipline_goal.
...
## Core rules
- discipline_goal hanya mengurus enterprise_plus goal_management untuk discipline_goal dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status discipline_goal, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
