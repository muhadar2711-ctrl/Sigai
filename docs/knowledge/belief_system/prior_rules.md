# belief_system/prior_rules

## Purpose
Menetapkan aturan operasional untuk belief_system dan fungsi prior_rules dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul belief_system dan seluruh agent yang bergantung pada prior_rules.

## Definitions
- prior_rules: komponen utama yang mengatur belief_system dan fungsi prior_rules.
...
## Core rules
- prior_rules hanya mengurus belief_system dan fungsi prior_rules dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status prior_rules, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
