# portfolio_engine/correlation_matrix

## Purpose
Menetapkan aturan operasional untuk enterprise_plus portfolio_engine untuk correlation_matrix dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul portfolio_engine dan seluruh agent yang bergantung pada correlation_matrix.

## Definitions
- correlation_matrix: komponen utama yang mengatur enterprise_plus portfolio_engine untuk correlation_matrix.
...
## Core rules
- correlation_matrix hanya mengurus enterprise_plus portfolio_engine untuk correlation_matrix dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status correlation_matrix, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
