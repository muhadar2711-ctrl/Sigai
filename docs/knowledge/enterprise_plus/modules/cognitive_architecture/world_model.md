# cognitive_architecture/world_model

## Purpose
Menetapkan aturan operasional untuk enterprise_plus cognitive_architecture untuk world_model dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul cognitive_architecture dan seluruh agent yang bergantung pada world_model.

## Definitions
- world_model: komponen utama yang mengatur enterprise_plus cognitive_architecture untuk world_model.
...
## Core rules
- world_model hanya mengurus enterprise_plus cognitive_architecture untuk world_model dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status world_model, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
