...
## Purpose
Menetapkan aturan operasional untuk strategy dan fungsi ict dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul strategy dan seluruh agent yang bergantung pada ict.

## Definitions
- ict: komponen utama yang mengatur strategy dan fungsi ict.
...
## Core rules
- ict hanya mengurus strategy dan fungsi ict dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status ict, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
