...
## Purpose
Menetapkan aturan operasional untuk backtest dan fungsi walkforward dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul backtest dan seluruh agent yang bergantung pada walkforward.

## Definitions
- walkforward: komponen utama yang mengatur backtest dan fungsi walkforward.
...
## Core rules
- walkforward hanya mengurus backtest dan fungsi walkforward dan tidak boleh mengambil tanggung jawab modul lain.
