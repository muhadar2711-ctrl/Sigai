# planner_engine/priority_plan

## Purpose
Menetapkan aturan operasional untuk planner_engine dan fungsi priority_plan dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul planner_engine dan seluruh agent yang bergantung pada priority_plan.

## Definitions
- priority_plan: komponen utama yang mengatur planner_engine dan fungsi priority_plan.
...
## Core rules
- priority_plan hanya mengurus planner_engine dan fungsi priority_plan dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status priority_plan, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
