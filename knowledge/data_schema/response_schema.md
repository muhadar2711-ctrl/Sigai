...
## Purpose
Menetapkan aturan operasional untuk data_schema dan fungsi response_schema dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul data_schema dan seluruh agent yang bergantung pada response_schema.

## Definitions
- response_schema: komponen utama yang mengatur data_schema dan fungsi response_schema.
...
## Core rules
- response_schema hanya mengurus data_schema dan fungsi response_schema dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status response_schema, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
