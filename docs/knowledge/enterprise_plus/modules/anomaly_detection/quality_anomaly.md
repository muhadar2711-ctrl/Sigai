# anomaly_detection/quality_anomaly

## Purpose
Menetapkan aturan operasional untuk enterprise_plus anomaly_detection untuk quality_anomaly dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul anomaly_detection dan seluruh agent yang bergantung pada quality_anomaly.

## Definitions
- quality_anomaly: komponen utama yang mengatur enterprise_plus anomaly_detection untuk quality_anomaly.
...
## Core rules
- quality_anomaly hanya mengurus enterprise_plus anomaly_detection untuk quality_anomaly dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status quality_anomaly, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
