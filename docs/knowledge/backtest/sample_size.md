...
## Purpose
Menetapkan aturan operasional untuk backtest dan fungsi sample_size dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul backtest dan seluruh agent yang bergantung pada sample_size.

## Definitions
- sample_size: komponen utama yang mengatur backtest dan fungsi sample_size.
...
## Core rules
- sample_size hanya mengurus backtest dan fungsi sample_size dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status sample_size, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
