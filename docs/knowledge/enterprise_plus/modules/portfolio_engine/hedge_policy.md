# portfolio_engine/hedge_policy

## Purpose
Menetapkan aturan operasional untuk enterprise_plus portfolio_engine untuk hedge_policy dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul portfolio_engine dan seluruh agent yang bergantung pada hedge_policy.

## Definitions
- hedge_policy: komponen utama yang mengatur enterprise_plus portfolio_engine untuk hedge_policy.
...
## Core rules
- hedge_policy hanya mengurus enterprise_plus portfolio_engine untuk hedge_policy dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status hedge_policy, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
