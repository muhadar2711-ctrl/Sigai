...
## Purpose
Menetapkan aturan operasional untuk agents dan fungsi verifier_agent dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul agents dan seluruh agent yang bergantung pada verifier_agent.

## Definitions
- verifier_agent: komponen utama yang mengatur agents dan fungsi verifier_agent.
...
## Core rules
- verifier_agent hanya mengurus agents dan fungsi verifier_agent dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status verifier_agent, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
