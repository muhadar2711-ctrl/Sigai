# confidence_engine/source_weighting

## Purpose
Menetapkan aturan operasional untuk enterprise_plus confidence_engine untuk source_weighting dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul confidence_engine dan seluruh agent yang bergantung pada source_weighting.

## Definitions
- source_weighting: komponen utama yang mengatur enterprise_plus confidence_engine untuk source_weighting.
...
## Core rules
- source_weighting hanya mengurus enterprise_plus confidence_engine untuk source_weighting dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status source_weighting, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
