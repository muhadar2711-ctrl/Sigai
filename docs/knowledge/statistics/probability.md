...
## Purpose
Menetapkan aturan operasional untuk statistics dan fungsi probability dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul statistics dan seluruh agent yang bergantung pada probability.

## Definitions
- probability: komponen utama yang mengatur statistics dan fungsi probability.
...
## Core rules
- probability hanya mengurus statistics dan fungsi probability dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status probability, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
