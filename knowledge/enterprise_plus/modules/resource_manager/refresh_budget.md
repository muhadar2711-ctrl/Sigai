# resource_manager/refresh_budget

## Purpose
Menetapkan aturan operasional untuk enterprise_plus resource_manager untuk refresh_budget dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul resource_manager dan seluruh agent yang bergantung pada refresh_budget.

## Definitions
- refresh_budget: komponen utama yang mengatur enterprise_plus resource_manager untuk refresh_budget.
...
## Core rules
- refresh_budget hanya mengurus enterprise_plus resource_manager untuk refresh_budget dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status refresh_budget, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
