# data_schema/prompt_library

## Purpose
Menetapkan aturan operasional untuk data_schema dan fungsi prompt_library dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul data_schema dan seluruh agent yang bergantung pada prompt_library.

## Definitions
- prompt_library: komponen utama yang mengatur data_schema dan fungsi prompt_library.
...
## Core rules
- prompt_library hanya mengurus data_schema dan fungsi prompt_library dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status prompt_library, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
