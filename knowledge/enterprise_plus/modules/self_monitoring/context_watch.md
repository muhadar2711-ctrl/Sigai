# self_monitoring/context_watch

## Purpose
Menetapkan aturan operasional untuk enterprise_plus self_monitoring untuk context_watch dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul self_monitoring dan seluruh agent yang bergantung pada context_watch.

## Definitions
- context_watch: komponen utama yang mengatur enterprise_plus self_monitoring untuk context_watch.
...
## Core rules
- context_watch hanya mengurus enterprise_plus self_monitoring untuk context_watch dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status context_watch, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
