# probability_engine/posterior

## Purpose
Menetapkan aturan operasional untuk probability_engine dan fungsi posterior dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul probability_engine dan seluruh agent yang bergantung pada posterior.

## Definitions
- posterior: komponen utama yang mengatur probability_engine dan fungsi posterior.
...
## Core rules
- posterior hanya mengurus probability_engine dan fungsi posterior dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status posterior, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
