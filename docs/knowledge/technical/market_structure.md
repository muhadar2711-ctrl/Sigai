...
## Purpose
Menetapkan aturan operasional untuk technical dan fungsi market_structure dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul technical dan seluruh agent yang bergantung pada market_structure.

## Definitions
- market_structure: komponen utama yang mengatur technical dan fungsi market_structure.
...
## Core rules
- market_structure hanya mengurus technical dan fungsi market_structure dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status market_structure, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
