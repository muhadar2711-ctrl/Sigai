# explanation_engine/confidence_explanation

## Purpose
Menetapkan aturan operasional untuk enterprise_plus explanation_engine untuk confidence_explanation dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul explanation_engine dan seluruh agent yang bergantung pada confidence_explanation.

## Definitions
- confidence_explanation: komponen utama yang mengatur enterprise_plus explanation_engine untuk confidence_explanation.
...
## Core rules
- confidence_explanation hanya mengurus enterprise_plus explanation_engine untuk confidence_explanation dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait explanation_engine.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status confidence_explanation, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder explanation_engine lain yang relevan.
