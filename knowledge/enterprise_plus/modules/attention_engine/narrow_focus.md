# attention_engine/narrow_focus

## Purpose
Menetapkan aturan operasional untuk enterprise_plus attention_engine untuk narrow_focus dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul attention_engine dan seluruh agent yang bergantung pada narrow_focus.

## Definitions
- narrow_focus: komponen utama yang mengatur enterprise_plus attention_engine untuk narrow_focus.
...
## Core rules
- narrow_focus hanya mengurus enterprise_plus attention_engine untuk narrow_focus dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status narrow_focus, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
