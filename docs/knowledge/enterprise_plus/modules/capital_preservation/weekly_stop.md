# capital_preservation/weekly_stop

## Purpose
Menetapkan aturan operasional untuk enterprise_plus capital_preservation untuk weekly_stop dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul capital_preservation dan seluruh agent yang bergantung pada weekly_stop.

## Definitions
- weekly_stop: komponen utama yang mengatur enterprise_plus capital_preservation untuk weekly_stop.
...
## Core rules
- weekly_stop hanya mengurus enterprise_plus capital_preservation untuk weekly_stop dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status weekly_stop, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
