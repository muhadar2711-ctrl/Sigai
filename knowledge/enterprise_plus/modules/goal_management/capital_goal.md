# goal_management/capital_goal

## Purpose
Menetapkan aturan operasional untuk enterprise_plus goal_management untuk capital_goal dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul goal_management dan seluruh agent yang bergantung pada capital_goal.

## Definitions
- capital_goal: komponen utama yang mengatur enterprise_plus goal_management untuk capital_goal.
...
## Core rules
- capital_goal hanya mengurus enterprise_plus goal_management untuk capital_goal dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status capital_goal, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
