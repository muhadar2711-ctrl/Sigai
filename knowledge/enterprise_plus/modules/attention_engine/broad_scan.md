# attention_engine/broad_scan

## Purpose
Menetapkan aturan operasional untuk enterprise_plus attention_engine untuk broad_scan dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul attention_engine dan seluruh agent yang bergantung pada broad_scan.

## Definitions
- broad_scan: komponen utama yang mengatur enterprise_plus attention_engine untuk broad_scan.
...
## Core rules
- broad_scan hanya mengurus enterprise_plus attention_engine untuk broad_scan dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status broad_scan, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
