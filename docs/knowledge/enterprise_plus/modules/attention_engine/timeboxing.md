# attention_engine/timeboxing

## Purpose
Menetapkan aturan operasional untuk enterprise_plus attention_engine untuk timeboxing dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul attention_engine dan seluruh agent yang bergantung pada timeboxing.

## Definitions
- timeboxing: komponen utama yang mengatur enterprise_plus attention_engine untuk timeboxing.
...
## Core rules
- timeboxing hanya mengurus enterprise_plus attention_engine untuk timeboxing dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status timeboxing, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
