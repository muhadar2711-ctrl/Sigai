...
## Purpose
Menetapkan aturan operasional untuk agents dan fungsi execution_agent dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul agents dan seluruh agent yang bergantung pada execution_agent.

## Definitions
- execution_agent: komponen utama yang mengatur agents dan fungsi execution_agent.
...
## Core rules
- execution_agent hanya mengurus agents dan fungsi execution_agent dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status execution_agent, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
