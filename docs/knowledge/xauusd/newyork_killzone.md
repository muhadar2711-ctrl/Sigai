# xauusd/newyork_killzone

## Purpose
Menetapkan aturan operasional untuk xauusd dan fungsi newyork_killzone dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul xauusd dan seluruh agent yang bergantung pada newyork_killzone.

## Definitions
- newyork_killzone: komponen utama yang mengatur xauusd dan fungsi newyork_killzone.
...
## Core rules
- newyork_killzone hanya mengurus xauusd dan fungsi newyork_killzone dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status newyork_killzone, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
