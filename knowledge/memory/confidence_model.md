# memory/confidence_model

## Purpose
Menetapkan aturan operasional untuk memory dan fungsi confidence_model dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul memory dan seluruh agent yang bergantung pada confidence_model.

## Definitions
- confidence_model: komponen utama yang mengatur memory dan fungsi confidence_model.
...
## Core rules
- confidence_model hanya mengurus memory dan fungsi confidence_model dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status confidence_model, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
