# attention_engine/context_priority

## Purpose
Menetapkan aturan operasional untuk enterprise_plus attention_engine untuk context_priority dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul attention_engine dan seluruh agent yang bergantung pada context_priority.

## Definitions
- context_priority: komponen utama yang mengatur enterprise_plus attention_engine untuk context_priority.
...
## Core rules
- context_priority hanya mengurus enterprise_plus attention_engine untuk context_priority dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status context_priority, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
