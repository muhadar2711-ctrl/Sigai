# verification/risk_validation

## Purpose
Menetapkan aturan operasional untuk verification dan fungsi risk_validation dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul verification dan seluruh agent yang bergantung pada risk_validation.

## Definitions
- risk_validation: komponen utama yang mengatur verification dan fungsi risk_validation.
...
## Core rules
- risk_validation hanya mengurus verification dan fungsi risk_validation dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status risk_validation, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
