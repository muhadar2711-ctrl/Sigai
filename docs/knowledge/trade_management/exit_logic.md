# trade_management/exit_logic

## Purpose
Menetapkan aturan operasional untuk trade_management dan fungsi exit_logic dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul trade_management dan seluruh agent yang bergantung pada exit_logic.

## Definitions
- exit_logic: komponen utama yang mengatur trade_management dan fungsi exit_logic.
...
## Core rules
- exit_logic hanya mengurus trade_management dan fungsi exit_logic dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status exit_logic, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
