# anomaly_detection/spread_anomaly

## Purpose
Menetapkan aturan operasional untuk enterprise_plus anomaly_detection untuk spread_anomaly dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul anomaly_detection dan seluruh agent yang bergantung pada spread_anomaly.

## Definitions
- spread_anomaly: komponen utama yang mengatur enterprise_plus anomaly_detection untuk spread_anomaly.
...
## Core rules
- spread_anomaly hanya mengurus enterprise_plus anomaly_detection untuk spread_anomaly dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status spread_anomaly, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
