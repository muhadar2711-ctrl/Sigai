# execution_guard/spread_guard

## Purpose
Menetapkan aturan operasional untuk enterprise_plus execution_guard untuk spread_guard dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul execution_guard dan seluruh agent yang bergantung pada spread_guard.

## Definitions
- spread_guard: komponen utama yang mengatur enterprise_plus execution_guard untuk spread_guard.
...
## Core rules
- spread_guard hanya mengurus enterprise_plus execution_guard untuk spread_guard dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status spread_guard, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
