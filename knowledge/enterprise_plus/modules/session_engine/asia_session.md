# session_engine/asia_session

## Purpose
Menetapkan aturan operasional untuk enterprise_plus session_engine untuk asia_session dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul session_engine dan seluruh agent yang bergantung pada asia_session.

## Definitions
- asia_session: komponen utama yang mengatur enterprise_plus session_engine untuk asia_session.
...
## Core rules
- asia_session hanya mengurus enterprise_plus session_engine untuk asia_session dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status asia_session, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
