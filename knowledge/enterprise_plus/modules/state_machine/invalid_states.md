# state_machine/invalid_states

## Purpose
Menetapkan aturan operasional untuk enterprise_plus state_machine untuk invalid_states dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul state_machine dan seluruh agent yang bergantung pada invalid_states.

## Definitions
- invalid_states: komponen utama yang mengatur enterprise_plus state_machine untuk invalid_states.
...
## Core rules
- invalid_states hanya mengurus enterprise_plus state_machine untuk invalid_states dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status invalid_states, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
