# simulation_engine/stress_paths

## Purpose
Menetapkan aturan operasional untuk simulation_engine dan fungsi stress_paths dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul simulation_engine dan seluruh agent yang bergantung pada stress_paths.

## Definitions
- stress_paths: komponen utama yang mengatur simulation_engine dan fungsi stress_paths.
...
## Core rules
- stress_paths hanya mengurus simulation_engine dan fungsi stress_paths dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status stress_paths, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
