# executor_engine/fail_safe

## Purpose
Menetapkan aturan operasional untuk executor_engine dan fungsi fail_safe dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul executor_engine dan seluruh agent yang bergantung pada fail_safe.

## Definitions
- fail_safe: komponen utama yang mengatur executor_engine dan fungsi fail_safe.
...
## Core rules
- fail_safe hanya mengurus executor_engine dan fungsi fail_safe dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status fail_safe, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
