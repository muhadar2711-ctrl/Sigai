# learning_engine/pattern_learning

## Purpose
Menetapkan aturan operasional untuk learning_engine dan fungsi pattern_learning dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul learning_engine dan seluruh agent yang bergantung pada pattern_learning.

## Definitions
- pattern_learning: komponen utama yang mengatur learning_engine dan fungsi pattern_learning.
...
## Core rules
- pattern_learning hanya mengurus learning_engine dan fungsi pattern_learning dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status pattern_learning, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
