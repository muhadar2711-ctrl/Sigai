# execution/slippage_control

## Purpose
Menetapkan aturan operasional untuk execution dan fungsi slippage_control dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul execution dan seluruh agent yang bergantung pada slippage_control.

## Definitions
- slippage_control: komponen utama yang mengatur execution dan fungsi slippage_control.
...
## Core rules
- slippage_control hanya mengurus execution dan fungsi slippage_control dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status slippage_control, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
