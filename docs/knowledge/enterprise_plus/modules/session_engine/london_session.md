# session_engine/london_session

## Purpose
Menetapkan aturan operasional untuk enterprise_plus session_engine untuk london_session dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul session_engine dan seluruh agent yang bergantung pada london_session.

## Definitions
- london_session: komponen utama yang mengatur enterprise_plus session_engine untuk london_session.
...
## Core rules
- london_session hanya mengurus enterprise_plus session_engine untuk london_session dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status london_session, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
