# volatility_engine/atr_model

## Purpose
Menetapkan aturan operasional untuk enterprise_plus volatility_engine untuk atr_model dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul volatility_engine dan seluruh agent yang bergantung pada atr_model.

## Definitions
- atr_model: komponen utama yang mengatur enterprise_plus volatility_engine untuk atr_model.
...
## Core rules
- atr_model hanya mengurus enterprise_plus volatility_engine untuk atr_model dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status atr_model, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
