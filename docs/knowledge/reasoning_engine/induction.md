# reasoning_engine/induction

## Purpose
Menetapkan aturan operasional untuk reasoning_engine dan fungsi induction dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul reasoning_engine dan seluruh agent yang bergantung pada induction.

## Definitions
- induction: komponen utama yang mengatur reasoning_engine dan fungsi induction.
...
## Core rules
- induction hanya mengurus reasoning_engine dan fungsi induction dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status induction, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
