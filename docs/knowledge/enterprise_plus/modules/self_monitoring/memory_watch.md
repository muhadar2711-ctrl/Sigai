# self_monitoring/memory_watch

## Purpose
Menetapkan aturan operasional untuk enterprise_plus self_monitoring untuk memory_watch dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul self_monitoring dan seluruh agent yang bergantung pada memory_watch.

## Definitions
- memory_watch: komponen utama yang mengatur enterprise_plus self_monitoring untuk memory_watch.
...
## Core rules
- memory_watch hanya mengurus enterprise_plus self_monitoring untuk memory_watch dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status memory_watch, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
