# inference_engine/certainty_model

## Purpose
Menetapkan aturan operasional untuk enterprise_plus inference_engine untuk certainty_model dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul inference_engine dan seluruh agent yang bergantung pada certainty_model.

## Definitions
- certainty_model: komponen utama yang mengatur enterprise_plus inference_engine untuk certainty_model.
...
## Core rules
- certainty_model hanya mengurus enterprise_plus inference_engine untuk certainty_model dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status certainty_model, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
