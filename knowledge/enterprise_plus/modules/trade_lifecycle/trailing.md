# trade_lifecycle/trailing

## Purpose
Menetapkan aturan operasional untuk enterprise_plus trade_lifecycle untuk trailing dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul trade_lifecycle dan seluruh agent yang bergantung pada trailing.

## Definitions
- trailing: komponen utama yang mengatur enterprise_plus trade_lifecycle untuk trailing.
...
## Core rules
- trailing hanya mengurus enterprise_plus trade_lifecycle untuk trailing dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status trailing, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
