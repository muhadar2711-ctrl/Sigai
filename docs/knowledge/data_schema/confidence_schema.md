# data_schema/confidence_schema

## Purpose
Menetapkan aturan operasional untuk data_schema dan fungsi confidence_schema dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul data_schema dan seluruh agent yang bergantung pada confidence_schema.

## Definitions
- confidence_schema: komponen utama yang mengatur data_schema dan fungsi confidence_schema.
...
## Core rules
- confidence_schema hanya mengurus data_schema dan fungsi confidence_schema dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait data_schema.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status confidence_schema, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder data_schema lain yang relevan.
