# memory_graph/pruning

## Purpose
Menetapkan aturan operasional untuk memory_graph dan fungsi pruning dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul memory_graph dan seluruh agent yang bergantung pada pruning.

## Definitions
- pruning: komponen utama yang mengatur memory_graph dan fungsi pruning.
...
## Core rules
- pruning hanya mengurus memory_graph dan fungsi pruning dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status pruning, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
