# supervisor_engine/escalation

## Purpose
Menetapkan aturan operasional untuk supervisor_engine dan fungsi escalation dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul supervisor_engine dan seluruh agent yang bergantung pada escalation.

## Definitions
- escalation: komponen utama yang mengatur supervisor_engine dan fungsi escalation.
...
## Core rules
- escalation hanya mengurus supervisor_engine dan fungsi escalation dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status escalation, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
