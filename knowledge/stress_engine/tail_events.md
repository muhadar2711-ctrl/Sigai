# stress_engine/tail_events

## Purpose
Menetapkan aturan operasional untuk stress_engine dan fungsi tail_events dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul stress_engine dan seluruh agent yang bergantung pada tail_events.

## Definitions
- tail_events: komponen utama yang mengatur stress_engine dan fungsi tail_events.
...
## Core rules
- tail_events hanya mengurus stress_engine dan fungsi tail_events dan tidak boleh mengambil tanggung jawab modul lain.
