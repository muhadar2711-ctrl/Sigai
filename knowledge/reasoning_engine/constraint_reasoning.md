# reasoning_engine/constraint_reasoning

## Purpose
Menetapkan aturan operasional untuk reasoning_engine dan fungsi constraint_reasoning dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul reasoning_engine dan seluruh agent yang bergantung pada constraint_reasoning.

## Definitions
- constraint_reasoning: komponen utama yang mengatur reasoning_engine dan fungsi constraint_reasoning.
...
## Core rules
- constraint_reasoning hanya mengurus reasoning_engine dan fungsi constraint_reasoning dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status constraint_reasoning, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
