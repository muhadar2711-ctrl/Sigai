...
## Purpose
Menetapkan aturan operasional untuk fundamental dan fungsi macroeconomics dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul fundamental dan seluruh agent yang bergantung pada macroeconomics.

## Definitions
- macroeconomics: komponen utama yang mengatur fundamental dan fungsi macroeconomics.
...
## Core rules
- macroeconomics hanya mengurus fundamental dan fungsi macroeconomics dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status macroeconomics, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
