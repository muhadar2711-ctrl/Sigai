# verification/confidence_validation

## Purpose
Menetapkan aturan operasional untuk verification dan fungsi confidence_validation dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul verification dan seluruh agent yang bergantung pada confidence_validation.

## Definitions
- confidence_validation: komponen utama yang mengatur verification dan fungsi confidence_validation.
...
## Core rules
- confidence_validation hanya mengurus verification dan fungsi confidence_validation dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status confidence_validation, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
