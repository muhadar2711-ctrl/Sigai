# regime_engine/trending

## Purpose
Menetapkan aturan operasional untuk regime_engine dan fungsi trending dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul regime_engine dan seluruh agent yang bergantung pada trending.

## Definitions
- trending: komponen utama yang mengatur regime_engine dan fungsi trending.
...
## Core rules
- trending hanya mengurus regime_engine dan fungsi trending dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status trending, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
