# goal_management/priority_goal

## Purpose
Menetapkan aturan operasional untuk enterprise_plus goal_management untuk priority_goal dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul goal_management dan seluruh agent yang bergantung pada priority_goal.

## Definitions
- priority_goal: komponen utama yang mengatur enterprise_plus goal_management untuk priority_goal.
...
## Core rules
- priority_goal hanya mengurus enterprise_plus goal_management untuk priority_goal dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status priority_goal, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
