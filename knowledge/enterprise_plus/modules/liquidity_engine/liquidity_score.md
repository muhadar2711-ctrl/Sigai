# liquidity_engine/liquidity_score

## Purpose
Menetapkan aturan operasional untuk enterprise_plus liquidity_engine untuk liquidity_score dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul liquidity_engine dan seluruh agent yang bergantung pada liquidity_score.

## Definitions
- liquidity_score: komponen utama yang mengatur enterprise_plus liquidity_engine untuk liquidity_score.
...
## Core rules
- liquidity_score hanya mengurus enterprise_plus liquidity_engine untuk liquidity_score dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status liquidity_score, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
