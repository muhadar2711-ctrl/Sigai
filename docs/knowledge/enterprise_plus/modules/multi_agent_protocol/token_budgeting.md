# multi_agent_protocol/token_budgeting

## Purpose
Menetapkan aturan operasional untuk enterprise_plus multi_agent_protocol untuk token_budgeting dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul multi_agent_protocol dan seluruh agent yang bergantung pada token_budgeting.

## Definitions
- token_budgeting: komponen utama yang mengatur enterprise_plus multi_agent_protocol untuk token_budgeting.
...
## Core rules
- token_budgeting hanya mengurus enterprise_plus multi_agent_protocol untuk token_budgeting dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status token_budgeting, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
