# execution/no_trade_rules

## Purpose
Menetapkan aturan operasional untuk execution dan fungsi no_trade_rules dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul execution dan seluruh agent yang bergantung pada no_trade_rules.

## Definitions
- no_trade_rules: komponen utama yang mengatur execution dan fungsi no_trade_rules.
...
## Core rules
- no_trade_rules hanya mengurus execution dan fungsi no_trade_rules dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status no_trade_rules, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
