# state_engine/state_snapshot

## Purpose
Menetapkan aturan operasional untuk state_engine dan fungsi state_snapshot dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul state_engine dan seluruh agent yang bergantung pada state_snapshot.

## Definitions
- state_snapshot: komponen utama yang mengatur state_engine dan fungsi state_snapshot.
...
## Core rules
- state_snapshot hanya mengurus state_engine dan fungsi state_snapshot dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status state_snapshot, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
