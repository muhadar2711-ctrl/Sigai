# research/liquidity_study

## Purpose
Menetapkan aturan operasional untuk research dan fungsi liquidity_study dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul research dan seluruh agent yang bergantung pada liquidity_study.

## Definitions
- liquidity_study: komponen utama yang mengatur research dan fungsi liquidity_study.
...
## Core rules
- liquidity_study hanya mengurus research dan fungsi liquidity_study dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status liquidity_study, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
