...
## Purpose
Menetapkan aturan operasional untuk models dan fungsi trend_model dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul models dan seluruh agent yang bergantung pada trend_model.

## Definitions
- trend_model: komponen utama yang mengatur models dan fungsi trend_model.
...
## Core rules
- trend_model hanya mengurus models dan fungsi trend_model dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status trend_model, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
