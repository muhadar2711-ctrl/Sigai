# volatility_engine/contraction

## Purpose
Menetapkan aturan operasional untuk enterprise_plus volatility_engine untuk contraction dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul volatility_engine dan seluruh agent yang bergantung pada contraction.

## Definitions
- contraction: komponen utama yang mengatur enterprise_plus volatility_engine untuk contraction.
...
## Core rules
- contraction hanya mengurus enterprise_plus volatility_engine untuk contraction dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status contraction, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
