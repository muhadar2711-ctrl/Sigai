# reflection_engine/post_trade_review

## Purpose
Menetapkan aturan operasional untuk reflection_engine dan fungsi post_trade_review dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul reflection_engine dan seluruh agent yang bergantung pada post_trade_review.

## Definitions
- post_trade_review: komponen utama yang mengatur reflection_engine dan fungsi post_trade_review.
...
## Core rules
- post_trade_review hanya mengurus reflection_engine dan fungsi post_trade_review dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status post_trade_review, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
