# consensus_engine/veto

## Purpose
Menetapkan aturan operasional untuk consensus_engine dan fungsi veto dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul consensus_engine dan seluruh agent yang bergantung pada veto.

## Definitions
- veto: komponen utama yang mengatur consensus_engine dan fungsi veto.
...
## Core rules
- veto hanya mengurus consensus_engine dan fungsi veto dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status veto, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
