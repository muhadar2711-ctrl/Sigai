# evaluation_engine/miss_rate

## Purpose
Menetapkan aturan operasional untuk evaluation_engine dan fungsi miss_rate dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul evaluation_engine dan seluruh agent yang bergantung pada miss_rate.

## Definitions
- miss_rate: komponen utama yang mengatur evaluation_engine dan fungsi miss_rate.
...
## Core rules
- miss_rate hanya mengurus evaluation_engine dan fungsi miss_rate dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status miss_rate, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
