# liquidity_engine/sweep_detection

## Purpose
Menetapkan aturan operasional untuk enterprise_plus liquidity_engine untuk sweep_detection dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul liquidity_engine dan seluruh agent yang bergantung pada sweep_detection.

## Definitions
- sweep_detection: komponen utama yang mengatur enterprise_plus liquidity_engine untuk sweep_detection.
...
## Core rules
- sweep_detection hanya mengurus enterprise_plus liquidity_engine untuk sweep_detection dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status sweep_detection, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
