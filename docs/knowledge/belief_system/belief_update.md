# belief_system/belief_update

## Purpose
Menetapkan aturan operasional untuk belief_system dan fungsi belief_update dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul belief_system dan seluruh agent yang bergantung pada belief_update.

## Definitions
- belief_update: komponen utama yang mengatur belief_system dan fungsi belief_update.
...
## Core rules
- belief_update hanya mengurus belief_system dan fungsi belief_update dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status belief_update, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
