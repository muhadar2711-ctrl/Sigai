# liquidity_engine/bsl_ssl

## Purpose
Menetapkan aturan operasional untuk enterprise_plus liquidity_engine untuk bsl_ssl dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul liquidity_engine dan seluruh agent yang bergantung pada bsl_ssl.

## Definitions
- bsl_ssl: komponen utama yang mengatur enterprise_plus liquidity_engine untuk bsl_ssl.
...
## Core rules
- bsl_ssl hanya mengurus enterprise_plus liquidity_engine untuk bsl_ssl dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status bsl_ssl, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
