# resource_manager/fallback_budget

## Purpose
Menetapkan aturan operasional untuk enterprise_plus resource_manager untuk fallback_budget dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul resource_manager dan seluruh agent yang bergantung pada fallback_budget.

## Definitions
- fallback_budget: komponen utama yang mengatur enterprise_plus resource_manager untuk fallback_budget.
...
## Core rules
- fallback_budget hanya mengurus enterprise_plus resource_manager untuk fallback_budget dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status fallback_budget, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
