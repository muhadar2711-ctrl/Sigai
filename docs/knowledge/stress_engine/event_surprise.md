# stress_engine/event_surprise

## Purpose
Menetapkan aturan operasional untuk stress_engine dan fungsi event_surprise dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul stress_engine dan seluruh agent yang bergantung pada event_surprise.

## Definitions
- event_surprise: komponen utama yang mengatur stress_engine dan fungsi event_surprise.
...
## Core rules
- event_surprise hanya mengurus stress_engine dan fungsi event_surprise dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status event_surprise, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
