# policy_engine/approval_policy

## Purpose
Menetapkan aturan operasional untuk enterprise_plus policy_engine untuk approval_policy dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul policy_engine dan seluruh agent yang bergantung pada approval_policy.

## Definitions
- approval_policy: komponen utama yang mengatur enterprise_plus policy_engine untuk approval_policy.
...
## Core rules
- approval_policy hanya mengurus enterprise_plus policy_engine untuk approval_policy dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status approval_policy, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
