# memory_graph/query_rules

## Purpose
Menetapkan aturan operasional untuk memory_graph dan fungsi query_rules dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul memory_graph dan seluruh agent yang bergantung pada query_rules.

## Definitions
- query_rules: komponen utama yang mengatur memory_graph dan fungsi query_rules.
...
## Core rules
- query_rules hanya mengurus memory_graph dan fungsi query_rules dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait memory_graph.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status query_rules, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder memory_graph lain yang relevan.
