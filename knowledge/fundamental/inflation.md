...
## Purpose
Menetapkan aturan operasional untuk fundamental dan fungsi inflation dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul fundamental dan seluruh agent yang bergantung pada inflation.

## Definitions
- inflation: komponen utama yang mengatur fundamental dan fungsi inflation.
...
## Core rules
- inflation hanya mengurus fundamental dan fungsi inflation dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status inflation, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
