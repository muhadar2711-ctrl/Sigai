# observer_engine/signal_watch

## Purpose
Menetapkan aturan operasional untuk observer_engine dan fungsi signal_watch dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul observer_engine dan seluruh agent yang bergantung pada signal_watch.

## Definitions
- signal_watch: komponen utama yang mengatur observer_engine dan fungsi signal_watch.
...
## Core rules
- signal_watch hanya mengurus observer_engine dan fungsi signal_watch dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status signal_watch, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
