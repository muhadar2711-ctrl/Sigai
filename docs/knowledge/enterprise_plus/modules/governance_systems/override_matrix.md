# governance_systems/override_matrix

## Purpose
Menetapkan aturan operasional untuk enterprise_plus governance_systems untuk override_matrix dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul governance_systems dan seluruh agent yang bergantung pada override_matrix.

## Definitions
- override_matrix: komponen utama yang mengatur enterprise_plus governance_systems untuk override_matrix.
...
## Core rules
- override_matrix hanya mengurus enterprise_plus governance_systems untuk override_matrix dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status override_matrix, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
