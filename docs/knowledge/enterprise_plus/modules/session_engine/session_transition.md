# session_engine/session_transition

## Purpose
Menetapkan aturan operasional untuk enterprise_plus session_engine untuk session_transition dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul session_engine dan seluruh agent yang bergantung pada session_transition.

## Definitions
- session_transition: komponen utama yang mengatur enterprise_plus session_engine untuk session_transition.
...
## Core rules
- session_transition hanya mengurus enterprise_plus session_engine untuk session_transition dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait session_engine.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status session_transition, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder session_engine lain yang relevan.
