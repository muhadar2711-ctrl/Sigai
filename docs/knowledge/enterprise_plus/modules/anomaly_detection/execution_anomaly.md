# anomaly_detection/execution_anomaly

## Purpose
Menetapkan aturan operasional untuk enterprise_plus anomaly_detection untuk execution_anomaly dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul anomaly_detection dan seluruh agent yang bergantung pada execution_anomaly.

## Definitions
- execution_anomaly: komponen utama yang mengatur enterprise_plus anomaly_detection untuk execution_anomaly.
...
## Core rules
- execution_anomaly hanya mengurus enterprise_plus anomaly_detection untuk execution_anomaly dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status execution_anomaly, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
