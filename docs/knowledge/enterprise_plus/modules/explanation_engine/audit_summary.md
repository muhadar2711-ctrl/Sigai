# explanation_engine/audit_summary

## Purpose
Menetapkan aturan operasional untuk enterprise_plus explanation_engine untuk audit_summary dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul explanation_engine dan seluruh agent yang bergantung pada audit_summary.

## Definitions
- audit_summary: komponen utama yang mengatur enterprise_plus explanation_engine untuk audit_summary.
...
## Core rules
- audit_summary hanya mengurus enterprise_plus explanation_engine untuk audit_summary dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status audit_summary, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
