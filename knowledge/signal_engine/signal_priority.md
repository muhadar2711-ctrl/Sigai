# signal_engine/signal_priority

## Purpose
Menetapkan aturan operasional untuk signal_engine dan fungsi signal_priority dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul signal_engine dan seluruh agent yang bergantung pada signal_priority.

## Definitions
- signal_priority: komponen utama yang mengatur signal_engine dan fungsi signal_priority.
...
## Core rules
- signal_priority hanya mengurus signal_engine dan fungsi signal_priority dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status signal_priority, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
