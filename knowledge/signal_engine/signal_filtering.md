# signal_engine/signal_filtering

## Purpose
Menetapkan aturan operasional untuk signal_engine dan fungsi signal_filtering dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul signal_engine dan seluruh agent yang bergantung pada signal_filtering.

## Definitions
- signal_filtering: komponen utama yang mengatur signal_engine dan fungsi signal_filtering.
...
## Core rules
- signal_filtering hanya mengurus signal_engine dan fungsi signal_filtering dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status signal_filtering, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
