# portfolio_engine/asset_rotation

## Purpose
Menetapkan aturan operasional untuk enterprise_plus portfolio_engine untuk asset_rotation dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul portfolio_engine dan seluruh agent yang bergantung pada asset_rotation.

## Definitions
- asset_rotation: komponen utama yang mengatur enterprise_plus portfolio_engine untuk asset_rotation.
...
## Core rules
- asset_rotation hanya mengurus enterprise_plus portfolio_engine untuk asset_rotation dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status asset_rotation, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
