# world_model/bias_state

## Purpose
Menetapkan aturan operasional untuk world_model dan fungsi bias_state dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul world_model dan seluruh agent yang bergantung pada bias_state.

## Definitions
- bias_state: komponen utama yang mengatur world_model dan fungsi bias_state.
...
## Core rules
- bias_state hanya mengurus world_model dan fungsi bias_state dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status bias_state, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
