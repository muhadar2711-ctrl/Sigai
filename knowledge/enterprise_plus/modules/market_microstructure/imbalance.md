# market_microstructure/imbalance

## Purpose
Menetapkan aturan operasional untuk enterprise_plus market_microstructure untuk imbalance dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul market_microstructure dan seluruh agent yang bergantung pada imbalance.

## Definitions
- imbalance: komponen utama yang mengatur enterprise_plus market_microstructure untuk imbalance.
...
## Core rules
- imbalance hanya mengurus enterprise_plus market_microstructure untuk imbalance dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status imbalance, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
