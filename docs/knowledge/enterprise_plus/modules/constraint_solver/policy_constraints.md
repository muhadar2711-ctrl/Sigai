# constraint_solver/policy_constraints

## Purpose
Menetapkan aturan operasional untuk enterprise_plus constraint_solver untuk policy_constraints dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul constraint_solver dan seluruh agent yang bergantung pada policy_constraints.

## Definitions
- policy_constraints: komponen utama yang mengatur enterprise_plus constraint_solver untuk policy_constraints.
...
## Core rules
- policy_constraints hanya mengurus enterprise_plus constraint_solver untuk policy_constraints dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status policy_constraints, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
