# filters/liquidity_filter

## Purpose
Menetapkan aturan operasional untuk filters dan fungsi liquidity_filter dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul filters dan seluruh agent yang bergantung pada liquidity_filter.

## Definitions
- liquidity_filter: komponen utama yang mengatur filters dan fungsi liquidity_filter.
...
## Core rules
- liquidity_filter hanya mengurus filters dan fungsi liquidity_filter dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait filters.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status liquidity_filter, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder filters lain yang relevan.
