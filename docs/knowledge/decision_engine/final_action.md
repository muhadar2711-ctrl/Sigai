# decision_engine/final_action

## Purpose
Menetapkan aturan operasional untuk decision_engine dan fungsi final_action dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul decision_engine dan seluruh agent yang bergantung pada final_action.

## Definitions
- final_action: komponen utama yang mengatur decision_engine dan fungsi final_action.
...
## Core rules
- final_action hanya mengurus decision_engine dan fungsi final_action dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status final_action, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
