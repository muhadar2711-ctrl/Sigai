...
## Purpose
Menetapkan aturan operasional untuk technical dan fungsi indicators dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul technical dan seluruh agent yang bergantung pada indicators.

## Definitions
- indicators: komponen utama yang mengatur technical dan fungsi indicators.
...
## Core rules
- indicators hanya mengurus technical dan fungsi indicators dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status indicators, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
