# trade_lifecycle/management

## Purpose
Menetapkan aturan operasional untuk enterprise_plus trade_lifecycle untuk management dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul trade_lifecycle dan seluruh agent yang bergantung pada management.

## Definitions
- management: komponen utama yang mengatur enterprise_plus trade_lifecycle untuk management.
...
## Core rules
- management hanya mengurus enterprise_plus trade_lifecycle untuk management dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait trade_lifecycle.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status management, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder trade_lifecycle lain yang relevan.
