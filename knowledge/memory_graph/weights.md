# memory_graph/weights

## Purpose
Menetapkan aturan operasional untuk memory_graph dan fungsi weights dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul memory_graph dan seluruh agent yang bergantung pada weights.

## Definitions
- weights: komponen utama yang mengatur memory_graph dan fungsi weights.
...
## Core rules
- weights hanya mengurus memory_graph dan fungsi weights dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status weights, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
