# evaluation_engine/hit_rate

## Purpose
Menetapkan aturan operasional untuk evaluation_engine dan fungsi hit_rate dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul evaluation_engine dan seluruh agent yang bergantung pada hit_rate.

## Definitions
- hit_rate: komponen utama yang mengatur evaluation_engine dan fungsi hit_rate.
...
## Core rules
- hit_rate hanya mengurus evaluation_engine dan fungsi hit_rate dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status hit_rate, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
