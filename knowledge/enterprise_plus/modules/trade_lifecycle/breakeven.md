# trade_lifecycle/breakeven

## Purpose
Menetapkan aturan operasional untuk enterprise_plus trade_lifecycle untuk breakeven dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul trade_lifecycle dan seluruh agent yang bergantung pada breakeven.

## Definitions
- breakeven: komponen utama yang mengatur enterprise_plus trade_lifecycle untuk breakeven.
...
## Core rules
- breakeven hanya mengurus enterprise_plus trade_lifecycle untuk breakeven dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status breakeven, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
