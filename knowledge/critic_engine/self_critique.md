# critic_engine/self_critique

## Purpose
Menetapkan aturan operasional untuk critic_engine dan fungsi self_critique dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul critic_engine dan seluruh agent yang bergantung pada self_critique.

## Definitions
- self_critique: komponen utama yang mengatur critic_engine dan fungsi self_critique.
...
## Core rules
- self_critique hanya mengurus critic_engine dan fungsi self_critique dan tidak boleh mengambil tanggung jawab modul lain.
