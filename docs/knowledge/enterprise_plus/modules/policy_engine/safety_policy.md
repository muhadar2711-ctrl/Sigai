# policy_engine/safety_policy

## Purpose
Menetapkan aturan operasional untuk enterprise_plus policy_engine untuk safety_policy dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul policy_engine dan seluruh agent yang bergantung pada safety_policy.

## Definitions
- safety_policy: komponen utama yang mengatur enterprise_plus policy_engine untuk safety_policy.
...
## Core rules
- safety_policy hanya mengurus enterprise_plus policy_engine untuk safety_policy dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status safety_policy, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
