# resource_manager/compute_budget

## Purpose
Menetapkan aturan operasional untuk enterprise_plus resource_manager untuk compute_budget dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul resource_manager dan seluruh agent yang bergantung pada compute_budget.

## Definitions
- compute_budget: komponen utama yang mengatur enterprise_plus resource_manager untuk compute_budget.
...
## Core rules
- compute_budget hanya mengurus enterprise_plus resource_manager untuk compute_budget dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status compute_budget, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
