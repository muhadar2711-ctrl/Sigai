...
## Purpose
Menetapkan aturan operasional untuk performance dan fungsi winrate dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul performance dan seluruh agent yang bergantung pada winrate.

## Definitions
- winrate: komponen utama yang mengatur performance dan fungsi winrate.
...
## Core rules
- winrate hanya mengurus performance dan fungsi winrate dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status winrate, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
