# experience_learning/reflection

## Purpose
Menetapkan aturan operasional untuk enterprise_plus experience_learning untuk reflection dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul experience_learning dan seluruh agent yang bergantung pada reflection.

## Definitions
- reflection: komponen utama yang mengatur enterprise_plus experience_learning untuk reflection.
...
## Core rules
- reflection hanya mengurus enterprise_plus experience_learning untuk reflection dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status reflection, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
