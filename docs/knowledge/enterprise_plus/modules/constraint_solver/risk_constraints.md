# constraint_solver/risk_constraints

## Purpose
Menetapkan aturan operasional untuk enterprise_plus constraint_solver untuk risk_constraints dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul constraint_solver dan seluruh agent yang bergantung pada risk_constraints.

## Definitions
- risk_constraints: komponen utama yang mengatur enterprise_plus constraint_solver untuk risk_constraints.
...
## Core rules
- risk_constraints hanya mengurus enterprise_plus constraint_solver untuk risk_constraints dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status risk_constraints, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
