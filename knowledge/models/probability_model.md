# models/probability_model

## Purpose
Menetapkan aturan operasional untuk models dan fungsi probability_model dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul models dan seluruh agent yang bergantung pada probability_model.

## Definitions
- probability_model: komponen utama yang mengatur models dan fungsi probability_model.
...
## Core rules
- probability_model hanya mengurus models dan fungsi probability_model dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status probability_model, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
