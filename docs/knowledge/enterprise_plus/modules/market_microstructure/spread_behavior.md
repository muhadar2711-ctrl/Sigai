# market_microstructure/spread_behavior

## Purpose
Menetapkan aturan operasional untuk enterprise_plus market_microstructure untuk spread_behavior dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul market_microstructure dan seluruh agent yang bergantung pada spread_behavior.

## Definitions
- spread_behavior: komponen utama yang mengatur enterprise_plus market_microstructure untuk spread_behavior.
...
## Core rules
- spread_behavior hanya mengurus enterprise_plus market_microstructure untuk spread_behavior dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status spread_behavior, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
