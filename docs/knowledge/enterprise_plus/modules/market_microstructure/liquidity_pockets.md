# market_microstructure/liquidity_pockets

## Purpose
Menetapkan aturan operasional untuk enterprise_plus market_microstructure untuk liquidity_pockets dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul market_microstructure dan seluruh agent yang bergantung pada liquidity_pockets.

## Definitions
- liquidity_pockets: komponen utama yang mengatur enterprise_plus market_microstructure untuk liquidity_pockets.
...
## Core rules
- liquidity_pockets hanya mengurus enterprise_plus market_microstructure untuk liquidity_pockets dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status liquidity_pockets, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
