# xauusd/london_ny_overlap

## Purpose
Menetapkan aturan operasional untuk xauusd dan fungsi london_ny_overlap dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul xauusd dan seluruh agent yang bergantung pada london_ny_overlap.

## Definitions
- london_ny_overlap: komponen utama yang mengatur xauusd dan fungsi london_ny_overlap.
...
## Core rules
- london_ny_overlap hanya mengurus xauusd dan fungsi london_ny_overlap dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status london_ny_overlap, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
