# anomaly_detection/regime_anomaly

## Purpose
Menetapkan aturan operasional untuk enterprise_plus anomaly_detection untuk regime_anomaly dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul anomaly_detection dan seluruh agent yang bergantung pada regime_anomaly.

## Definitions
- regime_anomaly: komponen utama yang mengatur enterprise_plus anomaly_detection untuk regime_anomaly.
...
## Core rules
- regime_anomaly hanya mengurus enterprise_plus anomaly_detection untuk regime_anomaly dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status regime_anomaly, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
