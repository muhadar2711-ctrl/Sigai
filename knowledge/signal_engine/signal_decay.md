# signal_engine/signal_decay

## Purpose
Menetapkan aturan operasional untuk signal_engine dan fungsi signal_decay dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul signal_engine dan seluruh agent yang bergantung pada signal_decay.

## Definitions
- signal_decay: komponen utama yang mengatur signal_engine dan fungsi signal_decay.
...
## Core rules
- signal_decay hanya mengurus signal_engine dan fungsi signal_decay dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status signal_decay, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
