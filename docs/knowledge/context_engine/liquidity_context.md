# context_engine/liquidity_context

## Purpose
Menetapkan aturan operasional untuk context_engine dan fungsi liquidity_context dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul context_engine dan seluruh agent yang bergantung pada liquidity_context.

## Definitions
- liquidity_context: komponen utama yang mengatur context_engine dan fungsi liquidity_context.
...
## Core rules
- liquidity_context hanya mengurus context_engine dan fungsi liquidity_context dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait context_engine.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status liquidity_context, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder context_engine lain yang relevan.
