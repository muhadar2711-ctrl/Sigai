# probability_engine/prior

## Purpose
Menetapkan aturan operasional untuk probability_engine dan fungsi prior dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul probability_engine dan seluruh agent yang bergantung pada prior.

## Definitions
- prior: komponen utama yang mengatur probability_engine dan fungsi prior.
...
## Core rules
- prior hanya mengurus probability_engine dan fungsi prior dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status prior, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
