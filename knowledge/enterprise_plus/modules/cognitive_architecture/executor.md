# cognitive_architecture/executor

## Purpose
Menetapkan aturan operasional untuk enterprise_plus cognitive_architecture untuk executor dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul cognitive_architecture dan seluruh agent yang bergantung pada executor.

## Definitions
- executor: komponen utama yang mengatur enterprise_plus cognitive_architecture untuk executor.
...
## Core rules
- executor hanya mengurus enterprise_plus cognitive_architecture untuk executor dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status executor, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
