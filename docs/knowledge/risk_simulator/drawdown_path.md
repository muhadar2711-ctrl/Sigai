# risk_simulator/drawdown_path

## Purpose
Menetapkan aturan operasional untuk risk_simulator dan fungsi drawdown_path dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul risk_simulator dan seluruh agent yang bergantung pada drawdown_path.

## Definitions
- drawdown_path: komponen utama yang mengatur risk_simulator dan fungsi drawdown_path.
...
## Core rules
- drawdown_path hanya mengurus risk_simulator dan fungsi drawdown_path dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait risk_simulator.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status drawdown_path, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder risk_simulator lain yang relevan.
