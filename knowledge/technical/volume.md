...
## Purpose
Menetapkan aturan operasional untuk technical dan fungsi volume dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul technical dan seluruh agent yang bergantung pada volume.

## Definitions
- volume: komponen utama yang mengatur technical dan fungsi volume.
...
## Core rules
- volume hanya mengurus technical dan fungsi volume dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status volume, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
