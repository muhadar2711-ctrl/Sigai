# technical/vwap_model

## Purpose
Menetapkan aturan operasional untuk technical dan fungsi vwap_model dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul technical dan seluruh agent yang bergantung pada vwap_model.

## Definitions
- vwap_model: komponen utama yang mengatur technical dan fungsi vwap_model.
...
## Core rules
- vwap_model hanya mengurus technical dan fungsi vwap_model dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status vwap_model, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
