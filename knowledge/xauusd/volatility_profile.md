# xauusd/volatility_profile

## Purpose
Menetapkan aturan operasional untuk xauusd dan fungsi volatility_profile dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul xauusd dan seluruh agent yang bergantung pada volatility_profile.

## Definitions
- volatility_profile: komponen utama yang mengatur xauusd dan fungsi volatility_profile.
...
## Core rules
- volatility_profile hanya mengurus xauusd dan fungsi volatility_profile dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait xauusd.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status volatility_profile, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder xauusd lain yang relevan.
