# decision_engine/no_trade_gate

## Purpose
Menetapkan aturan operasional untuk decision_engine dan fungsi no_trade_gate dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul decision_engine dan seluruh agent yang bergantung pada no_trade_gate.

## Definitions
- no_trade_gate: komponen utama yang mengatur decision_engine dan fungsi no_trade_gate.
...
## Core rules
- no_trade_gate hanya mengurus decision_engine dan fungsi no_trade_gate dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status no_trade_gate, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
