# market_simulator/volatility_shift

## Purpose
Menetapkan aturan operasional untuk market_simulator dan fungsi volatility_shift dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul market_simulator dan seluruh agent yang bergantung pada volatility_shift.

## Definitions
- volatility_shift: komponen utama yang mengatur market_simulator dan fungsi volatility_shift.
...
## Core rules
- volatility_shift hanya mengurus market_simulator dan fungsi volatility_shift dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait market_simulator.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status volatility_shift, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder market_simulator lain yang relevan.
