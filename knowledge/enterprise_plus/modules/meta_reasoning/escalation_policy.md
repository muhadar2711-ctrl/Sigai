# meta_reasoning/escalation_policy

## Purpose
Menetapkan aturan operasional untuk enterprise_plus meta_reasoning untuk escalation_policy dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul meta_reasoning dan seluruh agent yang bergantung pada escalation_policy.

## Definitions
- escalation_policy: komponen utama yang mengatur enterprise_plus meta_reasoning untuk escalation_policy.
...
## Core rules
- escalation_policy hanya mengurus enterprise_plus meta_reasoning untuk escalation_policy dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status escalation_policy, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
