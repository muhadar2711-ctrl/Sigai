...
## Purpose
Menetapkan aturan operasional untuk statistics dan fungsi standard_deviation dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul statistics dan seluruh agent yang bergantung pada standard_deviation.

## Definitions
- standard_deviation: komponen utama yang mengatur statistics dan fungsi standard_deviation.
...
## Core rules
- standard_deviation hanya mengurus statistics dan fungsi standard_deviation dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status standard_deviation, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
