# backtest/risk_of_ruin

## Purpose
Menetapkan aturan operasional untuk backtest dan fungsi risk_of_ruin dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul backtest dan seluruh agent yang bergantung pada risk_of_ruin.

## Definitions
- risk_of_ruin: komponen utama yang mengatur backtest dan fungsi risk_of_ruin.
...
## Core rules
- risk_of_ruin hanya mengurus backtest dan fungsi risk_of_ruin dan tidak boleh mengambil tanggung jawab modul lain.
