# knowledge_base/evidence_index

## Purpose
Menetapkan aturan operasional untuk knowledge_base dan fungsi evidence_index dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul knowledge_base dan seluruh agent yang bergantung pada evidence_index.

## Definitions
- evidence_index: komponen utama yang mengatur knowledge_base dan fungsi evidence_index.
...
## Core rules
- evidence_index hanya mengurus knowledge_base dan fungsi evidence_index dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status evidence_index, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
