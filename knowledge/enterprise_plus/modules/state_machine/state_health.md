# state_machine/state_health

## Purpose
Menetapkan aturan operasional untuk enterprise_plus state_machine untuk state_health dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul state_machine dan seluruh agent yang bergantung pada state_health.

## Definitions
- state_health: komponen utama yang mengatur enterprise_plus state_machine untuk state_health.
...
## Core rules
- state_health hanya mengurus enterprise_plus state_machine untuk state_health dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status state_health, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
