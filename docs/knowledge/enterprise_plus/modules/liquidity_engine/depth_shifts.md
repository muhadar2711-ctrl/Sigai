# liquidity_engine/depth_shifts

## Purpose
Menetapkan aturan operasional untuk enterprise_plus liquidity_engine untuk depth_shifts dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul liquidity_engine dan seluruh agent yang bergantung pada depth_shifts.

## Definitions
- depth_shifts: komponen utama yang mengatur enterprise_plus liquidity_engine untuk depth_shifts.
...
## Core rules
- depth_shifts hanya mengurus enterprise_plus liquidity_engine untuk depth_shifts dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status depth_shifts, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
