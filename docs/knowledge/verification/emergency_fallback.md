# verification/emergency_fallback

## Purpose
Menetapkan aturan operasional untuk verification dan fungsi emergency_fallback dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul verification dan seluruh agent yang bergantung pada emergency_fallback.

## Definitions
- emergency_fallback: komponen utama yang mengatur verification dan fungsi emergency_fallback.
...
## Core rules
- emergency_fallback hanya mengurus verification dan fungsi emergency_fallback dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status emergency_fallback, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
