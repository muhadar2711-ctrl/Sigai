# scoring_framework/stability_score

## Purpose
Menetapkan aturan operasional untuk enterprise_plus scoring_framework untuk stability_score dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul scoring_framework dan seluruh agent yang bergantung pada stability_score.

## Definitions
- stability_score: komponen utama yang mengatur enterprise_plus scoring_framework untuk stability_score.
...
## Core rules
- stability_score hanya mengurus enterprise_plus scoring_framework untuk stability_score dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status stability_score, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
