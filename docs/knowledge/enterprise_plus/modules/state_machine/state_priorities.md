# state_machine/state_priorities

## Purpose
Menetapkan aturan operasional untuk enterprise_plus state_machine untuk state_priorities dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul state_machine dan seluruh agent yang bergantung pada state_priorities.

## Definitions
- state_priorities: komponen utama yang mengatur enterprise_plus state_machine untuk state_priorities.
...
## Core rules
- state_priorities hanya mengurus enterprise_plus state_machine untuk state_priorities dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status state_priorities, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
