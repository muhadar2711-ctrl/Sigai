# meta_reasoning/self_critique

## Purpose
Menetapkan aturan operasional untuk enterprise_plus meta_reasoning untuk self_critique dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul meta_reasoning dan seluruh agent yang bergantung pada self_critique.

## Definitions
- self_critique: komponen utama yang mengatur enterprise_plus meta_reasoning untuk self_critique.
...
## Core rules
- self_critique hanya mengurus enterprise_plus meta_reasoning untuk self_critique dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status self_critique, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
