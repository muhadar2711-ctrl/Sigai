# xauusd/weekly_behavior

## Purpose
Menetapkan aturan operasional untuk xauusd dan fungsi weekly_behavior dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul xauusd dan seluruh agent yang bergantung pada weekly_behavior.

## Definitions
- weekly_behavior: komponen utama yang mengatur xauusd dan fungsi weekly_behavior.
...
## Core rules
- weekly_behavior hanya mengurus xauusd dan fungsi weekly_behavior dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status weekly_behavior, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
