# anomaly_detection/data_anomaly

## Purpose
Menetapkan aturan operasional untuk enterprise_plus anomaly_detection untuk data_anomaly dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul anomaly_detection dan seluruh agent yang bergantung pada data_anomaly.

## Definitions
- data_anomaly: komponen utama yang mengatur enterprise_plus anomaly_detection untuk data_anomaly.
...
## Core rules
- data_anomaly hanya mengurus enterprise_plus anomaly_detection untuk data_anomaly dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status data_anomaly, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
