...
## Purpose
Menetapkan aturan operasional untuk xauusd dan fungsi news_impact dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul xauusd dan seluruh agent yang bergantung pada news_impact.

## Definitions
- news_impact: komponen utama yang mengatur xauusd dan fungsi news_impact.
...
## Core rules
- news_impact hanya mengurus xauusd dan fungsi news_impact dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status news_impact, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
