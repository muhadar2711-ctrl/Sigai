...
## Purpose
Menetapkan aturan operasional untuk fundamental dan fungsi gdp dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul fundamental dan seluruh agent yang bergantung pada gdp.

## Definitions
- gdp: komponen utama yang mengatur fundamental dan fungsi gdp.
...
## Core rules
- gdp hanya mengurus fundamental dan fungsi gdp dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status gdp, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
