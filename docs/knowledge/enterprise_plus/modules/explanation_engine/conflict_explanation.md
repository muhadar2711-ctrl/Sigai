# explanation_engine/conflict_explanation

## Purpose
Menetapkan aturan operasional untuk enterprise_plus explanation_engine untuk conflict_explanation dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul explanation_engine dan seluruh agent yang bergantung pada conflict_explanation.

## Definitions
- conflict_explanation: komponen utama yang mengatur enterprise_plus explanation_engine untuk conflict_explanation.
...
## Core rules
- conflict_explanation hanya mengurus enterprise_plus explanation_engine untuk conflict_explanation dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status conflict_explanation, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
