# cognitive_architecture/state_machine

## Purpose
Menetapkan aturan operasional untuk enterprise_plus cognitive_architecture untuk state_machine dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul cognitive_architecture dan seluruh agent yang bergantung pada state_machine.

## Definitions
- state_machine: komponen utama yang mengatur enterprise_plus cognitive_architecture untuk state_machine.
...
## Core rules
- state_machine hanya mengurus enterprise_plus cognitive_architecture untuk state_machine dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status state_machine, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
