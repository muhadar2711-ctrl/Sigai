# self_monitoring/health_checks

## Purpose
Menetapkan aturan operasional untuk enterprise_plus self_monitoring untuk health_checks dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul self_monitoring dan seluruh agent yang bergantung pada health_checks.

## Definitions
- health_checks: komponen utama yang mengatur enterprise_plus self_monitoring untuk health_checks.
...
## Core rules
- health_checks hanya mengurus enterprise_plus self_monitoring untuk health_checks dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status health_checks, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
