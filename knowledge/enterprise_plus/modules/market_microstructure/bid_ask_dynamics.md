# market_microstructure/bid_ask_dynamics

## Purpose
Menetapkan aturan operasional untuk enterprise_plus market_microstructure untuk bid_ask_dynamics dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul market_microstructure dan seluruh agent yang bergantung pada bid_ask_dynamics.

## Definitions
- bid_ask_dynamics: komponen utama yang mengatur enterprise_plus market_microstructure untuk bid_ask_dynamics.
...
## Core rules
- bid_ask_dynamics hanya mengurus enterprise_plus market_microstructure untuk bid_ask_dynamics dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status bid_ask_dynamics, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
