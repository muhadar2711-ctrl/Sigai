...
## Purpose
Menetapkan aturan operasional untuk world_model dan fungsi market_state dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul world_model dan seluruh agent yang bergantung pada market_state.

## Definitions
- market_state: komponen utama yang mengatur world_model dan fungsi market_state.
...
## Core rules
- market_state hanya mengurus world_model dan fungsi market_state dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status market_state, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
