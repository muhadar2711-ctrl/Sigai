# capital_preservation/risk_per_trade

## Purpose
Menetapkan aturan operasional untuk enterprise_plus capital_preservation untuk risk_per_trade dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul capital_preservation dan seluruh agent yang bergantung pada risk_per_trade.

## Definitions
- risk_per_trade: komponen utama yang mengatur enterprise_plus capital_preservation untuk risk_per_trade.
...
## Core rules
- risk_per_trade hanya mengurus enterprise_plus capital_preservation untuk risk_per_trade dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status risk_per_trade, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
