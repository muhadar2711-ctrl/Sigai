# scoring_engine/setup_score

## Purpose
Menetapkan aturan operasional untuk scoring_engine dan fungsi setup_score dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul scoring_engine dan seluruh agent yang bergantung pada setup_score.

## Definitions
- setup_score: komponen utama yang mengatur scoring_engine dan fungsi setup_score.
...
## Core rules
- setup_score hanya mengurus scoring_engine dan fungsi setup_score dan tidak boleh mengambil tanggung jawab modul lain.
