# resource_manager/rate_limits

## Purpose
Menetapkan aturan operasional untuk enterprise_plus resource_manager untuk rate_limits dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul resource_manager dan seluruh agent yang bergantung pada rate_limits.

## Definitions
- rate_limits: komponen utama yang mengatur enterprise_plus resource_manager untuk rate_limits.
...
## Core rules
- rate_limits hanya mengurus enterprise_plus resource_manager untuk rate_limits dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status rate_limits, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
