# explanation_engine/decision_trace

## Purpose
Menetapkan aturan operasional untuk enterprise_plus explanation_engine untuk decision_trace dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul explanation_engine dan seluruh agent yang bergantung pada decision_trace.

## Definitions
- decision_trace: komponen utama yang mengatur enterprise_plus explanation_engine untuk decision_trace.
...
## Core rules
- decision_trace hanya mengurus enterprise_plus explanation_engine untuk decision_trace dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status decision_trace, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
