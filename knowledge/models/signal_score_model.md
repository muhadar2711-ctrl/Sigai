# models/signal_score_model

## Purpose
Menetapkan aturan operasional untuk models dan fungsi signal_score_model dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul models dan seluruh agent yang bergantung pada signal_score_model.

## Definitions
- signal_score_model: komponen utama yang mengatur models dan fungsi signal_score_model.
...
## Core rules
- signal_score_model hanya mengurus models dan fungsi signal_score_model dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status signal_score_model, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
