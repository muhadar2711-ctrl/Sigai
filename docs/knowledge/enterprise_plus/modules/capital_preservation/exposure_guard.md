# capital_preservation/exposure_guard

## Purpose
Menetapkan aturan operasional untuk enterprise_plus capital_preservation untuk exposure_guard dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul capital_preservation dan seluruh agent yang bergantung pada exposure_guard.

## Definitions
- exposure_guard: komponen utama yang mengatur enterprise_plus capital_preservation untuk exposure_guard.
...
## Core rules
- exposure_guard hanya mengurus enterprise_plus capital_preservation untuk exposure_guard dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status exposure_guard, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
