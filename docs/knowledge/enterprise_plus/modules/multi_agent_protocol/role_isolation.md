# multi_agent_protocol/role_isolation

## Purpose
Menetapkan aturan operasional untuk enterprise_plus multi_agent_protocol untuk role_isolation dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul multi_agent_protocol dan seluruh agent yang bergantung pada role_isolation.

## Definitions
- role_isolation: komponen utama yang mengatur enterprise_plus multi_agent_protocol untuk role_isolation.
...
## Core rules
- role_isolation hanya mengurus enterprise_plus multi_agent_protocol untuk role_isolation dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status role_isolation, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
