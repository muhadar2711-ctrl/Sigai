...
## Purpose
Menetapkan aturan operasional untuk models dan fungsi reversal_model dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul models dan seluruh agent yang bergantung pada reversal_model.

## Definitions
- reversal_model: komponen utama yang mengatur models dan fungsi reversal_model.
...
## Core rules
- reversal_model hanya mengurus models dan fungsi reversal_model dan tidak boleh mengambil tanggung jawab modul lain.
