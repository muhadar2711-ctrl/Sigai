# execution/execution_checklist

## Purpose
Menetapkan aturan operasional untuk execution dan fungsi execution_checklist dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul execution dan seluruh agent yang bergantung pada execution_checklist.

## Definitions
- execution_checklist: komponen utama yang mengatur execution dan fungsi execution_checklist.
...
## Core rules
- execution_checklist hanya mengurus execution dan fungsi execution_checklist dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status execution_checklist, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
