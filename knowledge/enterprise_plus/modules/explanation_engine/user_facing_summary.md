# explanation_engine/user_facing_summary

## Purpose
Menetapkan aturan operasional untuk enterprise_plus explanation_engine untuk user_facing_summary dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul explanation_engine dan seluruh agent yang bergantung pada user_facing_summary.

## Definitions
- user_facing_summary: komponen utama yang mengatur enterprise_plus explanation_engine untuk user_facing_summary.
...
## Core rules
- user_facing_summary hanya mengurus enterprise_plus explanation_engine untuk user_facing_summary dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status user_facing_summary, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
