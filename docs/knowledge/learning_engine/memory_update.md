# learning_engine/memory_update

## Purpose
Menetapkan aturan operasional untuk learning_engine dan fungsi memory_update dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul learning_engine dan seluruh agent yang bergantung pada memory_update.

## Definitions
- memory_update: komponen utama yang mengatur learning_engine dan fungsi memory_update.
...
## Core rules
- memory_update hanya mengurus learning_engine dan fungsi memory_update dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status memory_update, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
