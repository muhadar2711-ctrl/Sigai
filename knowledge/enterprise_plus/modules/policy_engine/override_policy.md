# policy_engine/override_policy

## Purpose
Menetapkan aturan operasional untuk enterprise_plus policy_engine untuk override_policy dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul policy_engine dan seluruh agent yang bergantung pada override_policy.

## Definitions
- override_policy: komponen utama yang mengatur enterprise_plus policy_engine untuk override_policy.
...
## Core rules
- override_policy hanya mengurus enterprise_plus policy_engine untuk override_policy dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status override_policy, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
