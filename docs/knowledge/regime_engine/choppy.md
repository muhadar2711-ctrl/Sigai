# regime_engine/choppy

## Purpose
Menetapkan aturan operasional untuk regime_engine dan fungsi choppy dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul regime_engine dan seluruh agent yang bergantung pada choppy.

## Definitions
- choppy: komponen utama yang mengatur regime_engine dan fungsi choppy.
...
## Core rules
- choppy hanya mengurus regime_engine dan fungsi choppy dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status choppy, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
