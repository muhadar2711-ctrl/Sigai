...
## Purpose
Menetapkan aturan operasional untuk psychology dan fungsi focus dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul psychology dan seluruh agent yang bergantung pada focus.

## Definitions
- focus: komponen utama yang mengatur psychology dan fungsi focus.
...
## Core rules
- focus hanya mengurus psychology dan fungsi focus dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status focus, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
