# trade_lifecycle/partials

## Purpose
Menetapkan aturan operasional untuk enterprise_plus trade_lifecycle untuk partials dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul trade_lifecycle dan seluruh agent yang bergantung pada partials.

## Definitions
- partials: komponen utama yang mengatur enterprise_plus trade_lifecycle untuk partials.
...
## Core rules
- partials hanya mengurus enterprise_plus trade_lifecycle untuk partials dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status partials, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
