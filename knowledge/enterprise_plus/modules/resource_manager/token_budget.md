# resource_manager/token_budget

## Purpose
Menetapkan aturan operasional untuk enterprise_plus resource_manager untuk token_budget dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul resource_manager dan seluruh agent yang bergantung pada token_budget.

## Definitions
- token_budget: komponen utama yang mengatur enterprise_plus resource_manager untuk token_budget.
...
## Core rules
- token_budget hanya mengurus enterprise_plus resource_manager untuk token_budget dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status token_budget, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
