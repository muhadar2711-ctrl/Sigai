# learning_engine/improvement_loop

## Purpose
Menetapkan aturan operasional untuk learning_engine dan fungsi improvement_loop dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul learning_engine dan seluruh agent yang bergantung pada improvement_loop.

## Definitions
- improvement_loop: komponen utama yang mengatur learning_engine dan fungsi improvement_loop.
...
## Core rules
- improvement_loop hanya mengurus learning_engine dan fungsi improvement_loop dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait learning_engine.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status improvement_loop, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder learning_engine lain yang relevan.
