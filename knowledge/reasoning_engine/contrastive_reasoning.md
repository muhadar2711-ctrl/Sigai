# reasoning_engine/contrastive_reasoning

## Purpose
Menetapkan aturan operasional untuk reasoning_engine dan fungsi contrastive_reasoning dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul reasoning_engine dan seluruh agent yang bergantung pada contrastive_reasoning.

## Definitions
- contrastive_reasoning: komponen utama yang mengatur reasoning_engine dan fungsi contrastive_reasoning.
...
## Core rules
- contrastive_reasoning hanya mengurus reasoning_engine dan fungsi contrastive_reasoning dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status contrastive_reasoning, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
