# experience_learning/lesson_database

## Purpose
Menetapkan aturan operasional untuk enterprise_plus experience_learning untuk lesson_database dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul experience_learning dan seluruh agent yang bergantung pada lesson_database.

## Definitions
- lesson_database: komponen utama yang mengatur enterprise_plus experience_learning untuk lesson_database.
...
## Core rules
- lesson_database hanya mengurus enterprise_plus experience_learning untuk lesson_database dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status lesson_database, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
