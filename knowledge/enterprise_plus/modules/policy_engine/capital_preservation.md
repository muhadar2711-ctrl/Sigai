# policy_engine/capital_preservation

## Purpose
Menetapkan aturan operasional untuk enterprise_plus policy_engine untuk capital_preservation dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul policy_engine dan seluruh agent yang bergantung pada capital_preservation.

## Definitions
- capital_preservation: komponen utama yang mengatur enterprise_plus policy_engine untuk capital_preservation.
...
## Core rules
- capital_preservation hanya mengurus enterprise_plus policy_engine untuk capital_preservation dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait policy_engine.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status capital_preservation, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder policy_engine lain yang relevan.
