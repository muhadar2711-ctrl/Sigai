# belief_system/certainty_levels

## Purpose
Menetapkan aturan operasional untuk belief_system dan fungsi certainty_levels dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul belief_system dan seluruh agent yang bergantung pada certainty_levels.

## Definitions
- certainty_levels: komponen utama yang mengatur belief_system dan fungsi certainty_levels.
...
## Core rules
- certainty_levels hanya mengurus belief_system dan fungsi certainty_levels dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait belief_system.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status certainty_levels, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder belief_system lain yang relevan.
