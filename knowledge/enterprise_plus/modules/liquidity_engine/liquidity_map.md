# liquidity_engine/liquidity_map

## Purpose
Menetapkan aturan operasional untuk enterprise_plus liquidity_engine untuk liquidity_map dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul liquidity_engine dan seluruh agent yang bergantung pada liquidity_map.

## Definitions
- liquidity_map: komponen utama yang mengatur enterprise_plus liquidity_engine untuk liquidity_map.
...
## Core rules
- liquidity_map hanya mengurus enterprise_plus liquidity_engine untuk liquidity_map dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status liquidity_map, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
