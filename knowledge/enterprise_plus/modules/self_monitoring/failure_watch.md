# self_monitoring/failure_watch

## Purpose
Menetapkan aturan operasional untuk enterprise_plus self_monitoring untuk failure_watch dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul self_monitoring dan seluruh agent yang bergantung pada failure_watch.

## Definitions
- failure_watch: komponen utama yang mengatur enterprise_plus self_monitoring untuk failure_watch.
...
## Core rules
- failure_watch hanya mengurus enterprise_plus self_monitoring untuk failure_watch dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status failure_watch, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
