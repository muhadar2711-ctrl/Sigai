# belief_system/belief_decay

## Purpose
Menetapkan aturan operasional untuk belief_system dan fungsi belief_decay dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul belief_system dan seluruh agent yang bergantung pada belief_decay.

## Definitions
- belief_decay: komponen utama yang mengatur belief_system dan fungsi belief_decay.
...
## Core rules
- belief_decay hanya mengurus belief_system dan fungsi belief_decay dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status belief_decay, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
