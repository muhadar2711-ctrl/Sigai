# context_engine/macro_context

## Purpose
Menetapkan aturan operasional untuk context_engine dan fungsi macro_context dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul context_engine dan seluruh agent yang bergantung pada macro_context.

## Definitions
- macro_context: komponen utama yang mengatur context_engine dan fungsi macro_context.
...
## Core rules
- macro_context hanya mengurus context_engine dan fungsi macro_context dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status macro_context, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
