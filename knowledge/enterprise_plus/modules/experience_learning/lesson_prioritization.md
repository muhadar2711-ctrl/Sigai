# experience_learning/lesson_prioritization

## Purpose
Menetapkan aturan operasional untuk enterprise_plus experience_learning untuk lesson_prioritization dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul experience_learning dan seluruh agent yang bergantung pada lesson_prioritization.

## Definitions
- lesson_prioritization: komponen utama yang mengatur enterprise_plus experience_learning untuk lesson_prioritization.
...
## Core rules
- lesson_prioritization hanya mengurus enterprise_plus experience_learning untuk lesson_prioritization dan tidak boleh mengambil tanggung jawab modul lain.
...
- Update memori hanya setelah review yang tervalidasi.
- Lesson harus berasal dari outcome yang dapat diaudit.

## Inputs
- Struktur market, session, liquidity, volatility, news, risk state, dan context aktif.
- Evidence dari modul terkait experience_learning.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status lesson_prioritization, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder experience_learning lain yang relevan.
