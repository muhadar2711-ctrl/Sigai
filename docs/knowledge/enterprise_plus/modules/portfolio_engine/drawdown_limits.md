# portfolio_engine/drawdown_limits

## Purpose
Menetapkan aturan operasional untuk enterprise_plus portfolio_engine untuk drawdown_limits dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul portfolio_engine dan seluruh agent yang bergantung pada drawdown_limits.

## Definitions
- drawdown_limits: komponen utama yang mengatur enterprise_plus portfolio_engine untuk drawdown_limits.
...
## Core rules
- drawdown_limits hanya mengurus enterprise_plus portfolio_engine untuk drawdown_limits dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status drawdown_limits, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
