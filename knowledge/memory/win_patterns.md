...
## Purpose
Menetapkan aturan operasional untuk memory dan fungsi win_patterns dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul memory dan seluruh agent yang bergantung pada win_patterns.

## Definitions
- win_patterns: komponen utama yang mengatur memory dan fungsi win_patterns.
...
## Core rules
- win_patterns hanya mengurus memory dan fungsi win_patterns dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status win_patterns, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
