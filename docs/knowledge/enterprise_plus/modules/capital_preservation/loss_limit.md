# capital_preservation/loss_limit

## Purpose
Menetapkan aturan operasional untuk enterprise_plus capital_preservation untuk loss_limit dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul capital_preservation dan seluruh agent yang bergantung pada loss_limit.

## Definitions
- loss_limit: komponen utama yang mengatur enterprise_plus capital_preservation untuk loss_limit.
...
## Core rules
- loss_limit hanya mengurus enterprise_plus capital_preservation untuk loss_limit dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status loss_limit, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
