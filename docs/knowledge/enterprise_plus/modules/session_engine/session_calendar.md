# session_engine/session_calendar

## Purpose
Menetapkan aturan operasional untuk enterprise_plus session_engine untuk session_calendar dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul session_engine dan seluruh agent yang bergantung pada session_calendar.

## Definitions
- session_calendar: komponen utama yang mengatur enterprise_plus session_engine untuk session_calendar.
...
## Core rules
- session_calendar hanya mengurus enterprise_plus session_engine untuk session_calendar dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status session_calendar, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
