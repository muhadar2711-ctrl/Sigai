# xauusd/xauusd_character

## Purpose
Menetapkan aturan operasional untuk xauusd dan fungsi xauusd_character dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul xauusd dan seluruh agent yang bergantung pada xauusd_character.

## Definitions
- xauusd_character: komponen utama yang mengatur xauusd dan fungsi xauusd_character.
...
## Core rules
- xauusd_character hanya mengurus xauusd dan fungsi xauusd_character dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status xauusd_character, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
