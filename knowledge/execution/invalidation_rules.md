# execution/invalidation_rules

## Purpose
Menetapkan aturan operasional untuk execution dan fungsi invalidation_rules dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul execution dan seluruh agent yang bergantung pada invalidation_rules.

## Definitions
- invalidation_rules: komponen utama yang mengatur execution dan fungsi invalidation_rules.
...
## Core rules
- invalidation_rules hanya mengurus execution dan fungsi invalidation_rules dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status invalidation_rules, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
