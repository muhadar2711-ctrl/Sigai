# experience_learning/adaptive_memory

## Purpose
Menetapkan aturan operasional untuk enterprise_plus experience_learning untuk adaptive_memory dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul experience_learning dan seluruh agent yang bergantung pada adaptive_memory.

## Definitions
- adaptive_memory: komponen utama yang mengatur enterprise_plus experience_learning untuk adaptive_memory.
...
## Core rules
- adaptive_memory hanya mengurus enterprise_plus experience_learning untuk adaptive_memory dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status adaptive_memory, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
