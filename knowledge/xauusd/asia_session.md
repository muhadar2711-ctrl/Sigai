...
## Purpose
Menetapkan aturan operasional untuk xauusd dan fungsi asia_session dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul xauusd dan seluruh agent yang bergantung pada asia_session.

## Definitions
- asia_session: komponen utama yang mengatur xauusd dan fungsi asia_session.
...
## Core rules
- asia_session hanya mengurus xauusd dan fungsi asia_session dan tidak boleh mengambil tanggung jawab modul lain.
