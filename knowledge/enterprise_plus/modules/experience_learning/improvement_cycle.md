# experience_learning/improvement_cycle

## Purpose
Menetapkan aturan operasional untuk enterprise_plus experience_learning untuk improvement_cycle dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul experience_learning dan seluruh agent yang bergantung pada improvement_cycle.

## Definitions
- improvement_cycle: komponen utama yang mengatur enterprise_plus experience_learning untuk improvement_cycle.
...
## Core rules
- improvement_cycle hanya mengurus enterprise_plus experience_learning untuk improvement_cycle dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status improvement_cycle, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
