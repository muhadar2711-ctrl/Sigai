...
## Purpose
Menetapkan aturan operasional untuk memory_graph dan fungsi nodes dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul memory_graph dan seluruh agent yang bergantung pada nodes.

## Definitions
- nodes: komponen utama yang mengatur memory_graph dan fungsi nodes.
...
## Core rules
- nodes hanya mengurus memory_graph dan fungsi nodes dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status nodes, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
