# stress_engine/liquidity_crisis

## Purpose
Menetapkan aturan operasional untuk stress_engine dan fungsi liquidity_crisis dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul stress_engine dan seluruh agent yang bergantung pada liquidity_crisis.

## Definitions
- liquidity_crisis: komponen utama yang mengatur stress_engine dan fungsi liquidity_crisis.
...
## Core rules
- liquidity_crisis hanya mengurus stress_engine dan fungsi liquidity_crisis dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait stress_engine.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status liquidity_crisis, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder stress_engine lain yang relevan.
