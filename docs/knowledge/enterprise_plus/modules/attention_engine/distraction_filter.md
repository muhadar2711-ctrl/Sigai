# attention_engine/distraction_filter

## Purpose
Menetapkan aturan operasional untuk enterprise_plus attention_engine untuk distraction_filter dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul attention_engine dan seluruh agent yang bergantung pada distraction_filter.

## Definitions
- distraction_filter: komponen utama yang mengatur enterprise_plus attention_engine untuk distraction_filter.
...
## Core rules
- distraction_filter hanya mengurus enterprise_plus attention_engine untuk distraction_filter dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait attention_engine.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status distraction_filter, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder attention_engine lain yang relevan.
