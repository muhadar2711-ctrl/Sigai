# memory/setup_library

## Purpose
Menetapkan aturan operasional untuk memory dan fungsi setup_library dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul memory dan seluruh agent yang bergantung pada setup_library.

## Definitions
- setup_library: komponen utama yang mengatur memory dan fungsi setup_library.
...
## Core rules
- setup_library hanya mengurus memory dan fungsi setup_library dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status setup_library, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
