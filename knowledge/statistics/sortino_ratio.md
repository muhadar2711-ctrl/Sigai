# statistics/sortino_ratio

## Purpose
Menetapkan aturan operasional untuk statistics dan fungsi sortino_ratio dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul statistics dan seluruh agent yang bergantung pada sortino_ratio.

## Definitions
- sortino_ratio: komponen utama yang mengatur statistics dan fungsi sortino_ratio.
...
## Core rules
- sortino_ratio hanya mengurus statistics dan fungsi sortino_ratio dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status sortino_ratio, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
