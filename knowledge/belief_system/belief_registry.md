# belief_system/belief_registry

## Purpose
Menetapkan aturan operasional untuk belief_system dan fungsi belief_registry dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul belief_system dan seluruh agent yang bergantung pada belief_registry.

## Definitions
- belief_registry: komponen utama yang mengatur belief_system dan fungsi belief_registry.
...
## Core rules
- belief_registry hanya mengurus belief_system dan fungsi belief_registry dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status belief_registry, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
