...
## Purpose
Menetapkan aturan operasional untuk technical dan fungsi adx_model dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul technical dan seluruh agent yang bergantung pada adx_model.

## Definitions
- adx_model: komponen utama yang mengatur technical dan fungsi adx_model.
...
## Core rules
- adx_model hanya mengurus technical dan fungsi adx_model dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status adx_model, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
