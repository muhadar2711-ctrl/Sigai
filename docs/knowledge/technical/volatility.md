...
## Purpose
Menetapkan aturan operasional untuk technical dan fungsi volatility dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul technical dan seluruh agent yang bergantung pada volatility.

## Definitions
- volatility: komponen utama yang mengatur technical dan fungsi volatility.
...
## Core rules
- volatility hanya mengurus technical dan fungsi volatility dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status volatility, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
