# goal_management/drawdown_goal

## Purpose
Menetapkan aturan operasional untuk enterprise_plus goal_management untuk drawdown_goal dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul goal_management dan seluruh agent yang bergantung pada drawdown_goal.

## Definitions
- drawdown_goal: komponen utama yang mengatur enterprise_plus goal_management untuk drawdown_goal.
...
## Core rules
- drawdown_goal hanya mengurus enterprise_plus goal_management untuk drawdown_goal dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status drawdown_goal, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
