# supervisor_engine/health_checks

## Purpose
Menetapkan aturan operasional untuk supervisor_engine dan fungsi health_checks dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul supervisor_engine dan seluruh agent yang bergantung pada health_checks.

## Definitions
- health_checks: komponen utama yang mengatur supervisor_engine dan fungsi health_checks.
...
## Core rules
- health_checks hanya mengurus supervisor_engine dan fungsi health_checks dan tidak boleh mengambil tanggung jawab modul lain.
