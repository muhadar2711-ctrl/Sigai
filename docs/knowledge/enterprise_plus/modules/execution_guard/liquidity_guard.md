# execution_guard/liquidity_guard

## Purpose
Menetapkan aturan operasional untuk enterprise_plus execution_guard untuk liquidity_guard dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul execution_guard dan seluruh agent yang bergantung pada liquidity_guard.

## Definitions
- liquidity_guard: komponen utama yang mengatur enterprise_plus execution_guard untuk liquidity_guard.
...
## Core rules
- liquidity_guard hanya mengurus enterprise_plus execution_guard untuk liquidity_guard dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status liquidity_guard, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
