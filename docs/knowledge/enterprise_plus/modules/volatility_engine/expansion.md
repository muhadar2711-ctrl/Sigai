# volatility_engine/expansion

## Purpose
Menetapkan aturan operasional untuk enterprise_plus volatility_engine untuk expansion dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul volatility_engine dan seluruh agent yang bergantung pada expansion.

## Definitions
- expansion: komponen utama yang mengatur enterprise_plus volatility_engine untuk expansion.
...
## Core rules
- expansion hanya mengurus enterprise_plus volatility_engine untuk expansion dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status expansion, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
