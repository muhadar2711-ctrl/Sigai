# confidence_engine/certainty_score

## Purpose
Menetapkan aturan operasional untuk enterprise_plus confidence_engine untuk certainty_score dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul confidence_engine dan seluruh agent yang bergantung pada certainty_score.

## Definitions
- certainty_score: komponen utama yang mengatur enterprise_plus confidence_engine untuk certainty_score.
...
## Core rules
- certainty_score hanya mengurus enterprise_plus confidence_engine untuk certainty_score dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status certainty_score, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
