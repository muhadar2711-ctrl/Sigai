# graph_index/index_validation

## Purpose
Menetapkan aturan operasional untuk graph_index dan fungsi index_validation dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul graph_index dan seluruh agent yang bergantung pada index_validation.

## Definitions
- index_validation: komponen utama yang mengatur graph_index dan fungsi index_validation.
...
## Core rules
- index_validation hanya mengurus graph_index dan fungsi index_validation dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait graph_index.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status index_validation, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder graph_index lain yang relevan.
