# xauusd/xauusd_session

## Purpose
Menetapkan aturan operasional untuk xauusd dan fungsi xauusd_session dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul xauusd dan seluruh agent yang bergantung pada xauusd_session.

## Definitions
- xauusd_session: komponen utama yang mengatur xauusd dan fungsi xauusd_session.
...
## Core rules
- xauusd_session hanya mengurus xauusd dan fungsi xauusd_session dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status xauusd_session, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
