# intent_engine/intent_priority

## Purpose
Menetapkan aturan operasional untuk enterprise_plus intent_engine untuk intent_priority dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul intent_engine dan seluruh agent yang bergantung pada intent_priority.

## Definitions
- intent_priority: komponen utama yang mengatur enterprise_plus intent_engine untuk intent_priority.
...
## Core rules
- intent_priority hanya mengurus enterprise_plus intent_engine untuk intent_priority dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status intent_priority, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
