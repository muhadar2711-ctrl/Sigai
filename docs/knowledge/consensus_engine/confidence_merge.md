# consensus_engine/confidence_merge

## Purpose
Menetapkan aturan operasional untuk consensus_engine dan fungsi confidence_merge dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul consensus_engine dan seluruh agent yang bergantung pada confidence_merge.

## Definitions
- confidence_merge: komponen utama yang mengatur consensus_engine dan fungsi confidence_merge.
...
## Core rules
- confidence_merge hanya mengurus consensus_engine dan fungsi confidence_merge dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait consensus_engine.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status confidence_merge, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder consensus_engine lain yang relevan.
