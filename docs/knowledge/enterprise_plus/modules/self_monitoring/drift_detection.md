# self_monitoring/drift_detection

## Purpose
Menetapkan aturan operasional untuk enterprise_plus self_monitoring untuk drift_detection dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul self_monitoring dan seluruh agent yang bergantung pada drift_detection.

## Definitions
- drift_detection: komponen utama yang mengatur enterprise_plus self_monitoring untuk drift_detection.
...
## Core rules
- drift_detection hanya mengurus enterprise_plus self_monitoring untuk drift_detection dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait self_monitoring.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status drift_detection, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder self_monitoring lain yang relevan.
