...
## Purpose
Menetapkan aturan operasional untuk backtest dan fungsi expectancy dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul backtest dan seluruh agent yang bergantung pada expectancy.

## Definitions
- expectancy: komponen utama yang mengatur backtest dan fungsi expectancy.
...
## Core rules
- expectancy hanya mengurus backtest dan fungsi expectancy dan tidak boleh mengambil tanggung jawab modul lain.
