# research/stress_test

## Purpose
Menetapkan aturan operasional untuk research dan fungsi stress_test dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul research dan seluruh agent yang bergantung pada stress_test.

## Definitions
- stress_test: komponen utama yang mengatur research dan fungsi stress_test.
...
## Core rules
- stress_test hanya mengurus research dan fungsi stress_test dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status stress_test, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
