# data_schema/output_contract

## Purpose
Menetapkan aturan operasional untuk data_schema dan fungsi output_contract dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul data_schema dan seluruh agent yang bergantung pada output_contract.

## Definitions
- output_contract: komponen utama yang mengatur data_schema dan fungsi output_contract.
...
## Core rules
- output_contract hanya mengurus data_schema dan fungsi output_contract dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status output_contract, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
