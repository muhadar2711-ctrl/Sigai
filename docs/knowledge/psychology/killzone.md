...
## Purpose
Menetapkan aturan operasional untuk psychology dan fungsi killzone dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul psychology dan seluruh agent yang bergantung pada killzone.

## Definitions
- killzone: komponen utama yang mengatur psychology dan fungsi killzone.
...
## Core rules
- killzone hanya mengurus psychology dan fungsi killzone dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status killzone, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
