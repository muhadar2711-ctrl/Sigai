# confidence_engine/calibration

## Purpose
Menetapkan aturan operasional untuk enterprise_plus confidence_engine untuk calibration dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul confidence_engine dan seluruh agent yang bergantung pada calibration.

## Definitions
- calibration: komponen utama yang mengatur enterprise_plus confidence_engine untuk calibration.
...
## Core rules
- calibration hanya mengurus enterprise_plus confidence_engine untuk calibration dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status calibration, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
