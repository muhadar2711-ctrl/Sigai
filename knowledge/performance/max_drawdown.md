...
## Purpose
Menetapkan aturan operasional untuk performance dan fungsi max_drawdown dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul performance dan seluruh agent yang bergantung pada max_drawdown.

## Definitions
- max_drawdown: komponen utama yang mengatur performance dan fungsi max_drawdown.
...
## Core rules
- max_drawdown hanya mengurus performance dan fungsi max_drawdown dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status max_drawdown, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
