# self_monitoring/load_monitor

## Purpose
Menetapkan aturan operasional untuk enterprise_plus self_monitoring untuk load_monitor dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul self_monitoring dan seluruh agent yang bergantung pada load_monitor.

## Definitions
- load_monitor: komponen utama yang mengatur enterprise_plus self_monitoring untuk load_monitor.
...
## Core rules
- load_monitor hanya mengurus enterprise_plus self_monitoring untuk load_monitor dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status load_monitor, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
