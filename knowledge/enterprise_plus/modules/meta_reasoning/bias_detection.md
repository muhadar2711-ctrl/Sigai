# meta_reasoning/bias_detection

## Purpose
Menetapkan aturan operasional untuk enterprise_plus meta_reasoning untuk bias_detection dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul meta_reasoning dan seluruh agent yang bergantung pada bias_detection.

## Definitions
- bias_detection: komponen utama yang mengatur enterprise_plus meta_reasoning untuk bias_detection.
...
## Core rules
- bias_detection hanya mengurus enterprise_plus meta_reasoning untuk bias_detection dan tidak boleh mengambil tanggung jawab modul lain.
