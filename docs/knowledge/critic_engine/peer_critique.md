# critic_engine/peer_critique

## Purpose
Menetapkan aturan operasional untuk critic_engine dan fungsi peer_critique dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul critic_engine dan seluruh agent yang bergantung pada peer_critique.

## Definitions
- peer_critique: komponen utama yang mengatur critic_engine dan fungsi peer_critique.
...
## Core rules
- peer_critique hanya mengurus critic_engine dan fungsi peer_critique dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status peer_critique, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
