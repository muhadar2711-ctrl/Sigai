# anomaly_detection/signal_anomaly

## Purpose
Menetapkan aturan operasional untuk enterprise_plus anomaly_detection untuk signal_anomaly dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul anomaly_detection dan seluruh agent yang bergantung pada signal_anomaly.

## Definitions
- signal_anomaly: komponen utama yang mengatur enterprise_plus anomaly_detection untuk signal_anomaly.
...
## Core rules
- signal_anomaly hanya mengurus enterprise_plus anomaly_detection untuk signal_anomaly dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status signal_anomaly, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
