# constraint_solver/data_constraints

## Purpose
Menetapkan aturan operasional untuk enterprise_plus constraint_solver untuk data_constraints dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul constraint_solver dan seluruh agent yang bergantung pada data_constraints.

## Definitions
- data_constraints: komponen utama yang mengatur enterprise_plus constraint_solver untuk data_constraints.
...
## Core rules
- data_constraints hanya mengurus enterprise_plus constraint_solver untuk data_constraints dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status data_constraints, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
