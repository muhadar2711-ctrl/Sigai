# confidence_engine/decay

## Purpose
Menetapkan aturan operasional untuk enterprise_plus confidence_engine untuk decay dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul confidence_engine dan seluruh agent yang bergantung pada decay.

## Definitions
- decay: komponen utama yang mengatur enterprise_plus confidence_engine untuk decay.
...
## Core rules
- decay hanya mengurus enterprise_plus confidence_engine untuk decay dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status decay, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
