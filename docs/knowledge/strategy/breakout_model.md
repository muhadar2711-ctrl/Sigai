# strategy/breakout_model

## Purpose
Menetapkan aturan operasional untuk strategy dan fungsi breakout_model dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul strategy dan seluruh agent yang bergantung pada breakout_model.

## Definitions
- breakout_model: komponen utama yang mengatur strategy dan fungsi breakout_model.
...
## Core rules
- breakout_model hanya mengurus strategy dan fungsi breakout_model dan tidak boleh mengambil tanggung jawab modul lain.
