# session_engine/session_bias

## Purpose
Menetapkan aturan operasional untuk enterprise_plus session_engine untuk session_bias dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul session_engine dan seluruh agent yang bergantung pada session_bias.

## Definitions
- session_bias: komponen utama yang mengatur enterprise_plus session_engine untuk session_bias.
...
## Core rules
- session_bias hanya mengurus enterprise_plus session_engine untuk session_bias dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status session_bias, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
