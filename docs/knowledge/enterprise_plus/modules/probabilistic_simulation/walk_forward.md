# probabilistic_simulation/walk_forward

## Purpose
Menetapkan aturan operasional untuk enterprise_plus probabilistic_simulation untuk walk_forward dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul probabilistic_simulation dan seluruh agent yang bergantung pada walk_forward.

## Definitions
- walk_forward: komponen utama yang mengatur enterprise_plus probabilistic_simulation untuk walk_forward.
...
## Core rules
- walk_forward hanya mengurus enterprise_plus probabilistic_simulation untuk walk_forward dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status walk_forward, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
