...
## Purpose
Menetapkan aturan operasional untuk fundamental dan fungsi cpi dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul fundamental dan seluruh agent yang bergantung pada cpi.

## Definitions
- cpi: komponen utama yang mengatur fundamental dan fungsi cpi.
...
## Core rules
- cpi hanya mengurus fundamental dan fungsi cpi dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status cpi, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
