# constraint_solver/feasibility_check

## Purpose
Menetapkan aturan operasional untuk enterprise_plus constraint_solver untuk feasibility_check dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul constraint_solver dan seluruh agent yang bergantung pada feasibility_check.

## Definitions
- feasibility_check: komponen utama yang mengatur enterprise_plus constraint_solver untuk feasibility_check.
...
## Core rules
- feasibility_check hanya mengurus enterprise_plus constraint_solver untuk feasibility_check dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status feasibility_check, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
