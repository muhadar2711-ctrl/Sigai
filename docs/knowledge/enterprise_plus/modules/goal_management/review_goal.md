# goal_management/review_goal

## Purpose
Menetapkan aturan operasional untuk enterprise_plus goal_management untuk review_goal dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul goal_management dan seluruh agent yang bergantung pada review_goal.

## Definitions
- review_goal: komponen utama yang mengatur enterprise_plus goal_management untuk review_goal.
...
## Core rules
- review_goal hanya mengurus enterprise_plus goal_management untuk review_goal dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status review_goal, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
