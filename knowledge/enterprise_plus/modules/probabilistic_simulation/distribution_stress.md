# probabilistic_simulation/distribution_stress

## Purpose
Menetapkan aturan operasional untuk enterprise_plus probabilistic_simulation untuk distribution_stress dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul probabilistic_simulation dan seluruh agent yang bergantung pada distribution_stress.

## Definitions
- distribution_stress: komponen utama yang mengatur enterprise_plus probabilistic_simulation untuk distribution_stress.
...
## Core rules
- distribution_stress hanya mengurus enterprise_plus probabilistic_simulation untuk distribution_stress dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status distribution_stress, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
