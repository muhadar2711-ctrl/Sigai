# capital_preservation/correlation_guard

## Purpose
Menetapkan aturan operasional untuk enterprise_plus capital_preservation untuk correlation_guard dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul capital_preservation dan seluruh agent yang bergantung pada correlation_guard.

## Definitions
- correlation_guard: komponen utama yang mengatur enterprise_plus capital_preservation untuk correlation_guard.
...
## Core rules
- correlation_guard hanya mengurus enterprise_plus capital_preservation untuk correlation_guard dan tidak boleh mengambil tanggung jawab modul lain.
...
- Safety dan capital preservation selalu menang atas peluang.
- WAIT atau HALT adalah outcome profesional.

## Inputs
- Struktur market, session, liquidity, volatility, news, risk state, dan context aktif.
- Evidence dari modul terkait capital_preservation.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status correlation_guard, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder capital_preservation lain yang relevan.
