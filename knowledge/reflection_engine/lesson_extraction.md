# reflection_engine/lesson_extraction

## Purpose
Menetapkan aturan operasional untuk reflection_engine dan fungsi lesson_extraction dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul reflection_engine dan seluruh agent yang bergantung pada lesson_extraction.

## Definitions
- lesson_extraction: komponen utama yang mengatur reflection_engine dan fungsi lesson_extraction.
...
## Core rules
- lesson_extraction hanya mengurus reflection_engine dan fungsi lesson_extraction dan tidak boleh mengambil tanggung jawab modul lain.
...
- Memory update harus mengikuti hasil review yang terverifikasi.
- Jangan mengubah lesson menjadi aturan tanpa bukti berulang.

## Inputs
- Struktur market, session, liquidity, volatility, news, risk state, dan context aktif.
- Evidence dari modul terkait reflection_engine.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status lesson_extraction, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder reflection_engine lain yang relevan.
