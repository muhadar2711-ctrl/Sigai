# execution_guard/broker_health

## Purpose
Menetapkan aturan operasional untuk enterprise_plus execution_guard untuk broker_health dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul execution_guard dan seluruh agent yang bergantung pada broker_health.

## Definitions
- broker_health: komponen utama yang mengatur enterprise_plus execution_guard untuk broker_health.
...
## Core rules
- broker_health hanya mengurus enterprise_plus execution_guard untuk broker_health dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status broker_health, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
