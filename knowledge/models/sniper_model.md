...
## Purpose
Menetapkan aturan operasional untuk models dan fungsi sniper_model dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul models dan seluruh agent yang bergantung pada sniper_model.

## Definitions
- sniper_model: komponen utama yang mengatur models dan fungsi sniper_model.
...
## Core rules
- sniper_model hanya mengurus models dan fungsi sniper_model dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status sniper_model, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
