# risk_simulator/halt_path

## Purpose
Menetapkan aturan operasional untuk risk_simulator dan fungsi halt_path dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul risk_simulator dan seluruh agent yang bergantung pada halt_path.

## Definitions
- halt_path: komponen utama yang mengatur risk_simulator dan fungsi halt_path.
...
## Core rules
- halt_path hanya mengurus risk_simulator dan fungsi halt_path dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status halt_path, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
