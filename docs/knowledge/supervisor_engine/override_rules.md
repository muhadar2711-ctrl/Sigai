# supervisor_engine/override_rules

## Purpose
Menetapkan aturan operasional untuk supervisor_engine dan fungsi override_rules dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul supervisor_engine dan seluruh agent yang bergantung pada override_rules.

## Definitions
- override_rules: komponen utama yang mengatur supervisor_engine dan fungsi override_rules.
...
## Core rules
- override_rules hanya mengurus supervisor_engine dan fungsi override_rules dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait supervisor_engine.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status override_rules, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder supervisor_engine lain yang relevan.
