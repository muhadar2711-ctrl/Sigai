...
## Purpose
Menetapkan aturan operasional untuk performance dan fungsi average_rr dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul performance dan seluruh agent yang bergantung pada average_rr.

## Definitions
- average_rr: komponen utama yang mengatur performance dan fungsi average_rr.
...
## Core rules
- average_rr hanya mengurus performance dan fungsi average_rr dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status average_rr, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
