...
## Purpose
Menetapkan aturan operasional untuk psychology dan fungsi patience dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul psychology dan seluruh agent yang bergantung pada patience.

## Definitions
- patience: komponen utama yang mengatur psychology dan fungsi patience.
...
## Core rules
- patience hanya mengurus psychology dan fungsi patience dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status patience, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
