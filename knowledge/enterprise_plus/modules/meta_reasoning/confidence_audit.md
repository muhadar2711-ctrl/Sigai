# meta_reasoning/confidence_audit

## Purpose
Menetapkan aturan operasional untuk enterprise_plus meta_reasoning untuk confidence_audit dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul meta_reasoning dan seluruh agent yang bergantung pada confidence_audit.

## Definitions
- confidence_audit: komponen utama yang mengatur enterprise_plus meta_reasoning untuk confidence_audit.
...
## Core rules
- confidence_audit hanya mengurus enterprise_plus meta_reasoning untuk confidence_audit dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status confidence_audit, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
