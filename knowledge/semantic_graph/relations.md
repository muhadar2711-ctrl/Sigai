...
## Purpose
Menetapkan aturan operasional untuk semantic_graph dan fungsi relations dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul semantic_graph dan seluruh agent yang bergantung pada relations.

## Definitions
- relations: komponen utama yang mengatur semantic_graph dan fungsi relations.
...
## Core rules
- relations hanya mengurus semantic_graph dan fungsi relations dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status relations, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
