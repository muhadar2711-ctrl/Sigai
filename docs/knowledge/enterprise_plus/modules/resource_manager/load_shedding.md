# resource_manager/load_shedding

## Purpose
Menetapkan aturan operasional untuk enterprise_plus resource_manager untuk load_shedding dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul resource_manager dan seluruh agent yang bergantung pada load_shedding.

## Definitions
- load_shedding: komponen utama yang mengatur enterprise_plus resource_manager untuk load_shedding.
...
## Core rules
- load_shedding hanya mengurus enterprise_plus resource_manager untuk load_shedding dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status load_shedding, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
