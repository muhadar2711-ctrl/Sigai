...
## Purpose
Menetapkan aturan operasional untuk filters dan fungsi volatility_filter dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul filters dan seluruh agent yang bergantung pada volatility_filter.

## Definitions
- volatility_filter: komponen utama yang mengatur filters dan fungsi volatility_filter.
...
## Core rules
- volatility_filter hanya mengurus filters dan fungsi volatility_filter dan tidak boleh mengambil tanggung jawab modul lain.
