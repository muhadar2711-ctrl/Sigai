# critic_engine/counter_argument

## Purpose
Menetapkan aturan operasional untuk critic_engine dan fungsi counter_argument dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul critic_engine dan seluruh agent yang bergantung pada counter_argument.

## Definitions
- counter_argument: komponen utama yang mengatur critic_engine dan fungsi counter_argument.
...
## Core rules
- counter_argument hanya mengurus critic_engine dan fungsi counter_argument dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status counter_argument, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
