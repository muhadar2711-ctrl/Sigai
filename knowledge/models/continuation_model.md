# models/continuation_model

## Purpose
Menetapkan aturan operasional untuk models dan fungsi continuation_model dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul models dan seluruh agent yang bergantung pada continuation_model.

## Definitions
- continuation_model: komponen utama yang mengatur models dan fungsi continuation_model.
...
## Core rules
- continuation_model hanya mengurus models dan fungsi continuation_model dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status continuation_model, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
