# risk_simulator/risk_path

## Purpose
Menetapkan aturan operasional untuk risk_simulator dan fungsi risk_path dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul risk_simulator dan seluruh agent yang bergantung pada risk_path.

## Definitions
- risk_path: komponen utama yang mengatur risk_simulator dan fungsi risk_path.
...
## Core rules
- risk_path hanya mengurus risk_simulator dan fungsi risk_path dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status risk_path, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
