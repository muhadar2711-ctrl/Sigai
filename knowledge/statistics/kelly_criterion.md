# statistics/kelly_criterion

## Purpose
Menetapkan aturan operasional untuk statistics dan fungsi kelly_criterion dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul statistics dan seluruh agent yang bergantung pada kelly_criterion.

## Definitions
- kelly_criterion: komponen utama yang mengatur statistics dan fungsi kelly_criterion.
...
## Core rules
- kelly_criterion hanya mengurus statistics dan fungsi kelly_criterion dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait statistics.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status kelly_criterion, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder statistics lain yang relevan.
