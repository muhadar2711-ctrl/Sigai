...
## Purpose
Menetapkan aturan operasional untuk psychology dan fungsi overtrading dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul psychology dan seluruh agent yang bergantung pada overtrading.

## Definitions
- overtrading: komponen utama yang mengatur psychology dan fungsi overtrading.
...
## Core rules
- overtrading hanya mengurus psychology dan fungsi overtrading dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status overtrading, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
