# market_simulator/market_path

## Purpose
Menetapkan aturan operasional untuk market_simulator dan fungsi market_path dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul market_simulator dan seluruh agent yang bergantung pada market_path.

## Definitions
- market_path: komponen utama yang mengatur market_simulator dan fungsi market_path.
...
## Core rules
- market_path hanya mengurus market_simulator dan fungsi market_path dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status market_path, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
