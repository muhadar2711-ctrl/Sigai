...
## Purpose
Menetapkan aturan operasional untuk strategy dan fungsi confluence dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul strategy dan seluruh agent yang bergantung pada confluence.

## Definitions
- confluence: komponen utama yang mengatur strategy dan fungsi confluence.
...
## Core rules
- confluence hanya mengurus strategy dan fungsi confluence dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status confluence, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
