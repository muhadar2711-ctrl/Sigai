# probabilistic_simulation/sensitivity_analysis

## Purpose
Menetapkan aturan operasional untuk enterprise_plus probabilistic_simulation untuk sensitivity_analysis dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul probabilistic_simulation dan seluruh agent yang bergantung pada sensitivity_analysis.

## Definitions
- sensitivity_analysis: komponen utama yang mengatur enterprise_plus probabilistic_simulation untuk sensitivity_analysis.
...
## Core rules
- sensitivity_analysis hanya mengurus enterprise_plus probabilistic_simulation untuk sensitivity_analysis dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status sensitivity_analysis, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
