# scoring_framework/quality_score

## Purpose
Menetapkan aturan operasional untuk enterprise_plus scoring_framework untuk quality_score dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul scoring_framework dan seluruh agent yang bergantung pada quality_score.

## Definitions
- quality_score: komponen utama yang mengatur enterprise_plus scoring_framework untuk quality_score.
...
## Core rules
- quality_score hanya mengurus enterprise_plus scoring_framework untuk quality_score dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status quality_score, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
