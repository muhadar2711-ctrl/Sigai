# portfolio_engine/position_concentration

## Purpose
Menetapkan aturan operasional untuk enterprise_plus portfolio_engine untuk position_concentration dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul portfolio_engine dan seluruh agent yang bergantung pada position_concentration.

## Definitions
- position_concentration: komponen utama yang mengatur enterprise_plus portfolio_engine untuk position_concentration.
...
## Core rules
- position_concentration hanya mengurus enterprise_plus portfolio_engine untuk position_concentration dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait portfolio_engine.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status position_concentration, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder portfolio_engine lain yang relevan.
