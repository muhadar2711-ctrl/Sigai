# intent_engine/intent_storage

## Purpose
Menetapkan aturan operasional untuk enterprise_plus intent_engine untuk intent_storage dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul intent_engine dan seluruh agent yang bergantung pada intent_storage.

## Definitions
- intent_storage: komponen utama yang mengatur enterprise_plus intent_engine untuk intent_storage.
...
## Core rules
- intent_storage hanya mengurus enterprise_plus intent_engine untuk intent_storage dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status intent_storage, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
