# statistics/edge_ratio

## Purpose
Menetapkan aturan operasional untuk statistics dan fungsi edge_ratio dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul statistics dan seluruh agent yang bergantung pada edge_ratio.

## Definitions
- edge_ratio: komponen utama yang mengatur statistics dan fungsi edge_ratio.
...
## Core rules
- edge_ratio hanya mengurus statistics dan fungsi edge_ratio dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status edge_ratio, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
