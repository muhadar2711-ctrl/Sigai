# decision_engine/decision_gate

## Purpose
Menetapkan aturan operasional untuk decision_engine dan fungsi decision_gate dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul decision_engine dan seluruh agent yang bergantung pada decision_gate.

## Definitions
- decision_gate: komponen utama yang mengatur decision_engine dan fungsi decision_gate.
...
## Core rules
- decision_gate hanya mengurus decision_engine dan fungsi decision_gate dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status decision_gate, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
