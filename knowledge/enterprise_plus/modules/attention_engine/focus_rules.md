# attention_engine/focus_rules

## Purpose
Menetapkan aturan operasional untuk enterprise_plus attention_engine untuk focus_rules dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul attention_engine dan seluruh agent yang bergantung pada focus_rules.

## Definitions
- focus_rules: komponen utama yang mengatur enterprise_plus attention_engine untuk focus_rules.
...
## Core rules
- focus_rules hanya mengurus enterprise_plus attention_engine untuk focus_rules dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status focus_rules, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
