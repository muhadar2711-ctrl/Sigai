...
## Purpose
Menetapkan aturan operasional untuk memory dan fungsi failure_patterns dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul memory dan seluruh agent yang bergantung pada failure_patterns.

## Definitions
- failure_patterns: komponen utama yang mengatur memory dan fungsi failure_patterns.
...
## Core rules
- failure_patterns hanya mengurus memory dan fungsi failure_patterns dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status failure_patterns, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
