# graph_index/lookup_policy

## Purpose
Menetapkan aturan operasional untuk graph_index dan fungsi lookup_policy dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul graph_index dan seluruh agent yang bergantung pada lookup_policy.

## Definitions
- lookup_policy: komponen utama yang mengatur graph_index dan fungsi lookup_policy.
...
## Core rules
- lookup_policy hanya mengurus graph_index dan fungsi lookup_policy dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status lookup_policy, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
