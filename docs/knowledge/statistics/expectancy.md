...
## Purpose
Menetapkan aturan operasional untuk statistics dan fungsi expectancy dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul statistics dan seluruh agent yang bergantung pada expectancy.

## Definitions
- expectancy: komponen utama yang mengatur statistics dan fungsi expectancy.
...
## Core rules
- expectancy hanya mengurus statistics dan fungsi expectancy dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status expectancy, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
