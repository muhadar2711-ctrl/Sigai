# market_simulator/liquidity_shift

## Purpose
Menetapkan aturan operasional untuk market_simulator dan fungsi liquidity_shift dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul market_simulator dan seluruh agent yang bergantung pada liquidity_shift.

## Definitions
- liquidity_shift: komponen utama yang mengatur market_simulator dan fungsi liquidity_shift.
...
## Core rules
- liquidity_shift hanya mengurus market_simulator dan fungsi liquidity_shift dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status liquidity_shift, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
