# cognitive_architecture/belief_system

## Purpose
Menetapkan aturan operasional untuk enterprise_plus cognitive_architecture untuk belief_system dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul cognitive_architecture dan seluruh agent yang bergantung pada belief_system.

## Definitions
- belief_system: komponen utama yang mengatur enterprise_plus cognitive_architecture untuk belief_system.
...
## Core rules
- belief_system hanya mengurus enterprise_plus cognitive_architecture untuk belief_system dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status belief_system, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
