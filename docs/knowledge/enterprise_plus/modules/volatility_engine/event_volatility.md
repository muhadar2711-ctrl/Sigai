# volatility_engine/event_volatility

## Purpose
Menetapkan aturan operasional untuk enterprise_plus volatility_engine untuk event_volatility dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul volatility_engine dan seluruh agent yang bergantung pada event_volatility.

## Definitions
- event_volatility: komponen utama yang mengatur enterprise_plus volatility_engine untuk event_volatility.
...
## Core rules
- event_volatility hanya mengurus enterprise_plus volatility_engine untuk event_volatility dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status event_volatility, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
