# intent_engine/market_intent

## Purpose
Menetapkan aturan operasional untuk enterprise_plus intent_engine untuk market_intent dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul intent_engine dan seluruh agent yang bergantung pada market_intent.

## Definitions
- market_intent: komponen utama yang mengatur enterprise_plus intent_engine untuk market_intent.
...
## Core rules
- market_intent hanya mengurus enterprise_plus intent_engine untuk market_intent dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status market_intent, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
