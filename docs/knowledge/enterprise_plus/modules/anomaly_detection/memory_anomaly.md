# anomaly_detection/memory_anomaly

## Purpose
Menetapkan aturan operasional untuk enterprise_plus anomaly_detection untuk memory_anomaly dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul anomaly_detection dan seluruh agent yang bergantung pada memory_anomaly.

## Definitions
- memory_anomaly: komponen utama yang mengatur enterprise_plus anomaly_detection untuk memory_anomaly.
...
## Core rules
- memory_anomaly hanya mengurus enterprise_plus anomaly_detection untuk memory_anomaly dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status memory_anomaly, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
