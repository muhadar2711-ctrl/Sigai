# confidence_engine/consistency_score

## Purpose
Menetapkan aturan operasional untuk enterprise_plus confidence_engine untuk consistency_score dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul confidence_engine dan seluruh agent yang bergantung pada consistency_score.

## Definitions
- consistency_score: komponen utama yang mengatur enterprise_plus confidence_engine untuk consistency_score.
...
## Core rules
- consistency_score hanya mengurus enterprise_plus confidence_engine untuk consistency_score dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait confidence_engine.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status consistency_score, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder confidence_engine lain yang relevan.
