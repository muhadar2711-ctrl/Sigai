# volatility_engine/volatility_spikes

## Purpose
Menetapkan aturan operasional untuk enterprise_plus volatility_engine untuk volatility_spikes dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul volatility_engine dan seluruh agent yang bergantung pada volatility_spikes.

## Definitions
- volatility_spikes: komponen utama yang mengatur enterprise_plus volatility_engine untuk volatility_spikes.
...
## Core rules
- volatility_spikes hanya mengurus enterprise_plus volatility_engine untuk volatility_spikes dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status volatility_spikes, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
