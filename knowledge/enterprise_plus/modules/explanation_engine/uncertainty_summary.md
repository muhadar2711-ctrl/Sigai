# explanation_engine/uncertainty_summary

## Purpose
Menetapkan aturan operasional untuk enterprise_plus explanation_engine untuk uncertainty_summary dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul explanation_engine dan seluruh agent yang bergantung pada uncertainty_summary.

## Definitions
- uncertainty_summary: komponen utama yang mengatur enterprise_plus explanation_engine untuk uncertainty_summary.
...
## Core rules
- uncertainty_summary hanya mengurus enterprise_plus explanation_engine untuk uncertainty_summary dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status uncertainty_summary, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
