# planner_engine/fallback_plan

## Purpose
Menetapkan aturan operasional untuk planner_engine dan fungsi fallback_plan dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul planner_engine dan seluruh agent yang bergantung pada fallback_plan.

## Definitions
- fallback_plan: komponen utama yang mengatur planner_engine dan fungsi fallback_plan.
...
## Core rules
- fallback_plan hanya mengurus planner_engine dan fungsi fallback_plan dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status fallback_plan, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
