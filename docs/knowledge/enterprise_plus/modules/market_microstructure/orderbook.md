# market_microstructure/orderbook

## Purpose
Menetapkan aturan operasional untuk enterprise_plus market_microstructure untuk orderbook dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul market_microstructure dan seluruh agent yang bergantung pada orderbook.

## Definitions
- orderbook: komponen utama yang mengatur enterprise_plus market_microstructure untuk orderbook.
...
## Core rules
- orderbook hanya mengurus enterprise_plus market_microstructure untuk orderbook dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status orderbook, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
