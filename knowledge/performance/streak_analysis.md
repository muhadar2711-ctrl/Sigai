# performance/streak_analysis

## Purpose
Menetapkan aturan operasional untuk performance dan fungsi streak_analysis dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul performance dan seluruh agent yang bergantung pada streak_analysis.

## Definitions
- streak_analysis: komponen utama yang mengatur performance dan fungsi streak_analysis.
...
## Core rules
- streak_analysis hanya mengurus performance dan fungsi streak_analysis dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait performance.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status streak_analysis, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder performance lain yang relevan.
