# explanation_engine/evidence_chain

## Purpose
Menetapkan aturan operasional untuk enterprise_plus explanation_engine untuk evidence_chain dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul explanation_engine dan seluruh agent yang bergantung pada evidence_chain.

## Definitions
- evidence_chain: komponen utama yang mengatur enterprise_plus explanation_engine untuk evidence_chain.
...
## Core rules
- evidence_chain hanya mengurus enterprise_plus explanation_engine untuk evidence_chain dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status evidence_chain, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
