# simulation_engine/what_if

## Purpose
Menetapkan aturan operasional untuk simulation_engine dan fungsi what_if dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul simulation_engine dan seluruh agent yang bergantung pada what_if.

## Definitions
- what_if: komponen utama yang mengatur simulation_engine dan fungsi what_if.
...
## Core rules
- what_if hanya mengurus simulation_engine dan fungsi what_if dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status what_if, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
