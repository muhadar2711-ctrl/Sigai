# explanation_engine/reasoning_summary

## Purpose
Menetapkan aturan operasional untuk enterprise_plus explanation_engine untuk reasoning_summary dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul explanation_engine dan seluruh agent yang bergantung pada reasoning_summary.

## Definitions
- reasoning_summary: komponen utama yang mengatur enterprise_plus explanation_engine untuk reasoning_summary.
...
## Core rules
- reasoning_summary hanya mengurus enterprise_plus explanation_engine untuk reasoning_summary dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status reasoning_summary, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
