# confidence_engine/final_confidence

## Purpose
Menetapkan aturan operasional untuk enterprise_plus confidence_engine untuk final_confidence dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul confidence_engine dan seluruh agent yang bergantung pada final_confidence.

## Definitions
- final_confidence: komponen utama yang mengatur enterprise_plus confidence_engine untuk final_confidence.
...
## Core rules
- final_confidence hanya mengurus enterprise_plus confidence_engine untuk final_confidence dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status final_confidence, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
