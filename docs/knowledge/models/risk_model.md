...
## Purpose
Menetapkan aturan operasional untuk models dan fungsi risk_model dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul models dan seluruh agent yang bergantung pada risk_model.

## Definitions
- risk_model: komponen utama yang mengatur models dan fungsi risk_model.
...
## Core rules
- risk_model hanya mengurus models dan fungsi risk_model dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status risk_model, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
