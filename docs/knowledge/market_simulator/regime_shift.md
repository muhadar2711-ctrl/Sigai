# market_simulator/regime_shift

## Purpose
Menetapkan aturan operasional untuk market_simulator dan fungsi regime_shift dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul market_simulator dan seluruh agent yang bergantung pada regime_shift.

## Definitions
- regime_shift: komponen utama yang mengatur market_simulator dan fungsi regime_shift.
...
## Core rules
- regime_shift hanya mengurus market_simulator dan fungsi regime_shift dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status regime_shift, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
