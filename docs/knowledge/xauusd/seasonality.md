...
## Purpose
Menetapkan aturan operasional untuk xauusd dan fungsi seasonality dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul xauusd dan seluruh agent yang bergantung pada seasonality.

## Definitions
- seasonality: komponen utama yang mengatur xauusd dan fungsi seasonality.
...
## Core rules
- seasonality hanya mengurus xauusd dan fungsi seasonality dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status seasonality, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
