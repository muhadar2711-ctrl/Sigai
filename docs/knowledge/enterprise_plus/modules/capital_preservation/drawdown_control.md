# capital_preservation/drawdown_control

## Purpose
Menetapkan aturan operasional untuk enterprise_plus capital_preservation untuk drawdown_control dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul capital_preservation dan seluruh agent yang bergantung pada drawdown_control.

## Definitions
- drawdown_control: komponen utama yang mengatur enterprise_plus capital_preservation untuk drawdown_control.
...
## Core rules
- drawdown_control hanya mengurus enterprise_plus capital_preservation untuk drawdown_control dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status drawdown_control, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
