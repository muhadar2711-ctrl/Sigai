# experience_learning/outcome_tracking

## Purpose
Menetapkan aturan operasional untuk enterprise_plus experience_learning untuk outcome_tracking dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul experience_learning dan seluruh agent yang bergantung pada outcome_tracking.

## Definitions
- outcome_tracking: komponen utama yang mengatur enterprise_plus experience_learning untuk outcome_tracking.
...
## Core rules
- outcome_tracking hanya mengurus enterprise_plus experience_learning untuk outcome_tracking dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status outcome_tracking, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
