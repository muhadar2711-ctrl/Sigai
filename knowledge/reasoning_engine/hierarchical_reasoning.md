# reasoning_engine/hierarchical_reasoning

## Purpose
Menetapkan aturan operasional untuk reasoning_engine dan fungsi hierarchical_reasoning dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul reasoning_engine dan seluruh agent yang bergantung pada hierarchical_reasoning.

## Definitions
- hierarchical_reasoning: komponen utama yang mengatur reasoning_engine dan fungsi hierarchical_reasoning.
...
## Core rules
- hierarchical_reasoning hanya mengurus reasoning_engine dan fungsi hierarchical_reasoning dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait reasoning_engine.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status hierarchical_reasoning, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder reasoning_engine lain yang relevan.
