# research/market_regime_study

## Purpose
Menetapkan aturan operasional untuk research dan fungsi market_regime_study dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul research dan seluruh agent yang bergantung pada market_regime_study.

## Definitions
- market_regime_study: komponen utama yang mengatur research dan fungsi market_regime_study.
...
## Core rules
- market_regime_study hanya mengurus research dan fungsi market_regime_study dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status market_regime_study, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
