# cognitive_architecture/planner

## Purpose
Menetapkan aturan operasional untuk enterprise_plus cognitive_architecture untuk planner dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul cognitive_architecture dan seluruh agent yang bergantung pada planner.

## Definitions
- planner: komponen utama yang mengatur enterprise_plus cognitive_architecture untuk planner.
...
## Core rules
- planner hanya mengurus enterprise_plus cognitive_architecture untuk planner dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status planner, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
