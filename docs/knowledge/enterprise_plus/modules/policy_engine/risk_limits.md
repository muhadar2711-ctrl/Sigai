# policy_engine/risk_limits

## Purpose
Menetapkan aturan operasional untuk enterprise_plus policy_engine untuk risk_limits dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul policy_engine dan seluruh agent yang bergantung pada risk_limits.

## Definitions
- risk_limits: komponen utama yang mengatur enterprise_plus policy_engine untuk risk_limits.
...
## Core rules
- risk_limits hanya mengurus enterprise_plus policy_engine untuk risk_limits dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status risk_limits, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
