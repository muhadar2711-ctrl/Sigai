# knowledge_base/module_index

## Purpose
Menetapkan aturan operasional untuk knowledge_base dan fungsi module_index dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul knowledge_base dan seluruh agent yang bergantung pada module_index.

## Definitions
- module_index: komponen utama yang mengatur knowledge_base dan fungsi module_index.
...
## Core rules
- module_index hanya mengurus knowledge_base dan fungsi module_index dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status module_index, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
