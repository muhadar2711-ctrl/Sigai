...
## Purpose
Menetapkan aturan operasional untuk statistics dan fungsi profit_factor dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul statistics dan seluruh agent yang bergantung pada profit_factor.

## Definitions
- profit_factor: komponen utama yang mengatur statistics dan fungsi profit_factor.
...
## Core rules
- profit_factor hanya mengurus statistics dan fungsi profit_factor dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status profit_factor, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
