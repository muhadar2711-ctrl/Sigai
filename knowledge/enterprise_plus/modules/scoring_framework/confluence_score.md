# scoring_framework/confluence_score

## Purpose
Menetapkan aturan operasional untuk enterprise_plus scoring_framework untuk confluence_score dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul scoring_framework dan seluruh agent yang bergantung pada confluence_score.

## Definitions
- confluence_score: komponen utama yang mengatur enterprise_plus scoring_framework untuk confluence_score.
...
## Core rules
- confluence_score hanya mengurus enterprise_plus scoring_framework untuk confluence_score dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait scoring_framework.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status confluence_score, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder scoring_framework lain yang relevan.
