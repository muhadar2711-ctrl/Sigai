...
## Purpose
Menetapkan aturan operasional untuk research dan fungsi walkforward dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul research dan seluruh agent yang bergantung pada walkforward.

## Definitions
- walkforward: komponen utama yang mengatur research dan fungsi walkforward.
...
## Core rules
- walkforward hanya mengurus research dan fungsi walkforward dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status walkforward, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
