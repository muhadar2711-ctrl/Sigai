...
## Purpose
Menetapkan aturan operasional untuk statistics dan fungsi winrate dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul statistics dan seluruh agent yang bergantung pada winrate.

## Definitions
- winrate: komponen utama yang mengatur statistics dan fungsi winrate.
...
## Core rules
- winrate hanya mengurus statistics dan fungsi winrate dan tidak boleh mengambil tanggung jawab modul lain.
