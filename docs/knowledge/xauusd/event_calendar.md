# xauusd/event_calendar

## Purpose
Menetapkan aturan operasional untuk xauusd dan fungsi event_calendar dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul xauusd dan seluruh agent yang bergantung pada event_calendar.

## Definitions
- event_calendar: komponen utama yang mengatur xauusd dan fungsi event_calendar.
...
## Core rules
- event_calendar hanya mengurus xauusd dan fungsi event_calendar dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status event_calendar, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
