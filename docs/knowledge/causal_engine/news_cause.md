# causal_engine/news_cause

## Purpose
Menetapkan aturan operasional untuk causal_engine dan fungsi news_cause dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul causal_engine dan seluruh agent yang bergantung pada news_cause.

## Definitions
- news_cause: komponen utama yang mengatur causal_engine dan fungsi news_cause.
...
## Core rules
- news_cause hanya mengurus causal_engine dan fungsi news_cause dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status news_cause, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
