# inference_engine/evidence_balancing

## Purpose
Menetapkan aturan operasional untuk enterprise_plus inference_engine untuk evidence_balancing dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul inference_engine dan seluruh agent yang bergantung pada evidence_balancing.

## Definitions
- evidence_balancing: komponen utama yang mengatur enterprise_plus inference_engine untuk evidence_balancing.
...
## Core rules
- evidence_balancing hanya mengurus enterprise_plus inference_engine untuk evidence_balancing dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status evidence_balancing, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
