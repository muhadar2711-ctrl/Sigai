...
## Purpose
Menetapkan aturan operasional untuk strategy dan fungsi smc dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul strategy dan seluruh agent yang bergantung pada smc.

## Definitions
- smc: komponen utama yang mengatur strategy dan fungsi smc.
...
## Core rules
- smc hanya mengurus strategy dan fungsi smc dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status smc, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
