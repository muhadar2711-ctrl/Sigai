# fundamental/interest_rate

## Purpose
Menetapkan aturan operasional untuk fundamental dan fungsi interest_rate dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul fundamental dan seluruh agent yang bergantung pada interest_rate.

## Definitions
- interest_rate: komponen utama yang mengatur fundamental dan fungsi interest_rate.
...
## Core rules
- interest_rate hanya mengurus fundamental dan fungsi interest_rate dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status interest_rate, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
