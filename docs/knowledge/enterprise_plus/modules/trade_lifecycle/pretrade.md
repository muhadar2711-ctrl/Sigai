# trade_lifecycle/pretrade

## Purpose
Menetapkan aturan operasional untuk enterprise_plus trade_lifecycle untuk pretrade dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul trade_lifecycle dan seluruh agent yang bergantung pada pretrade.

## Definitions
- pretrade: komponen utama yang mengatur enterprise_plus trade_lifecycle untuk pretrade.
...
## Core rules
- pretrade hanya mengurus enterprise_plus trade_lifecycle untuk pretrade dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status pretrade, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
