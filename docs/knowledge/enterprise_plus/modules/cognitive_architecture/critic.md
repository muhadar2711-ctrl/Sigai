# cognitive_architecture/critic

## Purpose
Menetapkan aturan operasional untuk enterprise_plus cognitive_architecture untuk critic dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul cognitive_architecture dan seluruh agent yang bergantung pada critic.

## Definitions
- critic: komponen utama yang mengatur enterprise_plus cognitive_architecture untuk critic.
...
## Core rules
- critic hanya mengurus enterprise_plus cognitive_architecture untuk critic dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status critic, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
