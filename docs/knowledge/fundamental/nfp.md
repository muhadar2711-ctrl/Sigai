...
## Purpose
Menetapkan aturan operasional untuk fundamental dan fungsi nfp dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul fundamental dan seluruh agent yang bergantung pada nfp.

## Definitions
- nfp: komponen utama yang mengatur fundamental dan fungsi nfp.
...
## Core rules
- nfp hanya mengurus fundamental dan fungsi nfp dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status nfp, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
