# policy_engine/no_trade_policy

## Purpose
Menetapkan aturan operasional untuk enterprise_plus policy_engine untuk no_trade_policy dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul policy_engine dan seluruh agent yang bergantung pada no_trade_policy.

## Definitions
- no_trade_policy: komponen utama yang mengatur enterprise_plus policy_engine untuk no_trade_policy.
...
## Core rules
- no_trade_policy hanya mengurus enterprise_plus policy_engine untuk no_trade_policy dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status no_trade_policy, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
