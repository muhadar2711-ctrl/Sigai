...
## Purpose
Menetapkan aturan operasional untuk verification dan fungsi quality_control dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul verification dan seluruh agent yang bergantung pada quality_control.

## Definitions
- quality_control: komponen utama yang mengatur verification dan fungsi quality_control.
...
## Core rules
- quality_control hanya mengurus verification dan fungsi quality_control dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status quality_control, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
