# state_machine/restart_rules

## Purpose
Menetapkan aturan operasional untuk enterprise_plus state_machine untuk restart_rules dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul state_machine dan seluruh agent yang bergantung pada restart_rules.

## Definitions
- restart_rules: komponen utama yang mengatur enterprise_plus state_machine untuk restart_rules.
...
## Core rules
- restart_rules hanya mengurus enterprise_plus state_machine untuk restart_rules dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status restart_rules, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
