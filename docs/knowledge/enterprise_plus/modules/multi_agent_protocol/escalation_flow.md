# multi_agent_protocol/escalation_flow

## Purpose
Menetapkan aturan operasional untuk enterprise_plus multi_agent_protocol untuk escalation_flow dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul multi_agent_protocol dan seluruh agent yang bergantung pada escalation_flow.

## Definitions
- escalation_flow: komponen utama yang mengatur enterprise_plus multi_agent_protocol untuk escalation_flow.
...
## Core rules
- escalation_flow hanya mengurus enterprise_plus multi_agent_protocol untuk escalation_flow dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status escalation_flow, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
