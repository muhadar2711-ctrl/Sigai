# strategy/continuation_model

## Purpose
Menetapkan aturan operasional untuk strategy dan fungsi continuation_model dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul strategy dan seluruh agent yang bergantung pada continuation_model.

## Definitions
- continuation_model: komponen utama yang mengatur strategy dan fungsi continuation_model.
...
## Core rules
- continuation_model hanya mengurus strategy dan fungsi continuation_model dan tidak boleh mengambil tanggung jawab modul lain.
