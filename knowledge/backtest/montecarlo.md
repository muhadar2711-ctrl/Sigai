...
## Purpose
Menetapkan aturan operasional untuk backtest dan fungsi montecarlo dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul backtest dan seluruh agent yang bergantung pada montecarlo.

## Definitions
- montecarlo: komponen utama yang mengatur backtest dan fungsi montecarlo.
...
## Core rules
- montecarlo hanya mengurus backtest dan fungsi montecarlo dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status montecarlo, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
