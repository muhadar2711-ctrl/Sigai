# volatility_engine/volatility_filter

## Purpose
Menetapkan aturan operasional untuk enterprise_plus volatility_engine untuk volatility_filter dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul volatility_engine dan seluruh agent yang bergantung pada volatility_filter.

## Definitions
- volatility_filter: komponen utama yang mengatur enterprise_plus volatility_engine untuk volatility_filter.
...
## Core rules
- volatility_filter hanya mengurus enterprise_plus volatility_engine untuk volatility_filter dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status volatility_filter, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
