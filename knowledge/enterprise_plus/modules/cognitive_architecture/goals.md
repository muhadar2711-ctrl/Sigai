# cognitive_architecture/goals

## Purpose
Menetapkan aturan operasional untuk enterprise_plus cognitive_architecture untuk goals dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul cognitive_architecture dan seluruh agent yang bergantung pada goals.

## Definitions
- goals: komponen utama yang mengatur enterprise_plus cognitive_architecture untuk goals.
...
## Core rules
- goals hanya mengurus enterprise_plus cognitive_architecture untuk goals dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status goals, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
