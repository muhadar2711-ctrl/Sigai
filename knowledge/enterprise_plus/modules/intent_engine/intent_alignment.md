# intent_engine/intent_alignment

## Purpose
Menetapkan aturan operasional untuk enterprise_plus intent_engine untuk intent_alignment dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul intent_engine dan seluruh agent yang bergantung pada intent_alignment.

## Definitions
- intent_alignment: komponen utama yang mengatur enterprise_plus intent_engine untuk intent_alignment.
...
## Core rules
- intent_alignment hanya mengurus enterprise_plus intent_engine untuk intent_alignment dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status intent_alignment, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
