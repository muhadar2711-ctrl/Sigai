# backtest/robustness_test

## Purpose
Menetapkan aturan operasional untuk backtest dan fungsi robustness_test dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul backtest dan seluruh agent yang bergantung pada robustness_test.

## Definitions
- robustness_test: komponen utama yang mengatur backtest dan fungsi robustness_test.
...
## Core rules
- robustness_test hanya mengurus backtest dan fungsi robustness_test dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait backtest.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status robustness_test, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder backtest lain yang relevan.
