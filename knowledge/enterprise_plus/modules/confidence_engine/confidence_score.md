# confidence_engine/confidence_score

## Purpose
Menetapkan aturan operasional untuk enterprise_plus confidence_engine untuk confidence_score dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul confidence_engine dan seluruh agent yang bergantung pada confidence_score.

## Definitions
- confidence_score: komponen utama yang mengatur enterprise_plus confidence_engine untuk confidence_score.
...
## Core rules
- confidence_score hanya mengurus enterprise_plus confidence_engine untuk confidence_score dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status confidence_score, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
