# capital_preservation/recovery_rules

## Purpose
Menetapkan aturan operasional untuk enterprise_plus capital_preservation untuk recovery_rules dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul capital_preservation dan seluruh agent yang bergantung pada recovery_rules.

## Definitions
- recovery_rules: komponen utama yang mengatur enterprise_plus capital_preservation untuk recovery_rules.
...
## Core rules
- recovery_rules hanya mengurus enterprise_plus capital_preservation untuk recovery_rules dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status recovery_rules, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
