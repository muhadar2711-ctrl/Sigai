# confidence_engine/bonus_rules

## Purpose
Menetapkan aturan operasional untuk enterprise_plus confidence_engine untuk bonus_rules dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul confidence_engine dan seluruh agent yang bergantung pada bonus_rules.

## Definitions
- bonus_rules: komponen utama yang mengatur enterprise_plus confidence_engine untuk bonus_rules.
...
## Core rules
- bonus_rules hanya mengurus enterprise_plus confidence_engine untuk bonus_rules dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status bonus_rules, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
