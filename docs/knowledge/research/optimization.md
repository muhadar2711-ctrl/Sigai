...
## Purpose
Menetapkan aturan operasional untuk research dan fungsi optimization dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul research dan seluruh agent yang bergantung pada optimization.

## Definitions
- optimization: komponen utama yang mengatur research dan fungsi optimization.
...
## Core rules
- optimization hanya mengurus research dan fungsi optimization dan tidak boleh mengambil tanggung jawab modul lain.
