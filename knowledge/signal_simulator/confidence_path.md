# signal_simulator/confidence_path

## Purpose
Menetapkan aturan operasional untuk signal_simulator dan fungsi confidence_path dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul signal_simulator dan seluruh agent yang bergantung pada confidence_path.

## Definitions
- confidence_path: komponen utama yang mengatur signal_simulator dan fungsi confidence_path.
...
## Core rules
- confidence_path hanya mengurus signal_simulator dan fungsi confidence_path dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait signal_simulator.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status confidence_path, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder signal_simulator lain yang relevan.
