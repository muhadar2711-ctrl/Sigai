# goal_management/accuracy_goal

## Purpose
Menetapkan aturan operasional untuk enterprise_plus goal_management untuk accuracy_goal dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul goal_management dan seluruh agent yang bergantung pada accuracy_goal.

## Definitions
- accuracy_goal: komponen utama yang mengatur enterprise_plus goal_management untuk accuracy_goal.
...
## Core rules
- accuracy_goal hanya mengurus enterprise_plus goal_management untuk accuracy_goal dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status accuracy_goal, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
