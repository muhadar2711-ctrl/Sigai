...
## Purpose
Menetapkan aturan operasional untuk performance dan fungsi equity_curve dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul performance dan seluruh agent yang bergantung pada equity_curve.

## Definitions
- equity_curve: komponen utama yang mengatur performance dan fungsi equity_curve.
...
## Core rules
- equity_curve hanya mengurus performance dan fungsi equity_curve dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status equity_curve, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
