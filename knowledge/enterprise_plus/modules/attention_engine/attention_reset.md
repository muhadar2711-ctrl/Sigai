# attention_engine/attention_reset

## Purpose
Menetapkan aturan operasional untuk enterprise_plus attention_engine untuk attention_reset dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul attention_engine dan seluruh agent yang bergantung pada attention_reset.

## Definitions
- attention_reset: komponen utama yang mengatur enterprise_plus attention_engine untuk attention_reset.
...
## Core rules
- attention_reset hanya mengurus enterprise_plus attention_engine untuk attention_reset dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status attention_reset, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
