...
## Purpose
Menetapkan aturan operasional untuk research dan fungsi robustness dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul research dan seluruh agent yang bergantung pada robustness.

## Definitions
- robustness: komponen utama yang mengatur research dan fungsi robustness.
...
## Core rules
- robustness hanya mengurus research dan fungsi robustness dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status robustness, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
