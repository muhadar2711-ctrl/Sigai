# market_microstructure/stop_runs

## Purpose
Menetapkan aturan operasional untuk enterprise_plus market_microstructure untuk stop_runs dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul market_microstructure dan seluruh agent yang bergantung pada stop_runs.

## Definitions
- stop_runs: komponen utama yang mengatur enterprise_plus market_microstructure untuk stop_runs.
...
## Core rules
- stop_runs hanya mengurus enterprise_plus market_microstructure untuk stop_runs dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status stop_runs, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
