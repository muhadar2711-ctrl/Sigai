# research/parameter_stability

## Purpose
Menetapkan aturan operasional untuk research dan fungsi parameter_stability dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul research dan seluruh agent yang bergantung pada parameter_stability.

## Definitions
- parameter_stability: komponen utama yang mengatur research dan fungsi parameter_stability.
...
## Core rules
- parameter_stability hanya mengurus research dan fungsi parameter_stability dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait research.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status parameter_stability, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder research lain yang relevan.
