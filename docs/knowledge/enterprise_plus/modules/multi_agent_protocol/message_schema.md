# multi_agent_protocol/message_schema

## Purpose
Menetapkan aturan operasional untuk enterprise_plus multi_agent_protocol untuk message_schema dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul multi_agent_protocol dan seluruh agent yang bergantung pada message_schema.

## Definitions
- message_schema: komponen utama yang mengatur enterprise_plus multi_agent_protocol untuk message_schema.
...
## Core rules
- message_schema hanya mengurus enterprise_plus multi_agent_protocol untuk message_schema dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status message_schema, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
