# execution/confirmation_rules

## Purpose
Menetapkan aturan operasional untuk execution dan fungsi confirmation_rules dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul execution dan seluruh agent yang bergantung pada confirmation_rules.

## Definitions
- confirmation_rules: komponen utama yang mengatur execution dan fungsi confirmation_rules.
...
## Core rules
- confirmation_rules hanya mengurus execution dan fungsi confirmation_rules dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status confirmation_rules, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
