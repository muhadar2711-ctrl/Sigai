# consensus_engine/weighted_vote

## Purpose
Menetapkan aturan operasional untuk consensus_engine dan fungsi weighted_vote dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul consensus_engine dan seluruh agent yang bergantung pada weighted_vote.

## Definitions
- weighted_vote: komponen utama yang mengatur consensus_engine dan fungsi weighted_vote.
...
## Core rules
- weighted_vote hanya mengurus consensus_engine dan fungsi weighted_vote dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status weighted_vote, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
