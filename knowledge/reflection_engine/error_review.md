# reflection_engine/error_review

## Purpose
Menetapkan aturan operasional untuk reflection_engine dan fungsi error_review dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul reflection_engine dan seluruh agent yang bergantung pada error_review.

## Definitions
- error_review: komponen utama yang mengatur reflection_engine dan fungsi error_review.
...
## Core rules
- error_review hanya mengurus reflection_engine dan fungsi error_review dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status error_review, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
