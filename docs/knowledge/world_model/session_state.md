# world_model/session_state

## Purpose
Menetapkan aturan operasional untuk world_model dan fungsi session_state dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul world_model dan seluruh agent yang bergantung pada session_state.

## Definitions
- session_state: komponen utama yang mengatur world_model dan fungsi session_state.
...
## Core rules
- session_state hanya mengurus world_model dan fungsi session_state dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status session_state, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
