# strategy/mean_reversion_model

## Purpose
Menetapkan aturan operasional untuk strategy dan fungsi mean_reversion_model dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul strategy dan seluruh agent yang bergantung pada mean_reversion_model.

## Definitions
- mean_reversion_model: komponen utama yang mengatur strategy dan fungsi mean_reversion_model.
...
## Core rules
- mean_reversion_model hanya mengurus strategy dan fungsi mean_reversion_model dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status mean_reversion_model, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
