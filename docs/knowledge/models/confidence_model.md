# models/confidence_model

## Purpose
Menetapkan aturan operasional untuk models dan fungsi confidence_model dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul models dan seluruh agent yang bergantung pada confidence_model.

## Definitions
- confidence_model: komponen utama yang mengatur models dan fungsi confidence_model.
...
## Core rules
- confidence_model hanya mengurus models dan fungsi confidence_model dan tidak boleh mengambil tanggung jawab modul lain.
