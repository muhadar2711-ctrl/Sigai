...
## Purpose
Menetapkan aturan operasional untuk agents dan fungsi router_agent dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul agents dan seluruh agent yang bergantung pada router_agent.

## Definitions
- router_agent: komponen utama yang mengatur agents dan fungsi router_agent.
...
## Core rules
- router_agent hanya mengurus agents dan fungsi router_agent dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status router_agent, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
