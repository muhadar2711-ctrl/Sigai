# probability_engine/likelihood

## Purpose
Menetapkan aturan operasional untuk probability_engine dan fungsi likelihood dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul probability_engine dan seluruh agent yang bergantung pada likelihood.

## Definitions
- likelihood: komponen utama yang mengatur probability_engine dan fungsi likelihood.
...
## Core rules
- likelihood hanya mengurus probability_engine dan fungsi likelihood dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status likelihood, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
