# market_microstructure/microstructure_risk

## Purpose
Menetapkan aturan operasional untuk enterprise_plus market_microstructure untuk microstructure_risk dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul market_microstructure dan seluruh agent yang bergantung pada microstructure_risk.

## Definitions
- microstructure_risk: komponen utama yang mengatur enterprise_plus market_microstructure untuk microstructure_risk.
...
## Core rules
- microstructure_risk hanya mengurus enterprise_plus market_microstructure untuk microstructure_risk dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait market_microstructure.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status microstructure_risk, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder market_microstructure lain yang relevan.
