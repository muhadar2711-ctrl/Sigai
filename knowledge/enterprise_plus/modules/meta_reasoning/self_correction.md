# meta_reasoning/self_correction

## Purpose
Menetapkan aturan operasional untuk enterprise_plus meta_reasoning untuk self_correction dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul meta_reasoning dan seluruh agent yang bergantung pada self_correction.

## Definitions
- self_correction: komponen utama yang mengatur enterprise_plus meta_reasoning untuk self_correction.
...
## Core rules
- self_correction hanya mengurus enterprise_plus meta_reasoning untuk self_correction dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status self_correction, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
