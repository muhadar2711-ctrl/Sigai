# self_monitoring/latency_watch

## Purpose
Menetapkan aturan operasional untuk enterprise_plus self_monitoring untuk latency_watch dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul self_monitoring dan seluruh agent yang bergantung pada latency_watch.

## Definitions
- latency_watch: komponen utama yang mengatur enterprise_plus self_monitoring untuk latency_watch.
...
## Core rules
- latency_watch hanya mengurus enterprise_plus self_monitoring untuk latency_watch dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status latency_watch, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
