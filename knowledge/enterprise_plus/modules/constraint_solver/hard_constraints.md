# constraint_solver/hard_constraints

## Purpose
Menetapkan aturan operasional untuk enterprise_plus constraint_solver untuk hard_constraints dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul constraint_solver dan seluruh agent yang bergantung pada hard_constraints.

## Definitions
- hard_constraints: komponen utama yang mengatur enterprise_plus constraint_solver untuk hard_constraints.
...
## Core rules
- hard_constraints hanya mengurus enterprise_plus constraint_solver untuk hard_constraints dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status hard_constraints, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
