...
## Purpose
Menetapkan aturan operasional untuk technical dan fungsi ema_model dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul technical dan seluruh agent yang bergantung pada ema_model.

## Definitions
- ema_model: komponen utama yang mengatur technical dan fungsi ema_model.
...
## Core rules
- ema_model hanya mengurus technical dan fungsi ema_model dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status ema_model, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
