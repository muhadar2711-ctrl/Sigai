# constraint_solver/trade_constraints

## Purpose
Menetapkan aturan operasional untuk enterprise_plus constraint_solver untuk trade_constraints dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul constraint_solver dan seluruh agent yang bergantung pada trade_constraints.

## Definitions
- trade_constraints: komponen utama yang mengatur enterprise_plus constraint_solver untuk trade_constraints.
...
## Core rules
- trade_constraints hanya mengurus enterprise_plus constraint_solver untuk trade_constraints dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status trade_constraints, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
