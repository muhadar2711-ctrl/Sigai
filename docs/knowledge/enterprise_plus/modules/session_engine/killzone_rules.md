# session_engine/killzone_rules

## Purpose
Menetapkan aturan operasional untuk enterprise_plus session_engine untuk killzone_rules dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul session_engine dan seluruh agent yang bergantung pada killzone_rules.

## Definitions
- killzone_rules: komponen utama yang mengatur enterprise_plus session_engine untuk killzone_rules.
...
## Core rules
- killzone_rules hanya mengurus enterprise_plus session_engine untuk killzone_rules dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status killzone_rules, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
