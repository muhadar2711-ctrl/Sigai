# inference_engine/decomposition_strategy

## Purpose
Menetapkan aturan operasional untuk enterprise_plus inference_engine untuk decomposition_strategy dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul inference_engine dan seluruh agent yang bergantung pada decomposition_strategy.

## Definitions
- decomposition_strategy: komponen utama yang mengatur enterprise_plus inference_engine untuk decomposition_strategy.
...
## Core rules
- decomposition_strategy hanya mengurus enterprise_plus inference_engine untuk decomposition_strategy dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait inference_engine.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status decomposition_strategy, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder inference_engine lain yang relevan.
