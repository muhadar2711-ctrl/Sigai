...
## Purpose
Menetapkan aturan operasional untuk filters dan fungsi spread_filter dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul filters dan seluruh agent yang bergantung pada spread_filter.

## Definitions
- spread_filter: komponen utama yang mengatur filters dan fungsi spread_filter.
...
## Core rules
- spread_filter hanya mengurus filters dan fungsi spread_filter dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status spread_filter, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
