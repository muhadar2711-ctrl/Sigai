# session_engine/session_volatility

## Purpose
Menetapkan aturan operasional untuk enterprise_plus session_engine untuk session_volatility dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul session_engine dan seluruh agent yang bergantung pada session_volatility.

## Definitions
- session_volatility: komponen utama yang mengatur enterprise_plus session_engine untuk session_volatility.
...
## Core rules
- session_volatility hanya mengurus enterprise_plus session_engine untuk session_volatility dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status session_volatility, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
