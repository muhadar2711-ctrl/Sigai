# coordinator_engine/routing

## Purpose
Menetapkan aturan operasional untuk coordinator_engine dan fungsi routing dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul coordinator_engine dan seluruh agent yang bergantung pada routing.

## Definitions
- routing: komponen utama yang mengatur coordinator_engine dan fungsi routing.
...
## Core rules
- routing hanya mengurus coordinator_engine dan fungsi routing dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status routing, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
