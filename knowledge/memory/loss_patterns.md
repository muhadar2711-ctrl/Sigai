...
## Purpose
Menetapkan aturan operasional untuk memory dan fungsi loss_patterns dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul memory dan seluruh agent yang bergantung pada loss_patterns.

## Definitions
- loss_patterns: komponen utama yang mengatur memory dan fungsi loss_patterns.
...
## Core rules
- loss_patterns hanya mengurus memory dan fungsi loss_patterns dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status loss_patterns, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
