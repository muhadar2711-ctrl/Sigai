# governance_systems/role_boundaries

## Purpose
Menetapkan aturan operasional untuk enterprise_plus governance_systems untuk role_boundaries dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul governance_systems dan seluruh agent yang bergantung pada role_boundaries.

## Definitions
- role_boundaries: komponen utama yang mengatur enterprise_plus governance_systems untuk role_boundaries.
...
## Core rules
- role_boundaries hanya mengurus enterprise_plus governance_systems untuk role_boundaries dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status role_boundaries, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
