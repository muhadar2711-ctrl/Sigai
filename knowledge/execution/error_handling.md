...
## Purpose
Menetapkan aturan operasional untuk execution dan fungsi error_handling dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul execution dan seluruh agent yang bergantung pada error_handling.

## Definitions
- error_handling: komponen utama yang mengatur execution dan fungsi error_handling.
...
## Core rules
- error_handling hanya mengurus execution dan fungsi error_handling dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status error_handling, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
