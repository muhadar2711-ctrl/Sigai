# policy_engine/recovery_policy

## Purpose
Menetapkan aturan operasional untuk enterprise_plus policy_engine untuk recovery_policy dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul policy_engine dan seluruh agent yang bergantung pada recovery_policy.

## Definitions
- recovery_policy: komponen utama yang mengatur enterprise_plus policy_engine untuk recovery_policy.
...
## Core rules
- recovery_policy hanya mengurus enterprise_plus policy_engine untuk recovery_policy dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status recovery_policy, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
