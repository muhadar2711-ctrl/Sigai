# policy_engine/validation_policy

## Purpose
Menetapkan aturan operasional untuk enterprise_plus policy_engine untuk validation_policy dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul policy_engine dan seluruh agent yang bergantung pada validation_policy.

## Definitions
- validation_policy: komponen utama yang mengatur enterprise_plus policy_engine untuk validation_policy.
...
## Core rules
- validation_policy hanya mengurus enterprise_plus policy_engine untuk validation_policy dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status validation_policy, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
