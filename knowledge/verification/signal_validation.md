# verification/signal_validation

## Purpose
Menetapkan aturan operasional untuk verification dan fungsi signal_validation dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul verification dan seluruh agent yang bergantung pada signal_validation.

## Definitions
- signal_validation: komponen utama yang mengatur verification dan fungsi signal_validation.
...
## Core rules
- signal_validation hanya mengurus verification dan fungsi signal_validation dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status signal_validation, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
