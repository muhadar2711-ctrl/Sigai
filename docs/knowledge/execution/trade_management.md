...
## Purpose
Menetapkan aturan operasional untuk execution dan fungsi trade_management dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul execution dan seluruh agent yang bergantung pada trade_management.

## Definitions
- trade_management: komponen utama yang mengatur execution dan fungsi trade_management.
...
## Core rules
- trade_management hanya mengurus execution dan fungsi trade_management dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status trade_management, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
