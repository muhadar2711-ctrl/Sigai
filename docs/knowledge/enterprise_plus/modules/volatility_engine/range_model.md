# volatility_engine/range_model

## Purpose
Menetapkan aturan operasional untuk enterprise_plus volatility_engine untuk range_model dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul volatility_engine dan seluruh agent yang bergantung pada range_model.

## Definitions
- range_model: komponen utama yang mengatur enterprise_plus volatility_engine untuk range_model.
...
## Core rules
- range_model hanya mengurus enterprise_plus volatility_engine untuk range_model dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status range_model, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
