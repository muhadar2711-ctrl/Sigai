# probabilistic_simulation/bootstrap

## Purpose
Menetapkan aturan operasional untuk enterprise_plus probabilistic_simulation untuk bootstrap dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul probabilistic_simulation dan seluruh agent yang bergantung pada bootstrap.

## Definitions
- bootstrap: komponen utama yang mengatur enterprise_plus probabilistic_simulation untuk bootstrap.
...
## Core rules
- bootstrap hanya mengurus enterprise_plus probabilistic_simulation untuk bootstrap dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status bootstrap, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
