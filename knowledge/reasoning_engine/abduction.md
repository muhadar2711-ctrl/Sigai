# reasoning_engine/abduction

## Purpose
Menetapkan aturan operasional untuk reasoning_engine dan fungsi abduction dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul reasoning_engine dan seluruh agent yang bergantung pada abduction.

## Definitions
- abduction: komponen utama yang mengatur reasoning_engine dan fungsi abduction.
...
## Core rules
- abduction hanya mengurus reasoning_engine dan fungsi abduction dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status abduction, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
