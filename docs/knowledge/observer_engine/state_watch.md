# observer_engine/state_watch

## Purpose
Menetapkan aturan operasional untuk observer_engine dan fungsi state_watch dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul observer_engine dan seluruh agent yang bergantung pada state_watch.

## Definitions
- state_watch: komponen utama yang mengatur observer_engine dan fungsi state_watch.
...
## Core rules
- state_watch hanya mengurus observer_engine dan fungsi state_watch dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status state_watch, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
