# belief_system/epistemic_limits

## Purpose
Menetapkan aturan operasional untuk belief_system dan fungsi epistemic_limits dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul belief_system dan seluruh agent yang bergantung pada epistemic_limits.

## Definitions
- epistemic_limits: komponen utama yang mengatur belief_system dan fungsi epistemic_limits.
...
## Core rules
- epistemic_limits hanya mengurus belief_system dan fungsi epistemic_limits dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status epistemic_limits, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
