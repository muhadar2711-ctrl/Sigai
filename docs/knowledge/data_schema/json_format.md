# data_schema/json_format

## Purpose
Menetapkan aturan operasional untuk data_schema dan fungsi json_format dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul data_schema dan seluruh agent yang bergantung pada json_format.

## Definitions
- json_format: komponen utama yang mengatur data_schema dan fungsi json_format.
...
## Core rules
- json_format hanya mengurus data_schema dan fungsi json_format dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status json_format, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
