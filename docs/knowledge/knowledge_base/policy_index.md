# knowledge_base/policy_index

## Purpose
Menetapkan aturan operasional untuk knowledge_base dan fungsi policy_index dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul knowledge_base dan seluruh agent yang bergantung pada policy_index.

## Definitions
- policy_index: komponen utama yang mengatur knowledge_base dan fungsi policy_index.
...
## Core rules
- policy_index hanya mengurus knowledge_base dan fungsi policy_index dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status policy_index, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
