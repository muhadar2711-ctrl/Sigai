# constraint_solver/soft_constraints

## Purpose
Menetapkan aturan operasional untuk enterprise_plus constraint_solver untuk soft_constraints dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul constraint_solver dan seluruh agent yang bergantung pada soft_constraints.

## Definitions
- soft_constraints: komponen utama yang mengatur enterprise_plus constraint_solver untuk soft_constraints.
...
## Core rules
- soft_constraints hanya mengurus enterprise_plus constraint_solver untuk soft_constraints dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status soft_constraints, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
