# models/market_regime_model

## Purpose
Menetapkan aturan operasional untuk models dan fungsi market_regime_model dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul models dan seluruh agent yang bergantung pada market_regime_model.

## Definitions
- market_regime_model: komponen utama yang mengatur models dan fungsi market_regime_model.
...
## Core rules
- market_regime_model hanya mengurus models dan fungsi market_regime_model dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait models.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status market_regime_model, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder models lain yang relevan.
