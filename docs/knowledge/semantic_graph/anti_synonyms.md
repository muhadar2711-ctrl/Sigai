# semantic_graph/anti_synonyms

## Purpose
Menetapkan aturan operasional untuk semantic_graph dan fungsi anti_synonyms dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul semantic_graph dan seluruh agent yang bergantung pada anti_synonyms.

## Definitions
- anti_synonyms: komponen utama yang mengatur semantic_graph dan fungsi anti_synonyms.
...
## Core rules
- anti_synonyms hanya mengurus semantic_graph dan fungsi anti_synonyms dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status anti_synonyms, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
