# causal_engine/cause_effect

## Purpose
Menetapkan aturan operasional untuk causal_engine dan fungsi cause_effect dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul causal_engine dan seluruh agent yang bergantung pada cause_effect.

## Definitions
- cause_effect: komponen utama yang mengatur causal_engine dan fungsi cause_effect.
...
## Core rules
- cause_effect hanya mengurus causal_engine dan fungsi cause_effect dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status cause_effect, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
