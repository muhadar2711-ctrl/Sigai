...
## Purpose
Menetapkan aturan operasional untuk performance dan fungsi kpi dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul performance dan seluruh agent yang bergantung pada kpi.

## Definitions
- kpi: komponen utama yang mengatur performance dan fungsi kpi.
...
## Core rules
- kpi hanya mengurus performance dan fungsi kpi dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status kpi, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
