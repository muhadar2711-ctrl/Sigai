...
## Purpose
Menetapkan aturan operasional untuk strategy dan fungsi price_action dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul strategy dan seluruh agent yang bergantung pada price_action.

## Definitions
- price_action: komponen utama yang mengatur strategy dan fungsi price_action.
...
## Core rules
- price_action hanya mengurus strategy dan fungsi price_action dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status price_action, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
