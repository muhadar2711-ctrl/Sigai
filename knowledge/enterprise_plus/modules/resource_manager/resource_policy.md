# resource_manager/resource_policy

## Purpose
Menetapkan aturan operasional untuk enterprise_plus resource_manager untuk resource_policy dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul resource_manager dan seluruh agent yang bergantung pada resource_policy.

## Definitions
- resource_policy: komponen utama yang mengatur enterprise_plus resource_manager untuk resource_policy.
...
## Core rules
- resource_policy hanya mengurus enterprise_plus resource_manager untuk resource_policy dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status resource_policy, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
