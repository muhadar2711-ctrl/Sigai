# graph_index/index_building

## Purpose
Menetapkan aturan operasional untuk graph_index dan fungsi index_building dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul graph_index dan seluruh agent yang bergantung pada index_building.

## Definitions
- index_building: komponen utama yang mengatur graph_index dan fungsi index_building.
...
## Core rules
- index_building hanya mengurus graph_index dan fungsi index_building dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status index_building, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
