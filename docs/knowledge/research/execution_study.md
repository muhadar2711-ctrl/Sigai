# research/execution_study

## Purpose
Menetapkan aturan operasional untuk research dan fungsi execution_study dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul research dan seluruh agent yang bergantung pada execution_study.

## Definitions
- execution_study: komponen utama yang mengatur research dan fungsi execution_study.
...
## Core rules
- execution_study hanya mengurus research dan fungsi execution_study dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status execution_study, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
