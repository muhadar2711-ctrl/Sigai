...
## Purpose
Menetapkan aturan operasional untuk technical dan fungsi liquidity dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul technical dan seluruh agent yang bergantung pada liquidity.

## Definitions
- liquidity: komponen utama yang mengatur technical dan fungsi liquidity.
...
## Core rules
- liquidity hanya mengurus technical dan fungsi liquidity dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status liquidity, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
