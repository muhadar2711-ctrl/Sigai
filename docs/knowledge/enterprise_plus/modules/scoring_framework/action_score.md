# scoring_framework/action_score

## Purpose
Menetapkan aturan operasional untuk enterprise_plus scoring_framework untuk action_score dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul scoring_framework dan seluruh agent yang bergantung pada action_score.

## Definitions
- action_score: komponen utama yang mengatur enterprise_plus scoring_framework untuk action_score.
...
## Core rules
- action_score hanya mengurus enterprise_plus scoring_framework untuk action_score dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status action_score, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
