# research/volatility_study

## Purpose
Menetapkan aturan operasional untuk research dan fungsi volatility_study dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul research dan seluruh agent yang bergantung pada volatility_study.

## Definitions
- volatility_study: komponen utama yang mengatur research dan fungsi volatility_study.
...
## Core rules
- volatility_study hanya mengurus research dan fungsi volatility_study dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status volatility_study, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
