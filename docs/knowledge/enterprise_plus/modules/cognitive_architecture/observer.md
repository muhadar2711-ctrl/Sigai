# cognitive_architecture/observer

## Purpose
Menetapkan aturan operasional untuk enterprise_plus cognitive_architecture untuk observer dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul cognitive_architecture dan seluruh agent yang bergantung pada observer.

## Definitions
- observer: komponen utama yang mengatur enterprise_plus cognitive_architecture untuk observer.
...
## Core rules
- observer hanya mengurus enterprise_plus cognitive_architecture untuk observer dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status observer, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
