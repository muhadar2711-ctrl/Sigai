# evaluation_engine/scorecard

## Purpose
Menetapkan aturan operasional untuk evaluation_engine dan fungsi scorecard dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul evaluation_engine dan seluruh agent yang bergantung pada scorecard.

## Definitions
- scorecard: komponen utama yang mengatur evaluation_engine dan fungsi scorecard.
...
## Core rules
- scorecard hanya mengurus evaluation_engine dan fungsi scorecard dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status scorecard, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
