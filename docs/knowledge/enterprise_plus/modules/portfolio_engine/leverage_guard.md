# portfolio_engine/leverage_guard

## Purpose
Menetapkan aturan operasional untuk enterprise_plus portfolio_engine untuk leverage_guard dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul portfolio_engine dan seluruh agent yang bergantung pada leverage_guard.

## Definitions
- leverage_guard: komponen utama yang mengatur enterprise_plus portfolio_engine untuk leverage_guard.
...
## Core rules
- leverage_guard hanya mengurus enterprise_plus portfolio_engine untuk leverage_guard dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status leverage_guard, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
