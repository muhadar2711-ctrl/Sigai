# scoring_framework/novelty_score

## Purpose
Menetapkan aturan operasional untuk enterprise_plus scoring_framework untuk novelty_score dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul scoring_framework dan seluruh agent yang bergantung pada novelty_score.

## Definitions
- novelty_score: komponen utama yang mengatur enterprise_plus scoring_framework untuk novelty_score.
...
## Core rules
- novelty_score hanya mengurus enterprise_plus scoring_framework untuk novelty_score dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status novelty_score, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
