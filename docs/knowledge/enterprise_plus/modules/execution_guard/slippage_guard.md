# execution_guard/slippage_guard

## Purpose
Menetapkan aturan operasional untuk enterprise_plus execution_guard untuk slippage_guard dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul execution_guard dan seluruh agent yang bergantung pada slippage_guard.

## Definitions
- slippage_guard: komponen utama yang mengatur enterprise_plus execution_guard untuk slippage_guard.
...
## Core rules
- slippage_guard hanya mengurus enterprise_plus execution_guard untuk slippage_guard dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status slippage_guard, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
