# constraint_solver/context_constraints

## Purpose
Menetapkan aturan operasional untuk enterprise_plus constraint_solver untuk context_constraints dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul constraint_solver dan seluruh agent yang bergantung pada context_constraints.

## Definitions
- context_constraints: komponen utama yang mengatur enterprise_plus constraint_solver untuk context_constraints.
...
## Core rules
- context_constraints hanya mengurus enterprise_plus constraint_solver untuk context_constraints dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status context_constraints, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
