# context_engine/session_context

## Purpose
Menetapkan aturan operasional untuk context_engine dan fungsi session_context dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul context_engine dan seluruh agent yang bergantung pada session_context.

## Definitions
- session_context: komponen utama yang mengatur context_engine dan fungsi session_context.
...
## Core rules
- session_context hanya mengurus context_engine dan fungsi session_context dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status session_context, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
