# signal_simulator/invalidations

## Purpose
Menetapkan aturan operasional untuk signal_simulator dan fungsi invalidations dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul signal_simulator dan seluruh agent yang bergantung pada invalidations.

## Definitions
- invalidations: komponen utama yang mengatur signal_simulator dan fungsi invalidations.
...
## Core rules
- invalidations hanya mengurus signal_simulator dan fungsi invalidations dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status invalidations, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
