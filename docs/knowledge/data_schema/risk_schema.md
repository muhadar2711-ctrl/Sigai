# data_schema/risk_schema

## Purpose
Menetapkan aturan operasional untuk data_schema dan fungsi risk_schema dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul data_schema dan seluruh agent yang bergantung pada risk_schema.

## Definitions
- risk_schema: komponen utama yang mengatur data_schema dan fungsi risk_schema.
...
## Core rules
- risk_schema hanya mengurus data_schema dan fungsi risk_schema dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status risk_schema, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
