# fundamental/retail_sales

## Purpose
Menetapkan aturan operasional untuk fundamental dan fungsi retail_sales dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul fundamental dan seluruh agent yang bergantung pada retail_sales.

## Definitions
- retail_sales: komponen utama yang mengatur fundamental dan fungsi retail_sales.
...
## Core rules
- retail_sales hanya mengurus fundamental dan fungsi retail_sales dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status retail_sales, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
