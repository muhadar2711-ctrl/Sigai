...
## Purpose
Menetapkan aturan operasional untuk models dan fungsi range_model dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul models dan seluruh agent yang bergantung pada range_model.

## Definitions
- range_model: komponen utama yang mengatur models dan fungsi range_model.
...
## Core rules
- range_model hanya mengurus models dan fungsi range_model dan tidak boleh mengambil tanggung jawab modul lain.
