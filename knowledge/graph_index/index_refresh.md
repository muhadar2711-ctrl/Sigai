# graph_index/index_refresh

## Purpose
Menetapkan aturan operasional untuk graph_index dan fungsi index_refresh dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul graph_index dan seluruh agent yang bergantung pada index_refresh.

## Definitions
- index_refresh: komponen utama yang mengatur graph_index dan fungsi index_refresh.
...
## Core rules
- index_refresh hanya mengurus graph_index dan fungsi index_refresh dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status index_refresh, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
