# semantic_graph/taxonomy

## Purpose
Menetapkan aturan operasional untuk semantic_graph dan fungsi taxonomy dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul semantic_graph dan seluruh agent yang bergantung pada taxonomy.

## Definitions
- taxonomy: komponen utama yang mengatur semantic_graph dan fungsi taxonomy.
...
## Core rules
- taxonomy hanya mengurus semantic_graph dan fungsi taxonomy dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status taxonomy, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
