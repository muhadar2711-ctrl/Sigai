# execution/spread_filter

## Purpose
Menetapkan aturan operasional untuk execution dan fungsi spread_filter dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul execution dan seluruh agent yang bergantung pada spread_filter.

## Definitions
- spread_filter: komponen utama yang mengatur execution dan fungsi spread_filter.
...
## Core rules
- spread_filter hanya mengurus execution dan fungsi spread_filter dan tidak boleh mengambil tanggung jawab modul lain.
