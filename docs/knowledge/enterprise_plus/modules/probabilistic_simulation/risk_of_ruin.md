# probabilistic_simulation/risk_of_ruin

## Purpose
Menetapkan aturan operasional untuk enterprise_plus probabilistic_simulation untuk risk_of_ruin dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul probabilistic_simulation dan seluruh agent yang bergantung pada risk_of_ruin.

## Definitions
- risk_of_ruin: komponen utama yang mengatur enterprise_plus probabilistic_simulation untuk risk_of_ruin.
...
## Core rules
- risk_of_ruin hanya mengurus enterprise_plus probabilistic_simulation untuk risk_of_ruin dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status risk_of_ruin, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
