# intent_engine/intent_decay

## Purpose
Menetapkan aturan operasional untuk enterprise_plus intent_engine untuk intent_decay dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul intent_engine dan seluruh agent yang bergantung pada intent_decay.

## Definitions
- intent_decay: komponen utama yang mengatur enterprise_plus intent_engine untuk intent_decay.
...
## Core rules
- intent_decay hanya mengurus enterprise_plus intent_engine untuk intent_decay dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status intent_decay, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
