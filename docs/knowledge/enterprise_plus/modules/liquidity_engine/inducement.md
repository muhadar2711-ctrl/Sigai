# liquidity_engine/inducement

## Purpose
Menetapkan aturan operasional untuk enterprise_plus liquidity_engine untuk inducement dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul liquidity_engine dan seluruh agent yang bergantung pada inducement.

## Definitions
- inducement: komponen utama yang mengatur enterprise_plus liquidity_engine untuk inducement.
...
## Core rules
- inducement hanya mengurus enterprise_plus liquidity_engine untuk inducement dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status inducement, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
