# goal_management/no_trade_goal

## Purpose
Menetapkan aturan operasional untuk enterprise_plus goal_management untuk no_trade_goal dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul goal_management dan seluruh agent yang bergantung pada no_trade_goal.

## Definitions
- no_trade_goal: komponen utama yang mengatur enterprise_plus goal_management untuk no_trade_goal.
...
## Core rules
- no_trade_goal hanya mengurus enterprise_plus goal_management untuk no_trade_goal dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status no_trade_goal, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
