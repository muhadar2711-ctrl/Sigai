...
## Purpose
Menetapkan aturan operasional untuk memory dan fungsi market_regime dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul memory dan seluruh agent yang bergantung pada market_regime.

## Definitions
- market_regime: komponen utama yang mengatur memory dan fungsi market_regime.
...
## Core rules
- market_regime hanya mengurus memory dan fungsi market_regime dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status market_regime, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
