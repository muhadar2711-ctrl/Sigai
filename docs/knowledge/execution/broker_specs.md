# execution/broker_specs

## Purpose
Menetapkan aturan operasional untuk execution dan fungsi broker_specs dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul execution dan seluruh agent yang bergantung pada broker_specs.

## Definitions
- broker_specs: komponen utama yang mengatur execution dan fungsi broker_specs.
...
## Core rules
- broker_specs hanya mengurus execution dan fungsi broker_specs dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status broker_specs, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
