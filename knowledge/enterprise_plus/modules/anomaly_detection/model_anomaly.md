# anomaly_detection/model_anomaly

## Purpose
Menetapkan aturan operasional untuk enterprise_plus anomaly_detection untuk model_anomaly dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul anomaly_detection dan seluruh agent yang bergantung pada model_anomaly.

## Definitions
- model_anomaly: komponen utama yang mengatur enterprise_plus anomaly_detection untuk model_anomaly.
...
## Core rules
- model_anomaly hanya mengurus enterprise_plus anomaly_detection untuk model_anomaly dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status model_anomaly, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
