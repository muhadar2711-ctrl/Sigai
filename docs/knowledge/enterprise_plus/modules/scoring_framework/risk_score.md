# scoring_framework/risk_score

## Purpose
Menetapkan aturan operasional untuk enterprise_plus scoring_framework untuk risk_score dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul scoring_framework dan seluruh agent yang bergantung pada risk_score.

## Definitions
- risk_score: komponen utama yang mengatur enterprise_plus scoring_framework untuk risk_score.
...
## Core rules
- risk_score hanya mengurus enterprise_plus scoring_framework untuk risk_score dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status risk_score, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
