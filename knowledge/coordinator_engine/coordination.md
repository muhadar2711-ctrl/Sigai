# coordinator_engine/coordination

## Purpose
Menetapkan aturan operasional untuk coordinator_engine dan fungsi coordination dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul coordinator_engine dan seluruh agent yang bergantung pada coordination.

## Definitions
- coordination: komponen utama yang mengatur coordinator_engine dan fungsi coordination.
...
## Core rules
- coordination hanya mengurus coordinator_engine dan fungsi coordination dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status coordination, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
