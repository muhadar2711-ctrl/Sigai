# state_machine/state_definitions

## Purpose
Menetapkan aturan operasional untuk enterprise_plus state_machine untuk state_definitions dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul state_machine dan seluruh agent yang bergantung pada state_definitions.

## Definitions
- state_definitions: komponen utama yang mengatur enterprise_plus state_machine untuk state_definitions.
...
## Core rules
- state_definitions hanya mengurus enterprise_plus state_machine untuk state_definitions dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait state_machine.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status state_definitions, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder state_machine lain yang relevan.
