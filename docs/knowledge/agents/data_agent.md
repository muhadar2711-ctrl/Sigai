...
## Purpose
Menetapkan aturan operasional untuk agents dan fungsi data_agent dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul agents dan seluruh agent yang bergantung pada data_agent.

## Definitions
- data_agent: komponen utama yang mengatur agents dan fungsi data_agent.
...
## Core rules
- data_agent hanya mengurus agents dan fungsi data_agent dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status data_agent, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
