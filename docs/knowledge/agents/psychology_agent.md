# agents/psychology_agent

## Purpose
Menetapkan aturan operasional untuk agents dan fungsi psychology_agent dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul agents dan seluruh agent yang bergantung pada psychology_agent.

## Definitions
- psychology_agent: komponen utama yang mengatur agents dan fungsi psychology_agent.
...
## Core rules
- psychology_agent hanya mengurus agents dan fungsi psychology_agent dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status psychology_agent, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
