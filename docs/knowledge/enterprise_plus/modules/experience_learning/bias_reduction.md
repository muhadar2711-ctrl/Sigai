# experience_learning/bias_reduction

## Purpose
Menetapkan aturan operasional untuk enterprise_plus experience_learning untuk bias_reduction dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul experience_learning dan seluruh agent yang bergantung pada bias_reduction.

## Definitions
- bias_reduction: komponen utama yang mengatur enterprise_plus experience_learning untuk bias_reduction.
...
## Core rules
- bias_reduction hanya mengurus enterprise_plus experience_learning untuk bias_reduction dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status bias_reduction, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
