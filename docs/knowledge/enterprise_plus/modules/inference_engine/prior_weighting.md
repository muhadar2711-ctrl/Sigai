# inference_engine/prior_weighting

## Purpose
Menetapkan aturan operasional untuk enterprise_plus inference_engine untuk prior_weighting dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul inference_engine dan seluruh agent yang bergantung pada prior_weighting.

## Definitions
- prior_weighting: komponen utama yang mengatur enterprise_plus inference_engine untuk prior_weighting.
...
## Core rules
- prior_weighting hanya mengurus enterprise_plus inference_engine untuk prior_weighting dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status prior_weighting, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
