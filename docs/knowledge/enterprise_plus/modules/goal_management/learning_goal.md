# goal_management/learning_goal

## Purpose
Menetapkan aturan operasional untuk enterprise_plus goal_management untuk learning_goal dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul goal_management dan seluruh agent yang bergantung pada learning_goal.

## Definitions
- learning_goal: komponen utama yang mengatur enterprise_plus goal_management untuk learning_goal.
...
## Core rules
- learning_goal hanya mengurus enterprise_plus goal_management untuk learning_goal dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status learning_goal, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
