...
## Purpose
Menetapkan aturan operasional untuk fundamental dan fungsi unemployment dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul fundamental dan seluruh agent yang bergantung pada unemployment.

## Definitions
- unemployment: komponen utama yang mengatur fundamental dan fungsi unemployment.
...
## Core rules
- unemployment hanya mengurus fundamental dan fungsi unemployment dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status unemployment, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
