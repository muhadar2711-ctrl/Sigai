# state_engine/state_transition

## Purpose
Menetapkan aturan operasional untuk state_engine dan fungsi state_transition dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul state_engine dan seluruh agent yang bergantung pada state_transition.

## Definitions
- state_transition: komponen utama yang mengatur state_engine dan fungsi state_transition.
...
## Core rules
- state_transition hanya mengurus state_engine dan fungsi state_transition dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait state_engine.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status state_transition, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder state_engine lain yang relevan.
