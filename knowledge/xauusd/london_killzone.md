# xauusd/london_killzone

## Purpose
Menetapkan aturan operasional untuk xauusd dan fungsi london_killzone dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul xauusd dan seluruh agent yang bergantung pada london_killzone.

## Definitions
- london_killzone: komponen utama yang mengatur xauusd dan fungsi london_killzone.
...
## Core rules
- london_killzone hanya mengurus xauusd dan fungsi london_killzone dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status london_killzone, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
