# memory_graph/refresh

## Purpose
Menetapkan aturan operasional untuk memory_graph dan fungsi refresh dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul memory_graph dan seluruh agent yang bergantung pada refresh.

## Definitions
- refresh: komponen utama yang mengatur memory_graph dan fungsi refresh.
...
## Core rules
- refresh hanya mengurus memory_graph dan fungsi refresh dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status refresh, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
