# scoring_framework/priority_score

## Purpose
Menetapkan aturan operasional untuk enterprise_plus scoring_framework untuk priority_score dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul scoring_framework dan seluruh agent yang bergantung pada priority_score.

## Definitions
- priority_score: komponen utama yang mengatur enterprise_plus scoring_framework untuk priority_score.
...
## Core rules
- priority_score hanya mengurus enterprise_plus scoring_framework untuk priority_score dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status priority_score, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
