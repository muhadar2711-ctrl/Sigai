# self_monitoring/runtime_audit

## Purpose
Menetapkan aturan operasional untuk enterprise_plus self_monitoring untuk runtime_audit dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul self_monitoring dan seluruh agent yang bergantung pada runtime_audit.

## Definitions
- runtime_audit: komponen utama yang mengatur enterprise_plus self_monitoring untuk runtime_audit.
...
## Core rules
- runtime_audit hanya mengurus enterprise_plus self_monitoring untuk runtime_audit dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status runtime_audit, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
