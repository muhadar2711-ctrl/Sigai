# multi_agent_protocol/consensus_policy

## Purpose
Menetapkan aturan operasional untuk enterprise_plus multi_agent_protocol untuk consensus_policy dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul multi_agent_protocol dan seluruh agent yang bergantung pada consensus_policy.

## Definitions
- consensus_policy: komponen utama yang mengatur enterprise_plus multi_agent_protocol untuk consensus_policy.
...
## Core rules
- consensus_policy hanya mengurus enterprise_plus multi_agent_protocol untuk consensus_policy dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status consensus_policy, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
