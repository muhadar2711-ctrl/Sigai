# market_microstructure/iceberg_detection

## Purpose
Menetapkan aturan operasional untuk enterprise_plus market_microstructure untuk iceberg_detection dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul market_microstructure dan seluruh agent yang bergantung pada iceberg_detection.

## Definitions
- iceberg_detection: komponen utama yang mengatur enterprise_plus market_microstructure untuk iceberg_detection.
...
## Core rules
- iceberg_detection hanya mengurus enterprise_plus market_microstructure untuk iceberg_detection dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status iceberg_detection, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
