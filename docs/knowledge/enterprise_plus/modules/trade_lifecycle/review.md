# trade_lifecycle/review

## Purpose
Menetapkan aturan operasional untuk enterprise_plus trade_lifecycle untuk review dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul trade_lifecycle dan seluruh agent yang bergantung pada review.

## Definitions
- review: komponen utama yang mengatur enterprise_plus trade_lifecycle untuk review.
...
## Core rules
- review hanya mengurus enterprise_plus trade_lifecycle untuk review dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status review, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
