# probabilistic_simulation/tail_events

## Purpose
Menetapkan aturan operasional untuk enterprise_plus probabilistic_simulation untuk tail_events dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul probabilistic_simulation dan seluruh agent yang bergantung pada tail_events.

## Definitions
- tail_events: komponen utama yang mengatur enterprise_plus probabilistic_simulation untuk tail_events.
...
## Core rules
- tail_events hanya mengurus enterprise_plus probabilistic_simulation untuk tail_events dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status tail_events, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
