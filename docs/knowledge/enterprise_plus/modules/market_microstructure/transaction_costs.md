# market_microstructure/transaction_costs

## Purpose
Menetapkan aturan operasional untuk enterprise_plus market_microstructure untuk transaction_costs dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul market_microstructure dan seluruh agent yang bergantung pada transaction_costs.

## Definitions
- transaction_costs: komponen utama yang mengatur enterprise_plus market_microstructure untuk transaction_costs.
...
## Core rules
- transaction_costs hanya mengurus enterprise_plus market_microstructure untuk transaction_costs dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status transaction_costs, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
