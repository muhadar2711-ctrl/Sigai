# probability_engine/uncertainty_weight

## Purpose
Menetapkan aturan operasional untuk probability_engine dan fungsi uncertainty_weight dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul probability_engine dan seluruh agent yang bergantung pada uncertainty_weight.

## Definitions
- uncertainty_weight: komponen utama yang mengatur probability_engine dan fungsi uncertainty_weight.
...
## Core rules
- uncertainty_weight hanya mengurus probability_engine dan fungsi uncertainty_weight dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait probability_engine.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status uncertainty_weight, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder probability_engine lain yang relevan.
