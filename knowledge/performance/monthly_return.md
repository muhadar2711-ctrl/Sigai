...
## Purpose
Menetapkan aturan operasional untuk performance dan fungsi monthly_return dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul performance dan seluruh agent yang bergantung pada monthly_return.

## Definitions
- monthly_return: komponen utama yang mengatur performance dan fungsi monthly_return.
...
## Core rules
- monthly_return hanya mengurus performance dan fungsi monthly_return dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status monthly_return, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
