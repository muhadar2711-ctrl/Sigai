# memory/backtest_rules

## Purpose
Menetapkan aturan operasional untuk memory dan fungsi backtest_rules dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul memory dan seluruh agent yang bergantung pada backtest_rules.

## Definitions
- backtest_rules: komponen utama yang mengatur memory dan fungsi backtest_rules.
...
## Core rules
- backtest_rules hanya mengurus memory dan fungsi backtest_rules dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status backtest_rules, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
