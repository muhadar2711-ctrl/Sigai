...
## Purpose
Menetapkan aturan operasional untuk performance dan fungsi performance_review dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul performance dan seluruh agent yang bergantung pada performance_review.

## Definitions
- performance_review: komponen utama yang mengatur performance dan fungsi performance_review.
...
## Core rules
- performance_review hanya mengurus performance dan fungsi performance_review dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status performance_review, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
