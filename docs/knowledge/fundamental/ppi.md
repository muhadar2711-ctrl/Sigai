...
## Purpose
Menetapkan aturan operasional untuk fundamental dan fungsi ppi dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul fundamental dan seluruh agent yang bergantung pada ppi.

## Definitions
- ppi: komponen utama yang mengatur fundamental dan fungsi ppi.
...
## Core rules
- ppi hanya mengurus fundamental dan fungsi ppi dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status ppi, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
