...
## Purpose
Menetapkan aturan operasional untuk models dan fungsi volatility_model dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul models dan seluruh agent yang bergantung pada volatility_model.

## Definitions
- volatility_model: komponen utama yang mengatur models dan fungsi volatility_model.
...
## Core rules
- volatility_model hanya mengurus models dan fungsi volatility_model dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status volatility_model, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
