# liquidity_engine/liquidity_pooling

## Purpose
Menetapkan aturan operasional untuk enterprise_plus liquidity_engine untuk liquidity_pooling dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul liquidity_engine dan seluruh agent yang bergantung pada liquidity_pooling.

## Definitions
- liquidity_pooling: komponen utama yang mengatur enterprise_plus liquidity_engine untuk liquidity_pooling.
...
## Core rules
- liquidity_pooling hanya mengurus enterprise_plus liquidity_engine untuk liquidity_pooling dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait liquidity_engine.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status liquidity_pooling, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder liquidity_engine lain yang relevan.
