# confidence_engine/penalty_rules

## Purpose
Menetapkan aturan operasional untuk enterprise_plus confidence_engine untuk penalty_rules dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul confidence_engine dan seluruh agent yang bergantung pada penalty_rules.

## Definitions
- penalty_rules: komponen utama yang mengatur enterprise_plus confidence_engine untuk penalty_rules.
...
## Core rules
- penalty_rules hanya mengurus enterprise_plus confidence_engine untuk penalty_rules dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status penalty_rules, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
