...
## Purpose
Menetapkan aturan operasional untuk enterprise_plus portfolio_engine untuk portfolio_risk dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul portfolio_engine dan seluruh agent yang bergantung pada portfolio_risk.

## Definitions
- portfolio_risk: komponen utama yang mengatur enterprise_plus portfolio_engine untuk portfolio_risk.
...
## Core rules
- portfolio_risk hanya mengurus enterprise_plus portfolio_engine untuk portfolio_risk dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status portfolio_risk, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
