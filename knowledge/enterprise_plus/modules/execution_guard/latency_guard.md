# execution_guard/latency_guard

## Purpose
Menetapkan aturan operasional untuk enterprise_plus execution_guard untuk latency_guard dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul execution_guard dan seluruh agent yang bergantung pada latency_guard.

## Definitions
- latency_guard: komponen utama yang mengatur enterprise_plus execution_guard untuk latency_guard.
...
## Core rules
- latency_guard hanya mengurus enterprise_plus execution_guard untuk latency_guard dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status latency_guard, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
