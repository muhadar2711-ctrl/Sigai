# models/breakout_model

## Purpose
Menetapkan aturan operasional untuk models dan fungsi breakout_model dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul models dan seluruh agent yang bergantung pada breakout_model.

## Definitions
- breakout_model: komponen utama yang mengatur models dan fungsi breakout_model.
...
## Core rules
- breakout_model hanya mengurus models dan fungsi breakout_model dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status breakout_model, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
