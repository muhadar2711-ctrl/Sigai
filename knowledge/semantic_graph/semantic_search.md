# semantic_graph/semantic_search

## Purpose
Menetapkan aturan operasional untuk semantic_graph dan fungsi semantic_search dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul semantic_graph dan seluruh agent yang bergantung pada semantic_search.

## Definitions
- semantic_search: komponen utama yang mengatur semantic_graph dan fungsi semantic_search.
...
## Core rules
- semantic_search hanya mengurus semantic_graph dan fungsi semantic_search dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait semantic_graph.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status semantic_search, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder semantic_graph lain yang relevan.
