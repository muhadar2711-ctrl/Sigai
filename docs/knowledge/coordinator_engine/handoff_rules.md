# coordinator_engine/handoff_rules

## Purpose
Menetapkan aturan operasional untuk coordinator_engine dan fungsi handoff_rules dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul coordinator_engine dan seluruh agent yang bergantung pada handoff_rules.

## Definitions
- handoff_rules: komponen utama yang mengatur coordinator_engine dan fungsi handoff_rules.
...
## Core rules
- handoff_rules hanya mengurus coordinator_engine dan fungsi handoff_rules dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status handoff_rules, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
