# signal_engine/signal_generation

## Purpose
Menetapkan aturan operasional untuk signal_engine dan fungsi signal_generation dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul signal_engine dan seluruh agent yang bergantung pada signal_generation.

## Definitions
- signal_generation: komponen utama yang mengatur signal_engine dan fungsi signal_generation.
...
## Core rules
- signal_generation hanya mengurus signal_engine dan fungsi signal_generation dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait signal_engine.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status signal_generation, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder signal_engine lain yang relevan.
