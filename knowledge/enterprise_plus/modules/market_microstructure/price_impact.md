# market_microstructure/price_impact

## Purpose
Menetapkan aturan operasional untuk enterprise_plus market_microstructure untuk price_impact dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul market_microstructure dan seluruh agent yang bergantung pada price_impact.

## Definitions
- price_impact: komponen utama yang mengatur enterprise_plus market_microstructure untuk price_impact.
...
## Core rules
- price_impact hanya mengurus enterprise_plus market_microstructure untuk price_impact dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status price_impact, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
