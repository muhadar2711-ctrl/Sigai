# semantic_graph/concept_nodes

## Purpose
Menetapkan aturan operasional untuk semantic_graph dan fungsi concept_nodes dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul semantic_graph dan seluruh agent yang bergantung pada concept_nodes.

## Definitions
- concept_nodes: komponen utama yang mengatur semantic_graph dan fungsi concept_nodes.
...
## Core rules
- concept_nodes hanya mengurus semantic_graph dan fungsi concept_nodes dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status concept_nodes, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
