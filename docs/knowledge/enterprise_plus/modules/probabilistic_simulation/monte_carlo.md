# probabilistic_simulation/monte_carlo

## Purpose
Menetapkan aturan operasional untuk enterprise_plus probabilistic_simulation untuk monte_carlo dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul probabilistic_simulation dan seluruh agent yang bergantung pada monte_carlo.

## Definitions
- monte_carlo: komponen utama yang mengatur enterprise_plus probabilistic_simulation untuk monte_carlo.
...
## Core rules
- monte_carlo hanya mengurus enterprise_plus probabilistic_simulation untuk monte_carlo dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status monte_carlo, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
