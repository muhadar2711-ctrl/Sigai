# resource_manager/context_budget

## Purpose
Menetapkan aturan operasional untuk enterprise_plus resource_manager untuk context_budget dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul resource_manager dan seluruh agent yang bergantung pada context_budget.

## Definitions
- context_budget: komponen utama yang mengatur enterprise_plus resource_manager untuk context_budget.
...
## Core rules
- context_budget hanya mengurus enterprise_plus resource_manager untuk context_budget dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status context_budget, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
