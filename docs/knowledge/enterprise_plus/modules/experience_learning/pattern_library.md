# experience_learning/pattern_library

## Purpose
Menetapkan aturan operasional untuk enterprise_plus experience_learning untuk pattern_library dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul experience_learning dan seluruh agent yang bergantung pada pattern_library.

## Definitions
- pattern_library: komponen utama yang mengatur enterprise_plus experience_learning untuk pattern_library.
...
## Core rules
- pattern_library hanya mengurus enterprise_plus experience_learning untuk pattern_library dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status pattern_library, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
