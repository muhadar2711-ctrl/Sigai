# causal_engine/liquidity_cause

## Purpose
Menetapkan aturan operasional untuk causal_engine dan fungsi liquidity_cause dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul causal_engine dan seluruh agent yang bergantung pada liquidity_cause.

## Definitions
- liquidity_cause: komponen utama yang mengatur causal_engine dan fungsi liquidity_cause.
...
## Core rules
- liquidity_cause hanya mengurus causal_engine dan fungsi liquidity_cause dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status liquidity_cause, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
