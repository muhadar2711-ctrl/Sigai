...
## Purpose
Menetapkan aturan operasional untuk data_schema dan fungsi signal_schema dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul data_schema dan seluruh agent yang bergantung pada signal_schema.

## Definitions
- signal_schema: komponen utama yang mengatur data_schema dan fungsi signal_schema.
...
## Core rules
- signal_schema hanya mengurus data_schema dan fungsi signal_schema dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status signal_schema, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
