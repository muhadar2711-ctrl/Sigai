...
## Purpose
Menetapkan aturan operasional untuk state_engine dan fungsi state_health dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul state_engine dan seluruh agent yang bergantung pada state_health.

## Definitions
- state_health: komponen utama yang mengatur state_engine dan fungsi state_health.
...
## Core rules
- state_health hanya mengurus state_engine dan fungsi state_health dan tidak boleh mengambil tanggung jawab modul lain.
