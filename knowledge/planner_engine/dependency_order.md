# planner_engine/dependency_order

## Purpose
Menetapkan aturan operasional untuk planner_engine dan fungsi dependency_order dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul planner_engine dan seluruh agent yang bergantung pada dependency_order.

## Definitions
- dependency_order: komponen utama yang mengatur planner_engine dan fungsi dependency_order.
...
## Core rules
- dependency_order hanya mengurus planner_engine dan fungsi dependency_order dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status dependency_order, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
