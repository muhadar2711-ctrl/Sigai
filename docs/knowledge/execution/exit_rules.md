# execution/exit_rules

## Purpose
Menetapkan aturan operasional untuk execution dan fungsi exit_rules dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul execution dan seluruh agent yang bergantung pada exit_rules.

## Definitions
- exit_rules: komponen utama yang mengatur execution dan fungsi exit_rules.
...
## Core rules
- exit_rules hanya mengurus execution dan fungsi exit_rules dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status exit_rules, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
