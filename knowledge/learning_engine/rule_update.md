# learning_engine/rule_update

## Purpose
Menetapkan aturan operasional untuk learning_engine dan fungsi rule_update dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul learning_engine dan seluruh agent yang bergantung pada rule_update.

## Definitions
- rule_update: komponen utama yang mengatur learning_engine dan fungsi rule_update.
...
## Core rules
- rule_update hanya mengurus learning_engine dan fungsi rule_update dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status rule_update, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
