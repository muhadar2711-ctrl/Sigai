# capital_preservation/shutdown_rules

## Purpose
Menetapkan aturan operasional untuk enterprise_plus capital_preservation untuk shutdown_rules dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul capital_preservation dan seluruh agent yang bergantung pada shutdown_rules.

## Definitions
- shutdown_rules: komponen utama yang mengatur enterprise_plus capital_preservation untuk shutdown_rules.
...
## Core rules
- shutdown_rules hanya mengurus enterprise_plus capital_preservation untuk shutdown_rules dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status shutdown_rules, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
