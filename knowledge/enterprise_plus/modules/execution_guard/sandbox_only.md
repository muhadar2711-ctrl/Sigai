# execution_guard/sandbox_only

## Purpose
Menetapkan aturan operasional untuk enterprise_plus execution_guard untuk sandbox_only dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul execution_guard dan seluruh agent yang bergantung pada sandbox_only.

## Definitions
- sandbox_only: komponen utama yang mengatur enterprise_plus execution_guard untuk sandbox_only.
...
## Core rules
- sandbox_only hanya mengurus enterprise_plus execution_guard untuk sandbox_only dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status sandbox_only, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
