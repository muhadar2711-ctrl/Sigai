# execution_guard/trade_window_guard

## Purpose
Menetapkan aturan operasional untuk enterprise_plus execution_guard untuk trade_window_guard dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul execution_guard dan seluruh agent yang bergantung pada trade_window_guard.

## Definitions
- trade_window_guard: komponen utama yang mengatur enterprise_plus execution_guard untuk trade_window_guard.
...
## Core rules
- trade_window_guard hanya mengurus enterprise_plus execution_guard untuk trade_window_guard dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status trade_window_guard, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
