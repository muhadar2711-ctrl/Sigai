# memory/adaptive_learning

## Purpose
Menetapkan aturan operasional untuk memory dan fungsi adaptive_learning dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul memory dan seluruh agent yang bergantung pada adaptive_learning.

## Definitions
- adaptive_learning: komponen utama yang mengatur memory dan fungsi adaptive_learning.
...
## Core rules
- adaptive_learning hanya mengurus memory dan fungsi adaptive_learning dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status adaptive_learning, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
