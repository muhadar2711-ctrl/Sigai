# intent_engine/agent_intent

## Purpose
Menetapkan aturan operasional untuk enterprise_plus intent_engine untuk agent_intent dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul intent_engine dan seluruh agent yang bergantung pada agent_intent.

## Definitions
- agent_intent: komponen utama yang mengatur enterprise_plus intent_engine untuk agent_intent.
...
## Core rules
- agent_intent hanya mengurus enterprise_plus intent_engine untuk agent_intent dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status agent_intent, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
