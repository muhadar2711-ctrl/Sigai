...
## Purpose
Menetapkan aturan operasional untuk agents dan fungsi memory_agent dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul agents dan seluruh agent yang bergantung pada memory_agent.

## Definitions
- memory_agent: komponen utama yang mengatur agents dan fungsi memory_agent.
...
## Core rules
- memory_agent hanya mengurus agents dan fungsi memory_agent dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status memory_agent, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
