# trade_lifecycle/entry

## Purpose
Menetapkan aturan operasional untuk enterprise_plus trade_lifecycle untuk entry dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul trade_lifecycle dan seluruh agent yang bergantung pada entry.

## Definitions
- entry: komponen utama yang mengatur enterprise_plus trade_lifecycle untuk entry.
...
## Core rules
- entry hanya mengurus enterprise_plus trade_lifecycle untuk entry dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status entry, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
