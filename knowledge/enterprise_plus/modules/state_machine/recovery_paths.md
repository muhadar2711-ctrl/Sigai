# state_machine/recovery_paths

## Purpose
Menetapkan aturan operasional untuk enterprise_plus state_machine untuk recovery_paths dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul state_machine dan seluruh agent yang bergantung pada recovery_paths.

## Definitions
- recovery_paths: komponen utama yang mengatur enterprise_plus state_machine untuk recovery_paths.
...
## Core rules
- recovery_paths hanya mengurus enterprise_plus state_machine untuk recovery_paths dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status recovery_paths, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
