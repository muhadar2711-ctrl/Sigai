# fundamental/treasury_yield

## Purpose
Menetapkan aturan operasional untuk fundamental dan fungsi treasury_yield dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul fundamental dan seluruh agent yang bergantung pada treasury_yield.

## Definitions
- treasury_yield: komponen utama yang mengatur fundamental dan fungsi treasury_yield.
...
## Core rules
- treasury_yield hanya mengurus fundamental dan fungsi treasury_yield dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status treasury_yield, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
