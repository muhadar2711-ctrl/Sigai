# data_schema/validation_rules

## Purpose
Menetapkan aturan operasional untuk data_schema dan fungsi validation_rules dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul data_schema dan seluruh agent yang bergantung pada validation_rules.

## Definitions
- validation_rules: komponen utama yang mengatur data_schema dan fungsi validation_rules.
...
## Core rules
- validation_rules hanya mengurus data_schema dan fungsi validation_rules dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status validation_rules, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
