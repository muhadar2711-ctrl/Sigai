# anomaly_detection/latency_anomaly

## Purpose
Menetapkan aturan operasional untuk enterprise_plus anomaly_detection untuk latency_anomaly dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul anomaly_detection dan seluruh agent yang bergantung pada latency_anomaly.

## Definitions
- latency_anomaly: komponen utama yang mengatur enterprise_plus anomaly_detection untuk latency_anomaly.
...
## Core rules
- latency_anomaly hanya mengurus enterprise_plus anomaly_detection untuk latency_anomaly dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status latency_anomaly, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
