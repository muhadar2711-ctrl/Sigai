# cognitive_architecture/intent_engine

## Purpose
Menetapkan aturan operasional untuk enterprise_plus cognitive_architecture untuk intent_engine dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul cognitive_architecture dan seluruh agent yang bergantung pada intent_engine.

## Definitions
- intent_engine: komponen utama yang mengatur enterprise_plus cognitive_architecture untuk intent_engine.
...
## Core rules
- intent_engine hanya mengurus enterprise_plus cognitive_architecture untuk intent_engine dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status intent_engine, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
