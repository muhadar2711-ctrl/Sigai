# state_machine/checkpoint_rules

## Purpose
Menetapkan aturan operasional untuk enterprise_plus state_machine untuk checkpoint_rules dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul state_machine dan seluruh agent yang bergantung pada checkpoint_rules.

## Definitions
- checkpoint_rules: komponen utama yang mengatur enterprise_plus state_machine untuk checkpoint_rules.
...
## Core rules
- checkpoint_rules hanya mengurus enterprise_plus state_machine untuk checkpoint_rules dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status checkpoint_rules, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
