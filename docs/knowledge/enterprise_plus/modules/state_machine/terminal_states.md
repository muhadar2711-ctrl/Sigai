...
## Purpose
Menetapkan aturan operasional untuk enterprise_plus state_machine untuk terminal_states dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul state_machine dan seluruh agent yang bergantung pada terminal_states.

## Definitions
- terminal_states: komponen utama yang mengatur enterprise_plus state_machine untuk terminal_states.
...
## Core rules
- terminal_states hanya mengurus enterprise_plus state_machine untuk terminal_states dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status terminal_states, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
