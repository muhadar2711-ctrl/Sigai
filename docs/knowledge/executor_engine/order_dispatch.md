# executor_engine/order_dispatch

## Purpose
Menetapkan aturan operasional untuk executor_engine dan fungsi order_dispatch dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul executor_engine dan seluruh agent yang bergantung pada order_dispatch.

## Definitions
- order_dispatch: komponen utama yang mengatur executor_engine dan fungsi order_dispatch.
...
## Core rules
- order_dispatch hanya mengurus executor_engine dan fungsi order_dispatch dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status order_dispatch, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
