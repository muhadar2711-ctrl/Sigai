# attention_engine/signal_salience

## Purpose
Menetapkan aturan operasional untuk enterprise_plus attention_engine untuk signal_salience dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul attention_engine dan seluruh agent yang bergantung pada signal_salience.

## Definitions
- signal_salience: komponen utama yang mengatur enterprise_plus attention_engine untuk signal_salience.
...
## Core rules
- signal_salience hanya mengurus enterprise_plus attention_engine untuk signal_salience dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status signal_salience, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
