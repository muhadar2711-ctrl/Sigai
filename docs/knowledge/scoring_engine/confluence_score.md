# scoring_engine/confluence_score

## Purpose
Menetapkan aturan operasional untuk scoring_engine dan fungsi confluence_score dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul scoring_engine dan seluruh agent yang bergantung pada confluence_score.

## Definitions
- confluence_score: komponen utama yang mengatur scoring_engine dan fungsi confluence_score.
...
## Core rules
- confluence_score hanya mengurus scoring_engine dan fungsi confluence_score dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait scoring_engine.
...
## Interactions
- Berinteraksi dengan folder scoring_engine lain yang relevan.
