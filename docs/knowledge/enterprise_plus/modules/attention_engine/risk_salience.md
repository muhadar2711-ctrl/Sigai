# attention_engine/risk_salience

## Purpose
Menetapkan aturan operasional untuk enterprise_plus attention_engine untuk risk_salience dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul attention_engine dan seluruh agent yang bergantung pada risk_salience.

## Definitions
- risk_salience: komponen utama yang mengatur enterprise_plus attention_engine untuk risk_salience.
...
## Core rules
- risk_salience hanya mengurus enterprise_plus attention_engine untuk risk_salience dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status risk_salience, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
