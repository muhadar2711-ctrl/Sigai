# inference_engine/inference_budget

## Purpose
Menetapkan aturan operasional untuk enterprise_plus inference_engine untuk inference_budget dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul inference_engine dan seluruh agent yang bergantung pada inference_budget.

## Definitions
- inference_budget: komponen utama yang mengatur enterprise_plus inference_engine untuk inference_budget.
...
## Core rules
- inference_budget hanya mengurus enterprise_plus inference_engine untuk inference_budget dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status inference_budget, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
