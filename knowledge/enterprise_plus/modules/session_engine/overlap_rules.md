# session_engine/overlap_rules

## Purpose
Menetapkan aturan operasional untuk enterprise_plus session_engine untuk overlap_rules dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul session_engine dan seluruh agent yang bergantung pada overlap_rules.

## Definitions
- overlap_rules: komponen utama yang mengatur enterprise_plus session_engine untuk overlap_rules.
...
## Core rules
- overlap_rules hanya mengurus enterprise_plus session_engine untuk overlap_rules dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status overlap_rules, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
