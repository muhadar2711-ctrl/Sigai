# session_engine/newyork_session

## Purpose
Menetapkan aturan operasional untuk enterprise_plus session_engine untuk newyork_session dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul session_engine dan seluruh agent yang bergantung pada newyork_session.

## Definitions
- newyork_session: komponen utama yang mengatur enterprise_plus session_engine untuk newyork_session.
...
## Core rules
- newyork_session hanya mengurus enterprise_plus session_engine untuk newyork_session dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status newyork_session, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
