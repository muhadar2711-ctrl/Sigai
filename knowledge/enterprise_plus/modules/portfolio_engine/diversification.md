# portfolio_engine/diversification

## Purpose
Menetapkan aturan operasional untuk enterprise_plus portfolio_engine untuk diversification dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul portfolio_engine dan seluruh agent yang bergantung pada diversification.

## Definitions
- diversification: komponen utama yang mengatur enterprise_plus portfolio_engine untuk diversification.
...
## Core rules
- diversification hanya mengurus enterprise_plus portfolio_engine untuk diversification dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status diversification, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
