# session_engine/session_liquidity

## Purpose
Menetapkan aturan operasional untuk enterprise_plus session_engine untuk session_liquidity dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul session_engine dan seluruh agent yang bergantung pada session_liquidity.

## Definitions
- session_liquidity: komponen utama yang mengatur enterprise_plus session_engine untuk session_liquidity.
...
## Core rules
- session_liquidity hanya mengurus enterprise_plus session_engine untuk session_liquidity dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status session_liquidity, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
