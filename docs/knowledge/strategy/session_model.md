# strategy/session_model

## Purpose
Menetapkan aturan operasional untuk strategy dan fungsi session_model dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul strategy dan seluruh agent yang bergantung pada session_model.

## Definitions
- session_model: komponen utama yang mengatur strategy dan fungsi session_model.
...
## Core rules
- session_model hanya mengurus strategy dan fungsi session_model dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status session_model, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
