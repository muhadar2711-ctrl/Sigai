# technical/regime_detection

## Purpose
Menetapkan aturan operasional untuk technical dan fungsi regime_detection dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul technical dan seluruh agent yang bergantung pada regime_detection.

## Definitions
- regime_detection: komponen utama yang mengatur technical dan fungsi regime_detection.
...
## Core rules
- regime_detection hanya mengurus technical dan fungsi regime_detection dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status regime_detection, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
