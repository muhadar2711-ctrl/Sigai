# knowledge_base/citation_rules

## Purpose
Menetapkan aturan operasional untuk knowledge_base dan fungsi citation_rules dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul knowledge_base dan seluruh agent yang bergantung pada citation_rules.

## Definitions
- citation_rules: komponen utama yang mengatur knowledge_base dan fungsi citation_rules.
...
## Core rules
- citation_rules hanya mengurus knowledge_base dan fungsi citation_rules dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status citation_rules, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
