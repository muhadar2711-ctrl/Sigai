# meta_reasoning/uncertainty_awareness

## Purpose
Menetapkan aturan operasional untuk enterprise_plus meta_reasoning untuk uncertainty_awareness dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul meta_reasoning dan seluruh agent yang bergantung pada uncertainty_awareness.

## Definitions
- uncertainty_awareness: komponen utama yang mengatur enterprise_plus meta_reasoning untuk uncertainty_awareness.
...
## Core rules
- uncertainty_awareness hanya mengurus enterprise_plus meta_reasoning untuk uncertainty_awareness dan tidak boleh mengambil tanggung jawab modul lain.
...
- Evidence dari modul terkait meta_reasoning.
- Registry synthetic bila dipakai untuk latihan atau validation.

## Outputs
- Status uncertainty_awareness, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
...
## Interactions
- Berinteraksi dengan folder meta_reasoning lain yang relevan.
