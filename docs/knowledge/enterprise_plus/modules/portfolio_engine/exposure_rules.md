# portfolio_engine/exposure_rules

## Purpose
Menetapkan aturan operasional untuk enterprise_plus portfolio_engine untuk exposure_rules dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul portfolio_engine dan seluruh agent yang bergantung pada exposure_rules.

## Definitions
- exposure_rules: komponen utama yang mengatur enterprise_plus portfolio_engine untuk exposure_rules.
...
## Core rules
- exposure_rules hanya mengurus enterprise_plus portfolio_engine untuk exposure_rules dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status exposure_rules, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
