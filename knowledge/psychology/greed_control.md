# psychology/greed_control

## Purpose
Menetapkan aturan operasional untuk psychology dan fungsi greed_control dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul psychology dan seluruh agent yang bergantung pada greed_control.

## Definitions
- greed_control: komponen utama yang mengatur psychology dan fungsi greed_control.
...
## Core rules
- greed_control hanya mengurus psychology dan fungsi greed_control dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status greed_control, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
