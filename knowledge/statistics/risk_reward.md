# statistics/risk_reward

## Purpose
Menetapkan aturan operasional untuk statistics dan fungsi risk_reward dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul statistics dan seluruh agent yang bergantung pada risk_reward.

## Definitions
- risk_reward: komponen utama yang mengatur statistics dan fungsi risk_reward.
...
## Core rules
- risk_reward hanya mengurus statistics dan fungsi risk_reward dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status risk_reward, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
