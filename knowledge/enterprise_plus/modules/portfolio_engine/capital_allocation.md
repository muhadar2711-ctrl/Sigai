# portfolio_engine/capital_allocation

## Purpose
Menetapkan aturan operasional untuk enterprise_plus portfolio_engine untuk capital_allocation dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul portfolio_engine dan seluruh agent yang bergantung pada capital_allocation.

## Definitions
- capital_allocation: komponen utama yang mengatur enterprise_plus portfolio_engine untuk capital_allocation.
...
## Core rules
- capital_allocation hanya mengurus enterprise_plus portfolio_engine untuk capital_allocation dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status capital_allocation, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
