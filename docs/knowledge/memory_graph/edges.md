...
## Purpose
Menetapkan aturan operasional untuk memory_graph dan fungsi edges dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul memory_graph dan seluruh agent yang bergantung pada edges.

## Definitions
- edges: komponen utama yang mengatur memory_graph dan fungsi edges.
...
## Core rules
- edges hanya mengurus memory_graph dan fungsi edges dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status edges, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
