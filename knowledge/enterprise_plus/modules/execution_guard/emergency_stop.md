# execution_guard/emergency_stop

## Purpose
Menetapkan aturan operasional untuk enterprise_plus execution_guard untuk emergency_stop dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul execution_guard dan seluruh agent yang bergantung pada emergency_stop.

## Definitions
- emergency_stop: komponen utama yang mengatur enterprise_plus execution_guard untuk emergency_stop.
...
## Core rules
- emergency_stop hanya mengurus enterprise_plus execution_guard untuk emergency_stop dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status emergency_stop, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
