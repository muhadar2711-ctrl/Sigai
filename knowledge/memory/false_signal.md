...
## Purpose
Menetapkan aturan operasional untuk memory dan fungsi false_signal dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul memory dan seluruh agent yang bergantung pada false_signal.

## Definitions
- false_signal: komponen utama yang mengatur memory dan fungsi false_signal.
...
## Core rules
- false_signal hanya mengurus memory dan fungsi false_signal dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status false_signal, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
