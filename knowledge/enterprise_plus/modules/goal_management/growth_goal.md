# goal_management/growth_goal

## Purpose
Menetapkan aturan operasional untuk enterprise_plus goal_management untuk growth_goal dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul goal_management dan seluruh agent yang bergantung pada growth_goal.

## Definitions
- growth_goal: komponen utama yang mengatur enterprise_plus goal_management untuk growth_goal.
...
## Core rules
- growth_goal hanya mengurus enterprise_plus goal_management untuk growth_goal dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status growth_goal, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
