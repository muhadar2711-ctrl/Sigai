# context_engine/risk_context

## Purpose
Menetapkan aturan operasional untuk context_engine dan fungsi risk_context dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul context_engine dan seluruh agent yang bergantung pada risk_context.

## Definitions
- risk_context: komponen utama yang mengatur context_engine dan fungsi risk_context.
...
## Core rules
- risk_context hanya mengurus context_engine dan fungsi risk_context dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status risk_context, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
