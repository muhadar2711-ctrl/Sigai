...
## Purpose
Menetapkan aturan operasional untuk verification dan fungsi data_validation dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul verification dan seluruh agent yang bergantung pada data_validation.

## Definitions
- data_validation: komponen utama yang mengatur verification dan fungsi data_validation.
...
## Core rules
- data_validation hanya mengurus verification dan fungsi data_validation dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status data_validation, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
