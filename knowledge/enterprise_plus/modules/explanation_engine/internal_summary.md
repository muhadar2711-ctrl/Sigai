# explanation_engine/internal_summary

## Purpose
Menetapkan aturan operasional untuk enterprise_plus explanation_engine untuk internal_summary dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul explanation_engine dan seluruh agent yang bergantung pada internal_summary.

## Definitions
- internal_summary: komponen utama yang mengatur enterprise_plus explanation_engine untuk internal_summary.
...
## Core rules
- internal_summary hanya mengurus enterprise_plus explanation_engine untuk internal_summary dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status internal_summary, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
