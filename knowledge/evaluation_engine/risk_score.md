# evaluation_engine/risk_score

## Purpose
Menetapkan aturan operasional untuk evaluation_engine dan fungsi risk_score dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul evaluation_engine dan seluruh agent yang bergantung pada risk_score.

## Definitions
- risk_score: komponen utama yang mengatur evaluation_engine dan fungsi risk_score.
...
## Core rules
- risk_score hanya mengurus evaluation_engine dan fungsi risk_score dan tidak boleh mengambil tanggung jawab modul lain.
