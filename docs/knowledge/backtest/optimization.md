...
## Purpose
Menetapkan aturan operasional untuk backtest dan fungsi optimization dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul backtest dan seluruh agent yang bergantung pada optimization.

## Definitions
- optimization: komponen utama yang mengatur backtest dan fungsi optimization.
...
## Core rules
- optimization hanya mengurus backtest dan fungsi optimization dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status optimization, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
