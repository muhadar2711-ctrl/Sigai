# multi_agent_protocol/conflict_protocol

## Purpose
Menetapkan aturan operasional untuk enterprise_plus multi_agent_protocol untuk conflict_protocol dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul multi_agent_protocol dan seluruh agent yang bergantung pada conflict_protocol.

## Definitions
- conflict_protocol: komponen utama yang mengatur enterprise_plus multi_agent_protocol untuk conflict_protocol.
...
## Core rules
- conflict_protocol hanya mengurus enterprise_plus multi_agent_protocol untuk conflict_protocol dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status conflict_protocol, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
