# supervisor_engine/supervision

## Purpose
Menetapkan aturan operasional untuk supervisor_engine dan fungsi supervision dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul supervisor_engine dan seluruh agent yang bergantung pada supervision.

## Definitions
- supervision: komponen utama yang mengatur supervisor_engine dan fungsi supervision.
...
## Core rules
- supervision hanya mengurus supervisor_engine dan fungsi supervision dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status supervision, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
