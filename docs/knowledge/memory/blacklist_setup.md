# memory/blacklist_setup

## Purpose
Menetapkan aturan operasional untuk memory dan fungsi blacklist_setup dalam sistem knowledge AI trading XAUUSD.

## Scope
Berlaku untuk modul memory dan seluruh agent yang bergantung pada blacklist_setup.

## Definitions
- blacklist_setup: komponen utama yang mengatur memory dan fungsi blacklist_setup.
...
## Core rules
- blacklist_setup hanya mengurus memory dan fungsi blacklist_setup dan tidak boleh mengambil tanggung jawab modul lain.
...
## Outputs
- Status blacklist_setup, confidence, risk note, action recommendation, dan alasan ringkas yang bisa diaudit.
